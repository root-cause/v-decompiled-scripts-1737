...
void func_1()
{
	...
	if (iLocal_42)
	{
		if (func_46(iLocal_44))
		{
			if ((((!func_45() && !PED::IS_PED_FLEEING(iLocal_44)) && !PED::IS_PED_RAGDOLL(iLocal_44)) && !PED::IS_PED_PRONE(iLocal_44)) && !PED::IS_PED_INJURED(iLocal_44))
			{
				if (func_44(iLocal_44, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
				{
			...
			if (func_44(iLocal_44, PLAYER::PLAYER_PED_ID(), 1) > 150f)
			{
				func_26(&iLocal_44);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_210[iVar0 /*11*/]))
		{
			...
			{
				MISC::SET_BIT(&(Global_106565.f_10043.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!MISC::IS_BIT_SET(Global_106565.f_10043.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_106565.f_10043.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_106565.f_10043.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_35()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_38(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(iVar0) && (!func_39(14) || Global_105516))
			{
...
int func_48()
{
	...
	while (iVar1 < iVar0)
	{
		if (func_46(uVar2[iVar1]))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_50(58))
			{
...
void func_53()
{
	...
	while (iVar0 < 15)
	{
		func_66(&(Local_210[iVar0 /*11*/].f_2));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 15)
	{
		func_65(&(Local_210[iVar0 /*11*/]), 0);
		iVar0++;
	}
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_38);
	if (func_2(2) || func_51(105) == 1)
	{
		func_61(88, 0, 0);
		func_60(11);
		func_59("JOSH1_TXT", 0);
		...
		if (func_51(105) == 0)
		{
			func_54(497850717, 1, 4, 58, 30000, 10000, -1, 176, -1, 0, 1);
		}
	}
	SCRIPT::TERMINATE_THIS_THREAD();
}

int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_62()
{
	...
	{
		func_64(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
