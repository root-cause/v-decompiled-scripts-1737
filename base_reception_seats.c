...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 2:
			if (func_49(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_85.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
...
int func_46(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_47(iVar1, 1, 1)) && func_49(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_85), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_56(&(uParam0->f_85), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_56(&(uParam0->f_85), 0, func_35(0));
	func_56(&(uParam0->f_85), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
...
void func_76(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar2 < 2)
	{
		...
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_79(func_80(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_79(func_78(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_79(func_77(iVar2), fVar1) + vVar0 };
