...
void __EntryFunction__()
{
	...
	iLocal_753 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("BIKER_BUSINESSES");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_753))
	{
		SYSTEM::WAIT(0);
	}
	func_466(1);
	...
	{
		iLocal_582 = func_458(PLAYER::PLAYER_ID());
	}
	else
	{
	...
	{
		vLocal_567 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	}
	...
	if (iLocal_582 != 0)
	{
		iVar0 = func_423(iLocal_582);
		if (iVar0 != -1)
		{
			if (func_422(PLAYER::PLAYER_ID(), iLocal_582) == func_421(iLocal_582))
			{
				if (!MISC::IS_BIT_SET(Global_1365075, iVar0))
				{
					func_420(iVar0, 1, 0);
					MISC::SET_BIT(&Global_1365075, iVar0);
				}
			}
			else
			{
				MISC::CLEAR_BIT(&Global_1365075, iVar0);
			}
		}
	}
	while (func_419())
	{
		if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_23, 14) || func_418(PLAYER::PLAYER_PED_ID(), vLocal_567, 1) > 5f)
		{
			func_468(0);
		}
		...
		if (func_417(PLAYER::PLAYER_ID()) || ((!func_428(7638, -1, -1) && func_415(PLAYER::PLAYER_ID())) && func_397()))
		{
			func_396(7638, 1, -1, 1);
		}
		func_383();
		...
		if (iLocal_582 != 0)
		{
			iVar1 = func_423(iLocal_582);
			if ((iVar1 > -1 && iVar1 < 6) && iLocal_580 != Global_1365067[iVar1])
			{
				func_431();
			}
		}
		if (iLocal_583 == -1 && !Global_1671156)
		{
			func_11();
		}
		else if (iLocal_579 != 190)
		{
			if (!func_10(&uLocal_584))
			{
				func_9(&uLocal_584, 0, 0);
			}
			else if (func_8(&uLocal_584, 200, 0))
			{
				if (!Global_1671156)
				{
					func_3(PLAYER::PLAYER_ID(), iLocal_582, iLocal_583, 1);
					Global_1671156 = 1;
					func_468(0);
				}
		...
		{
			if (MISC::IS_BIT_SET(Global_1365042, 0))
			{
				func_1();
			}
			else if (func_8(&uLocal_586, 15000, 0))
			{
				func_1();
			}
		}
...
void func_11()
{
	...
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "GET_CURRENT_SELECTION");
		iLocal_754 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "GET_SELECTED_BUSINESS_ID");
		iLocal_756 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "GET_CURRENT_SCREEN_ID");
		iLocal_757 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_570 = 0;
		iLocal_569 = 0;
	}
	if ((PAD::IS_CONTROL_JUST_PRESSED(2, 202) || PAD::IS_CONTROL_JUST_PRESSED(2, 238)) && iLocal_570)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "GET_CURRENT_SCREEN_ID");
		iLocal_757 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_570 = 0;
	}
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_757) && !iLocal_570)
	{
		iLocal_578 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_757);
		iLocal_570 = 1;
	}
	if (iLocal_574 && !iLocal_575)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "GET_CURRENT_ROLLOVER");
		iLocal_755 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		iLocal_575 = 1;
	}
	if (iLocal_575)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_755))
		{
			iLocal_576 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_755);
			iLocal_575 = 0;
		}
	}
	if (iLocal_576 == 3014 && func_381())
	{
	...
	if (!iLocal_569)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_754) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_756))
		{
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_754);
			iVar2 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_756);
			iVar3 = -1;
			if (iLocal_582 != 0)
			{
				iVar3 = func_423(iLocal_582);
			}
			switch (iVar1)
			{
				case 101:
				...
				case 3002:
					if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar3 /*12*/].f_4 <= 0)
					{
						func_190(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_178(iLocal_582) == 2)
					{
				...
				case 3003:
					...
					{
						if (func_174(PLAYER::PLAYER_ID()) && !func_177(PLAYER::PLAYER_ID()))
						{
...
void func_12(int iParam0)
{
	...
	if (Global_1365067[func_423(iLocal_582)] >= Global_262145.f_17791)
	{
		func_190(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_189(func_423(iLocal_582)))
	{
		func_190(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_175(192))
...
int func_16(int iParam0)
{
	...
	iVar1 = func_422(PLAYER::PLAYER_ID(), iParam0);
...
void func_18(int iParam0, int iParam1)
{
	...
	else if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
	{
		func_190(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_29(iParam0, iLocal_582))
	{
		func_190(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_28(PLAYER::PLAYER_ID(), iLocal_582, iParam0))
	{
		func_190(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (MONEY::NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iLocal_582), false, true, 0, -1, 0))
	{
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_137(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
		
		case 233:
			return func_131(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
			return 6;
...
{
	if (!func_176(PLAYER::PLAYER_ID(), iParam0, 0))
	{
		return 0;
	}
...
int func_178(int iParam0)
{
	...
	else if (!func_187(PLAYER::PLAYER_ID(), iVar0) && !func_186(iVar0))
	{
		return 2;
	}
...
int func_179(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1365067[iParam0] > 0 && (!func_184(iParam1) || !func_180(PLAYER::PLAYER_ID(), iParam1)))
		{
			if (!Global_262145.f_20950 || func_174(PLAYER::PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1365067[iParam0] > 0 && !func_184(iParam1)) && (!Global_262145.f_18353 || func_64(PLAYER::PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
{
	return func_185(PLAYER::PLAYER_ID(), iParam0);
}
...
{
	iLocal_577 = iParam0;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SHOW_OVERLAY");
...
void func_191(int iParam0, int iParam1)
{
	...
	if (func_207(PLAYER::PLAYER_ID(), func_27(iVar0)))
	{
		iVar3 = func_206(PLAYER::PLAYER_ID(), func_27(iVar0));
...
{
	if (func_193(iParam0) || func_7(PLAYER::PLAYER_ID(), iParam0))
	{
		return 0;
	}
	return 1;
...
int func_208(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_25())
	{
		...
		if (NETSHOPPING::_NET_GAMESERVER_CATALOG_ITEM_EXISTS_HASH(iVar2))
		{
			...
			StringCopy(&cVar4, func_209(iParam0), 16);
			return iVar3;
		}
		else
		{
			StringCopy(&cVar5, func_209(iParam0), 16);
		}
	}
	if (func_211(iParam0))
	{
...
void func_215(bool bParam0, int iParam1)
{
	...
	GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_753, "HIDE_OVERLAY");
	iLocal_572 = 0;
	if (bParam0)
	{
		switch (iLocal_577)
		{
			case 2001:
				if (iLocal_571)
				{
					GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_753, "SHOW_HOMEPAGE");
					iLocal_571 = 0;
				}
				else if (!func_193(iParam1))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					if (func_207(PLAYER::PLAYER_ID(), func_27(iParam1)))
					{
						func_374(iParam1);
						func_373(iVar0, 0);
					}
			...
			case 3003:
				if (func_316(iLocal_582))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_312(iLocal_582);
					func_310(func_423(iLocal_582));
				}
				break;
			...
			case 3005:
				...
				{
					iVar2 = func_294(func_27(iLocal_582));
					if (func_293(iVar2))
					{
						iVar3 = func_291(iVar2);
						func_282(iVar3);
						MISC::SET_BIT(&Global_1671152, iVar0);
					}
				}
				break;
			...
			case 3006:
				...
				iVar0 = func_423(iLocal_582);
				func_280(func_423(iLocal_582));
				func_431();
				func_373(iVar0, 0);
				break;
			
			case 3008:
				if (func_279(0, iLocal_582))
				{
					if (func_275(0))
					{
						func_271(0);
			...
			case 3011:
				if (func_256(iLocal_582))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_254(func_423(iLocal_582), !Global_262145.f_16856);
					func_238(190, iLocal_582, 0);
					func_234(iLocal_582, 0);
				}
				else
				{
					func_190(0, func_233(iLocal_764), "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			...
			case 3012:
				if (func_256(iLocal_582))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_254(func_423(iLocal_582), !Global_262145.f_16856);
					func_238(190, iLocal_582, 1);
					func_234(iLocal_582, 1);
				}
				else
				{
					func_190(0, func_233(iLocal_764), "OR_OVRLY_OK", "", -1, 1);
			...
			case 3015:
				if (func_316(iLocal_582))
				{
					Global_1671153 = iLocal_582;
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_238(192, iLocal_582, -1);
					func_254(func_423(iLocal_582), !Global_262145.f_16856);
					func_310(func_423(iLocal_582));
				}
				break;
...
int func_219()
{
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		if (iLocal_767 == -1)
		{
			if (Global_4263509[iLocal_766 /*84*/].f_65 != 2147483647)
			{
				iLocal_767 = Global_4263509[iLocal_766 /*84*/].f_65;
			}
		}
		iVar3 = 0;
		while (iVar3 < SCRIPT::GET_NUMBER_OF_EVENTS(1))
		{
			if (SCRIPT::GET_EVENT_AT_INDEX(1, iVar3) == 223)
			{
				...
				{
					if (vVar0.x == iLocal_767 && vVar0.x != -1)
					{
						if (vVar0.z == 0)
						{
							return 1;
...
void func_220(int iParam0, int iParam1)
{
	...
	iVar4 = MISC::GET_HASH_KEY(func_209(iParam0));
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam1)
	{
		case 1704445500:
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_230(struct<66> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
void func_240(var uParam0, var uParam1)
{
	if (func_252())
	{
		if (!func_250(PLAYER::PLAYER_ID(), 0))
		{
			func_249(uParam0);
...
int func_256(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if (!func_176(PLAYER::PLAYER_ID(), 190, 0))
	{
		iLocal_764 = 4;
		return 0;
	}
	...
	if (func_25())
	{
		...
		iLocal_763 = 0;
		iVar1 = func_269(1);
		while (!func_258(iVar0, iVar1, &iLocal_765))
		{
			SYSTEM::WAIT(0);
			func_383();
		}
...
int func_266(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_229(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
int func_275(int iParam0)
{
	...
	bVar0 = true;
	iVar1 = 1;
	iVar2 = func_19(iParam0, iLocal_582);
	iVar3 = iParam0;
	iVar4 = func_423(iLocal_582);
	iVar5 = func_278(iVar4, iVar3 + 1);
	iVar6 = func_27(iLocal_582);
	iVar7 = func_277(iVar6, iVar3 + 1, 1);
	if (func_25())
	{
		bVar0 = false;
		while (!func_276(-103880010, 235173372, iVar7, 1, iVar2, &iLocal_581, iVar5, 3, 0, 0))
		{
			SYSTEM::WAIT(0);
			func_383();
			if (iLocal_581 == 1 && func_268() == -1)
			{
				iLocal_581 = 3;
				iVar1 = 0;
			}
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			vVar8.x = MISC::GET_HASH_KEY(func_209(iLocal_582));
			vVar8.y = iVar6;
			vVar8.z = iParam0;
			...
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEED(func_262(func_268()));
...
void func_296()
{
	...
	iVar0 = func_423(iLocal_582);
	if (func_25() && func_422(PLAYER::PLAYER_ID(), iLocal_582) > 0)
	{
		iVar1 = func_269(1);
		iLocal_762 = 1;
		while (!func_258(iVar0, iVar1, &iLocal_765))
		...
		{
			iLocal_765 = 0;
			iVar2 = func_422(PLAYER::PLAYER_ID(), iLocal_582);
			while (!func_306(iVar0, iVar2, 0, 0, &iLocal_765, 0))
			{
				SYSTEM::WAIT(0);
				func_383();
			}
			...
			if (iLocal_765 == 2)
			{
				func_297(PLAYER::PLAYER_ID(), iLocal_582, 1, 0, 0, 0);
				func_420(iVar0, 0, 0);
			}
		}
	}
		...
		case 1:
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					...
					{
						NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEED(func_262(func_268()));
						iVar0 = func_188(PLAYER::PLAYER_ID(), iParam0);
						iVar1 = func_27(iVar0);
						MONEY::_NETWORK_EARN_FROM_BUSINESS_PRODUCT(iParam2, MISC::GET_HASH_KEY(func_209(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_224(func_268());
				}
...
int func_317(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_27(iVar0);
	iVar2 = func_206(PLAYER::PLAYER_ID(), iVar1);
...
void func_318(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar2 /*12*/] == 0)
		{
			iVar1 = iVar2;
		}
		else
...
void func_321()
{
	...
	Global_1365064 = NETWORK::GET_CLOUD_TIME_AS_INT();
}
...
void func_322(int iParam0)
{
	...
	if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iParam0 /*12*/] != 0 && Global_1365057[iParam0] != 0)
	{
		iVar0 = (NETWORK::GET_CLOUD_TIME_AS_INT() - Global_1365057[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
...
{
	Global_1365057[iParam0] = NETWORK::GET_CLOUD_TIME_AS_INT();
...
void func_326(int iParam0)
{
	...
	bVar4 = false;
	sVar5 = ZONE::GET_NAME_OF_ZONE(func_350(iVar0, 0));
	Var6 = { func_349(iVar0, iVar2) };
	iVar7 = func_24();
	iVar8 = 0;
	iVar9 = func_208(iVar0);
	iVar10 = -1;
	iVar11 = func_421(iVar0);
	iVar12 = func_422(PLAYER::PLAYER_ID(), iVar0);
	iVar13 = func_348(PLAYER::PLAYER_ID(), iVar0, iVar12);
	iVar14 = 0;
	iVar15 = 0;
	iVar16 = 0;
	iVar17 = 0;
	...
	if (func_7(PLAYER::PLAYER_ID(), iVar0))
	{
		...
		iVar18 = func_344(func_346(iVar7, iVar8), func_345(iVar7, iVar8));
		iVar21 = func_344(func_342(iVar7, iVar8), func_341(iVar7, iVar8));
		iVar22 = func_344(func_339(iVar7, iVar8), func_338(iVar7, iVar8));
		iVar17 = func_337(iVar7, iVar8);
		iVar15 = func_335(iVar0);
		iVar16 = func_331(iVar8, 0, 1);
		iVar23 = func_331(iVar8, 0, 0);
		iVar24 = func_331(iVar8, 1, 1);
		iVar14 = Global_1365067[iVar8];
		iVar19 = func_13(0, iVar14, 0);
		bVar4 = Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar8 /*12*/].f_4 > 0;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "ADD_BUSINESS");
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "ADD_BUSINESS_STATS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_START_PRODUCTION_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
int func_330(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if ((func_7(PLAYER::PLAYER_ID(), iParam0) && Global_1365067[iVar0] < Global_262145.f_17791) && !func_189(iVar0))
	{
		return 1;
	}
	return 0;
...
Vector3 func_350(int iParam0, int iParam1)
{
	...
	if (iParam1 && !func_351(vVar0[1 /*3*/], 0f, 0f, 0f, 0))
	{
		return vVar0[1 /*3*/];
	}
	return vVar0[0 /*3*/];
...
bool func_351(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_352(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar1 /*12*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/] = iParam0;
		if (func_183(iParam0))
		{
			Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
			func_377(9359, 0, -1, 1);
...
int func_362(int iParam0, int iParam1, int iParam2)
{
	...
	iVar4 = SYSTEM::CEIL((SYSTEM::TO_FLOAT(func_208(iParam0)) * Global_262145.f_77));
	iVar0 = iVar4;
	bVar5 = func_211(iParam0);
	if (bVar5)
	{
		iVar4 = 0;
		iVar0 = 0;
	...
	else
	{
		*iParam1 = func_423(iParam2);
		...
		if (iVar1 > 0)
		{
			...
			{
				func_372(MISC::GET_HASH_KEY(&cVar3), iVar1, 0);
				iLocal_764 = 1;
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", true);
				return 0;
			}
	...
	if (func_25())
	{
		...
		iVar7 = func_370(*iParam1);
		iVar8 = 0;
		if (bVar5)
		{
			iVar6 = func_371(iParam0, 1);
		}
		if (iParam2 != 0 && iParam2 != 32)
		{
			bVar9 = false;
			...
			iVar8 = func_371(iParam2, bVar9);
		}
		iVar10 = -1;
		while (func_369(&iVar10, iVar4, *iParam1, -1616616027, 235173372, iVar6, iVar7, iVar2, iVar8))
		{
			func_383();
			SYSTEM::WAIT(0);
		}
	...
	vVar11.x = MISC::GET_HASH_KEY(func_209(iParam0));
	...
	iParam2 = func_188(PLAYER::PLAYER_ID(), *iParam1);
	func_363(*iParam1, iVar4);
	if (iParam2 == 0 || iParam2 == 32)
	{
		if (func_25())
		{
	...
	else if (func_328(iParam2) > 0)
	{
		...
		MONEY::NETWORK_EARN_FROM_PROPERTY(iVar2, MISC::GET_HASH_KEY(func_209(iParam2)));
		if (func_25())
		{
			NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEED(func_262(func_268()));
		}
...
void func_374(int iParam0)
{
	...
	iVar0 = func_27(iParam0);
	iVar1 = func_206(PLAYER::PLAYER_ID(), iVar0);
...
void func_375(int iParam0, int iParam1)
{
	...
	if (func_376(iParam0, iParam1))
	{
		...
		func_302(iVar0, 0);
		func_217(func_303(iVar0), 0, -1, 1, 0);
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_1 = 0;
		func_217(func_304(iVar0), 0, -1, 1, 0);
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 = 0;
		func_377(func_305(iVar0), 0, -1, 1);
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_5 = 0;
		func_217(func_274(iVar0, 2), 0, -1, 1, 0);
		func_217(func_274(iVar0, 0), 0, -1, 1, 0);
		func_217(func_274(iVar0, 1), 0, -1, 1, 0);
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_6 = 0;
		func_396(func_255(iVar0), 0, -1, 1);
		if (iVar0 != 5)
		{
			func_361(iVar0);
		}
		Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_8 = 0;
		func_396(func_299(iVar0), 0, -1, 1);
		if (func_183(iParam0))
		{
			Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
...
int func_381()
{
	if (!iLocal_573 && func_378(9356, -1, -1) < 3)
	{
		return 1;
	}
	return 0;
...
void func_382()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_574 = 1;
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_574 = 1;
		}
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
		if (((iLocal_578 == 1 || iLocal_578 == -1) || iLocal_578 == 4) || iLocal_578 == 5)
		{
			if (!iLocal_572)
			{
				func_468(0);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_MOUSE_INPUT");
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_753, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
			if ((iLocal_578 == 1 || iLocal_578 == -1) || iLocal_578 == 4)
			{
				if (!iLocal_572)
				{
					func_468(0);
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_758 != 127) || iVar1 != 127) || iLocal_759 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_ANALOG_STICK_INPUT");
			iLocal_758 = iVar0;
			iLocal_759 = iVar1;
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_758);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_759);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			iLocal_574 = 1;
		}
	}
	...
	if (((iVar2 != 127 || iLocal_760 != 127) || iVar3 != 127) || iLocal_761 != 127)
	{
		...
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_760);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_761);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		if (!bVar4)
		{
...
void func_383()
{
	...
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_753, 255, 255, 255, 255, 0);
	func_390();
	func_387(0);
	func_384(1);
}
...
int func_397()
{
	return func_398(&uLocal_588, "BPLESAU", "BPLES_TUT1", 8, 0, 0, 0);
}
...
void func_406()
{
	...
	{
		if (func_409(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_408(PLAYER::PLAYER_PED_ID());
...
{
	if (func_416(Global_1589819[iParam0 /*818*/].f_273.f_25, -1) && !MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_23, 1))
	{
		return 1;
	}
	return 0;
...
float func_418(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
{
	func_427(1);
	func_426(&uLocal_588, 2, 0, "LJT", 0, 1);
}
...
void func_431()
{
	...
	if (func_448())
	{
		...
		iVar0 = func_423(iLocal_582);
		iVar1 = iLocal_582;
		iVar2 = func_27(iLocal_582);
		func_326(iVar1);
		if (!func_17(iLocal_582))
		{
			iVar3 = func_348(PLAYER::PLAYER_ID(), iLocal_582, func_422(PLAYER::PLAYER_ID(), iLocal_582));
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18468);
			iVar5 = SYSTEM::ROUND(fVar4);
			func_438(func_237(iLocal_582), &cVar7, &sVar6);
			func_437(iVar1, 1, &sVar6, &cVar7, iVar5, 1);
			func_438(!func_237(iLocal_582), &cVar7, &sVar6);
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18469);
			iVar5 = SYSTEM::ROUND(fVar4);
			func_437(iVar1, 2, &sVar6, &cVar7, iVar5, 1);
		}
		iVar8 = 0;
		while (iVar8 < 12)
		{
			iVar9 = iVar8;
			bVar10 = true;
			Var11 = { func_436(iVar2, iVar9) };
			if (func_28(PLAYER::PLAYER_ID(), iLocal_582, iVar9) || Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
			{
				bVar10 = false;
			}
			iVar12 = func_19(iVar9, iLocal_582);
			iVar13 = -1;
			if (func_435(iLocal_582, iVar9) && bVar10)
			{
				iVar13 = iVar12;
				iVar12 = func_434(iVar9, iLocal_582);
			}
			func_432(iVar1, iVar8 + 1, func_433(iVar9), iVar12, iVar13, bVar10, &Var11);
			iVar8++;
		}
	}
	else
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "ADD_BUSINESS_UPGRADE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_BUSINESS_UPGRADE_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
...
void func_437(int iParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, bool bParam5)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "ADD_BUSINESS_BUYER");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam2);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam3);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_BUSINESS_BUYER_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bParam5);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_439(bool bParam0)
{
	...
	sVar0 = func_441(PLAYER::PLAYER_ID());
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		sVar0 = func_440();
	}
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_753, "SET_PLAYER_DATA");
...
{
	if (((func_34(iParam0, 28) || func_34(PLAYER::PLAYER_ID(), 28)) || func_447(iParam0)) && !func_445(iParam0))
	{
		return func_440();
	}
	if (iParam0 != PLAYER::PLAYER_ID())
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_246(PLAYER::PLAYER_ID(), 0) && !func_454()))
				{
			...
			if (bParam1)
			{
				if (!func_453(iVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar25))
				{
					if (!bVar21)
					{
...
void func_468(int iParam0)
{
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_753);
	func_462(iParam0);
	func_464(0);
	func_472();
