		...
		switch (iLocal_216)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_106510[iLocal_217] = uLocal_330;
					}
					else
					{
...
int func_8()
{
	if (Global_106510[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_10()
{
	if (iLocal_278)
	{
		if (func_8())
		{
			ENTITY::DETACH_ENTITY(iLocal_277, 1, 1);
			iLocal_278 = 0;
		}
		else
		{
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_105516))
			{
...
void func_47(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
