...
void __EntryFunction__()
{
	...
	iLocal_404 = func_265(func_266(), 0, 1);
	iLocal_405 = func_265(func_266(), 0, 1);
	iLocal_406 = func_265(func_266(), 0, 1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		...
		func_246(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
	}
	iLocal_62 = func_245();
	func_244(&Local_61, iLocal_62);
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				func_238(&uLocal_48, iLocal_55, iLocal_56, iLocal_57, iLocal_58, iLocal_59, func_245());
			...
			case 1:
				if (!bVar4)
				{
					if (func_234(&uLocal_48))
					{
						func_226(&iLocal_379, iLocal_55, vLocal_395, fLocal_397, iLocal_404, iLocal_405, iLocal_406);
						func_216(&Local_61, func_245());
						func_236(&iLocal_228);
						bVar4 = true;
					}
				}
				if (bVar4)
				{
					if (!bVar5)
					{
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
							...
							{
								func_131(&vLocal_387, PLAYER::PLAYER_PED_ID(), 0, 2);
							}
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_379, 0))
							{
								func_131(&vLocal_391, iLocal_379, 0, 2);
							}
							bVar5 = true;
						}
					}
				}
				if (func_129(&iVar6) > 6f && func_128())
				{
			...
			case 2:
				...
				{
					func_126(iLocal_379, 1, 0);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_391, 0))
				{
					func_126(iLocal_379, 0, 1);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					func_125(iLocal_379, &iLocal_381, &iLocal_382, &iLocal_384, &uLocal_63, vLocal_396, fLocal_399, iLocal_57);
					func_123(func_245());
					func_236(&iLocal_231);
					func_122(&iLocal_255, 0, 0, 0, 1);
					func_121(&iLocal_255, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_121(&iLocal_255, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					bVar5 = false;
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					iLocal_60 = 3;
			...
			case 3:
				...
				if (CAM::IS_SCREEN_FADED_OUT() || bVar14)
				{
					...
					func_114(&iLocal_231);
					while (func_129(&iLocal_231) < 0.4f)
					{
						SYSTEM::WAIT(0);
						func_115();
					}
				...
				if (!bVar2)
				{
					...
					{
						Local_61.f_20 = 0;
						func_102(&(Local_61.f_12), &Local_61, func_245());
						bLocal_407 = true;
					}
					if (func_92(&iLocal_231, &iLocal_255, &bVar1))
					{
						if (bVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_129(&iLocal_231) >= 14f)
					{
						Local_61.f_20 = 2;
						bVar2 = true;
						HUD::CLEAR_HELP(1);
					}
					else if (!bVar3 && func_129(&iLocal_231) >= 7f)
					{
						StringCopy(&cVar11, "DRF_PROMPT", 16);
						func_91(&uLocal_63, &cVar10, &cVar11, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if ((func_129(&iLocal_231) > 5f && func_128()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_129(&iLocal_231) > fVar12) || func_88(iLocal_62, iLocal_379, &iLocal_384))))
				{
					func_85();
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
			...
			case 14:
				...
				if (((func_84() && CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_SCREEN_FADING_OUT()) && !CAM::IS_SCREEN_FADED_OUT())
				{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), true, 0);
							ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
							func_81(PLAYER::PLAYER_PED_ID(), -1902.609f, -559.9267f, 10.7916f);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382))
							{
								...
								{
									ENTITY::SET_ENTITY_COORDS(iLocal_382, func_72(iLocal_382), 1, 0, 0, 1);
							...
							if (CAM::IS_SCREEN_FADED_OUT())
							{
								if (!iLocal_408)
								{
									STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_71(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_408 = 1;
									SYSTEM::WAIT(0);
								}
								if (!iLocal_409)
				...
				else
				{
					if (!iLocal_408)
					{
						if (CUTSCENE::GET_CUTSCENE_TIME() > 60000)
						{
							if (iLocal_62 == 4)
							{
								STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_71(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_71(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_409)
					{
						if (CUTSCENE::_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_129(&iVar7) > func_69(func_245()))
							{
								if (func_245() == 4)
								{
									...
									ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_380, 1, 1);
									func_68(&uLocal_63, 1, iLocal_380, "FRIEDLANDER", 0, 1);
								}
								iLocal_409 = 1;
							}
						}
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
				{
					func_263(80, 1);
					STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), 1, 1);
					func_91(&uLocal_63, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_380) || func_67(iLocal_380, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					func_91(&uLocal_63, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (HUD::DOES_BLIP_EXIST(iLocal_383))
					{
				...
				else
				{
					...
					if (func_70(&iLocal_246))
					{
						if (func_129(&iLocal_246) > 2.5f)
						{
					...
					if (!iLocal_411)
					{
						...
						if (func_129(&iLocal_243) > 2f)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382) && !ENTITY::IS_ENTITY_DEAD(iLocal_382, 0))
							{
								...
								VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_382, 1);
							}
							func_114(&iLocal_243);
							iLocal_411 = 1;
						}
					...
					if (iLocal_410 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_52(&iLocal_237, 0.5f))
						{
							...
							{
								HUD::SET_BLIP_COLOUR(iLocal_383, 3);
								if (func_70(&iLocal_240))
								{
									if (func_129(&iLocal_240) < (7500f / 1000f))
									{
			...
			case 16:
				if (!func_70(&iLocal_234))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_236(&iLocal_234);
				}
				else if (func_129(&iLocal_234) > 2f)
				{
					func_2(func_39(), 24, func_38(iLocal_62));
					func_264();
					func_261(0, 0);
					func_246(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
				}
			...
			case 17:
				...
				if (func_129(&iLocal_234) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
...
int func_2(int iParam0, int iParam1, int iParam2)
{
	...
	return func_3(Global_106565.f_28044[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_8() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_8() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2539502[iParam0 /*3*/][func_10(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_14(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_8() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_15(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2539502[iParam0 /*3*/][func_10(iParam1)];
...
int func_21(int iParam0, int iParam1)
{
	...
	if (func_31(&Global_4269608))
	{
		if (func_29(&Global_4269608, iParam0))
		{
			return 0;
		}
		if (func_22(&Global_4269608, iParam0))
		{
			return 1;
		}
	}
...
void func_25(var uParam0)
{
	...
	func_27(uParam0, (Global_4269607 - 0.5f));
}
...
void func_40()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_43(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_41(iVar0) && (!func_33(14) || Global_105516))
			{
...
int func_44(int iParam0)
{
	...
	if ((func_47(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_45(iParam0))
	{
...
void func_55()
{
	...
	if (!func_70(&iLocal_249))
	{
		func_236(&iLocal_249);
	}
	if (!func_70(&iLocal_252))
	{
		func_236(&iLocal_252);
	}
	...
	if (iLocal_401 < 7)
	{
		...
		else if (func_129(&iLocal_249) > 12f)
		{
	...
	if (iLocal_403 < 8)
	{
		if (iLocal_403 <= 0)
		{
			if (func_129(&iLocal_252) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
		...
		else if (func_129(&iLocal_252) > 10.3f)
		{
...
Vector3 func_71(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_73(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_77(PLAYER::PLAYER_ID())) && !func_75(PLAYER::PLAYER_ID(), 0)) && !func_74()) && !bParam4) && !bParam5)
			{
...
Vector3 func_81(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_83()
{
	...
	{
		VEHICLE::DELETE_VEHICLE(&iLocal_381);
		iLocal_381 = VEHICLE::CREATE_VEHICLE(iLocal_57, vLocal_396, fLocal_399, 1, 1, 0);
	...
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1907.827f, -560.0641f, 10.8064f, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 260.195f);
		ENTITY::SET_ENTITY_COORDS(iLocal_381, vLocal_396, 1, 0, 0, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_382))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_382, 0))
			{
				...
				VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_382, 0);
				ENTITY::SET_ENTITY_COORDS(iLocal_382, func_72(iLocal_382), 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(iLocal_382, 231f);
			}
		}
		...
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_380, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			if (!iLocal_408)
			{
				STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_71(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_408 = 1;
				SYSTEM::WAIT(0);
			}
			while (!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || (!PED::IS_PED_INJURED(iLocal_380) && !PED::_0x7350823473013C02(iLocal_380)))
			{
				SYSTEM::WAIT(0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&uLocal_386);
			...
			TASK::CLOSE_SEQUENCE_TASK(uLocal_386);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_380, uLocal_386);
			PED::FORCE_PED_MOTION_STATE(iLocal_380, -530524, 1, 1, 1);
		}
		iLocal_383 = HUD::ADD_BLIP_FOR_ENTITY(iLocal_380);
		HUD::SET_BLIP_COLOUR(iLocal_383, 1);
		func_114(&iLocal_237);
	...
	VEHICLE::CREATE_VEHICLE(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1, 0);
}
...
int func_91(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_92(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_70(iParam0) && func_129(iParam0) > 1.3f)
	{
	...
	func_93(iParam1, 1128792064, 1, 0, 1, 1065353216);
	return 0;
}

void func_93(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_98(iParam0->f_1, 256) || (func_98(iParam0->f_1, 8192) && PAD::_0x6CD79468A1E595C6(2)))
	{
		...
		if (MISC::IS_PC_VERSION())
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_98(iParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
		while (iVar6 < iParam0->f_123)
		{
			...
			if (bVar4)
			{
				if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*iParam0, "SET_DATA_SLOT"))
				{
					...
					{
						func_96(iParam0->f_2[iVar6 /*15*/]);
					}
					if (MISC::IS_PC_VERSION())
					{
						if (func_98(iParam0->f_1, 4096))
						{
		...
		fVar8 = func_54(bParam4, func_54(func_98(iParam0->f_1, 32), 1f, 0f), -1f);
...
void func_102(char* sParam0, var uParam1, int iParam2)
{
	int iVar0;
	
	iVar0 = func_113(uParam1->f_20);
	iVar0 |= 4;
	iVar0 = (iVar0 || func_103(uParam1, iParam2));
	iVar0 |= 98304;
...
int func_103(var uParam0, int iParam1)
{
	...
	Var1 = { func_104(uParam0, &uVar0, iParam1, 1) };
...
struct<4> func_104(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	struct<4> Var0;
	int iVar1;
	...
	if (func_112() <= 0)
	{
		if (!func_111())
		{
			iVar1 = func_108(1, 2, 3, 4, 12);
		}
		else if (func_107() >= 1)
		{
			iVar1 = func_108(5, 6, 7, 0, 0);
		}
		else
		{
			iVar1 = func_108(5, 7, 0, 0, 0);
		}
	}
	else if (func_112() >= 2)
	{
		iVar1 = func_108(10, 11, 0, 0, 0);
	}
	else if (!func_111())
	{
		if (iParam2 != 4)
		{
			iVar1 = func_108(8, 9, 0, 0, 0);
		}
		else
		{
			iVar1 = 9;
	...
	{
		iVar1 = func_108(8, 9, 10, 0, 0);
	}
	else
	{
		iVar1 = func_108(9, 10, 0, 0, 0);
	}
	func_106(uParam0, iVar1);
	if (bParam3)
	{
		func_105(&(Global_106565.f_19955), iVar1, 1);
	}
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_110(&(Global_106565.f_19955), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_110(&(Global_106565.f_19955), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_110(&(Global_106565.f_19955), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_110(&(Global_106565.f_19955), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_110(&(Global_106565.f_19955), iParam4))
	{
		iVar2[iParam4] = 0;
	}
	iVar1 = func_109(&iVar2, 13, 1, 13);
	if (iVar1 > 0)
	{
		return iVar1;
	}
...
void func_122(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (MISC::IS_PC_VERSION())
	{
		if (bParam3)
		{
			func_95(&(uParam0->f_1), 4096);
		}
	}
	if (bParam4)
	{
		func_95(&(uParam0->f_1), 8192);
	}
}
...
void func_125(int iParam0, var uParam1, int iParam2, int iParam3, var uParam4, vector3 vParam5, float fParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	*iParam2 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = VEHICLE::CREATE_VEHICLE(iParam7, vParam5, fParam6, 1, 1, 0);
	...
	func_68(uParam4, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_68(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
...
void func_132(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		if (uParam1->f_13[iVar0] != Var2.f_13[iVar0] || (*uParam1)[iVar0] != Var2[iVar0])
		{
			...
			if (func_141(iVar4, func_211(iVar0), func_210(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_211(iVar0)), &uVar1))
			{
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_209(iVar4, 14, func_134(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_143(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_141(iVar4, 14, func_134(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_143(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_138(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_146(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_151(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_151(Global_2621444, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_15(func_149(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_15(func_148(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_15(iVar1, Global_71399, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_154(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_138(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_213(int iParam0, var uParam1)
{
	...
	uVar0 = Global_2571340[iParam0 /*3*/][func_10(uParam1)];
...
void func_216(char* sParam0, int iParam1)
{
	...
	iVar1 = 15;
	iVar1 = (iVar1 || func_224(iParam1, 1));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(64, iVar0));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(func_217(iParam1), iVar0));
...
int func_217(int iParam0)
{
	...
	Var1 = { func_218(iParam0, 1, 1, &uVar0) };
...
struct<4> func_218(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	struct<4> Var0;
	int iVar1;
	int iVar2;
	...
	if ((((!func_223(&(Global_106565.f_19955), 8) && iParam1) && iParam0 != 4) && func_221(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_223(&(Global_106565.f_19955), 1) && func_221(5) > 0)
		{
			MISC::SET_BIT(&iVar2, 1);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 2) && func_221(7) >= 2)
		{
			MISC::SET_BIT(&iVar2, 2);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 3) && ((((func_221(8) > 0 || func_221(9) > 0) && func_221(7) > 0) && iParam1) && iParam0 != 4))
		{
			MISC::SET_BIT(&iVar2, 3);
			iVar3++;
		}
		if ((!func_223(&(Global_106565.f_19955), 4) && func_221(1) > 0) && func_221(1) < 3)
		{
			MISC::SET_BIT(&iVar2, 4);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 5) && func_221(1) >= 3)
		{
			MISC::SET_BIT(&iVar2, 5);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 6) && func_221(0) > 0)
		{
			MISC::SET_BIT(&iVar2, 6);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 7))
		{
			MISC::SET_BIT(&iVar2, 7);
			iVar3++;
		}
		if (((!func_223(&(Global_106565.f_19955), 8) && iParam1) && func_221(3) > 0) && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar2, 8);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 9))
		{
			MISC::SET_BIT(&iVar2, 9);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 10))
		{
			MISC::SET_BIT(&iVar2, 10);
			iVar3++;
		}
		if (!func_223(&(Global_106565.f_19955), 11))
		{
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar1 = func_220(7, 9, 10, 11, 0);
			}
			else
			{
				iVar1 = func_220(7, 9, 10, 0, 0);
			}
		}
		else
		{
	...
	if (bParam2)
	{
		func_219(&(Global_106565.f_19955), iVar1, 1);
	}
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2[12];
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_223(&(Global_106565.f_19955), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar3 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_223(&(Global_106565.f_19955), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar3 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_223(&(Global_106565.f_19955), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar3 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_223(&(Global_106565.f_19955), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar3 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_223(&(Global_106565.f_19955), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar3 = true;
	}
...
int func_221(int iParam0)
{
	...
	{
		case 0:
			return func_222(&Global_90180, 1);
			break;
		
		case 1:
			return func_222(&Global_90182, 3);
			break;
		
		case 2:
			return func_222(&Global_90186, 1);
			break;
		
		case 3:
			return func_222(&Global_90188, 1);
			break;
		
		case 4:
			return func_222(&Global_90190, 1);
			break;
		
		case 5:
			return func_222(&Global_90192, 1);
			break;
		
		case 6:
			return func_222(&Global_90194, 1);
			break;
		
		case 7:
			return func_222(&Global_90196, 2);
			break;
		
		case 8:
			return func_222(&Global_90199, 1);
			break;
		
		case 9:
			return func_222(&Global_90201, 1);
			break;
	}
	return 0;
}
...
int func_224(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 1:
			if (func_225(20) && !func_225(59))
			{
				if ((!func_225(21) || func_225(72)) || func_225(73))
				{
					if (func_225(21))
					{
						return 64;
		...
		case 4:
			if ((func_225(48) && func_225(61)) && func_225(22))
			{
				if (func_225(27))
				{
					return 64;
				...
				else if (!func_225(84) && !func_225(85))
				{
					return 16;
				}
			}
...
void func_226(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
struct<6> func_233(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_248()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_249(&Global_90180, 1);
				break;
			
			case 1:
				func_249(&Global_90182, 3);
				break;
			
			case 2:
				func_249(&Global_90186, 1);
				break;
			
			case 3:
				func_249(&Global_90188, 1);
				break;
			
			case 4:
				func_249(&Global_90190, 1);
				break;
			
			case 5:
				func_249(&Global_90192, 1);
				break;
			
			case 6:
				func_249(&Global_90194, 1);
				break;
			
			case 7:
				func_249(&Global_90196, 2);
				break;
			
			case 8:
				func_249(&Global_90199, 1);
				break;
			
			case 9:
				func_249(&Global_90201, 1);
				break;
		}
		iVar1++;
	}
...
void func_251()
{
	...
	if (Global_106565.f_9079 || func_260(0))
	{
		if (!func_259())
		{
			iVar0 = func_258();
...
int func_253(int iParam0)
{
	...
	func_254(&(Global_106565.f_2357.f_539), iVar1);
...
void func_254(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_256(Global_106565.f_18527[iVar0], &vVar2, &fVar3))
			{
...
void func_261(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_260(0) && Global_71836.f_1 == 1) && func_262(Global_71836))
		{
		}
		else
		{
