...
void func_3()
{
	func_4(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_24(14) || Global_105516))
			{
...
{
	return func_29(iParam0, Global_36425);
}
...
void func_30(int iParam0)
{
	...
	if (iLocal_43 != 9)
	{
		if (!Global_106565.f_19977.f_13)
		{
			if (Global_106565.f_19977.f_1 == 0 && Global_106565.f_19977.f_2 == 0)
			{
				if (!func_169(Global_106565.f_19977, 32))
				{
					func_166("MG_TRAF_AVAIL", 0, 0, -1, 10000, 7, 0, 0, 0);
					func_164(&(Global_106565.f_19977), 32);
				}
			}
			func_1(106, 1, 0);
			Global_106565.f_19977.f_13 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_43)
	{
					...
					if (iVar2 == iLocal_44)
					{
						if (SYSTEM::VDIST2(vLocal_45, ENTITY::GET_ENTITY_COORDS(iLocal_28, true)) < 100f)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_29) && !ENTITY::IS_ENTITY_DEAD(iLocal_29, 0))
							{
								...
								{
									func_132(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = func_130(&iLocal_33, 6, 9, 0, 0);
					iLocal_37 = 1;
				}
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_30 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 28000);
					func_80(16);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_106565.f_19977.f_12 = iVar5;
					func_1(106, 0, 0);
					Global_106565.f_19977.f_13 = 0;
				}
				*iParam0 = 0;
				func_42(&Global_105216, 2);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_31(Global_106565.f_19977.f_12))
			{
				func_162(0);
				iLocal_43 = 1;
			}
...
void func_63(var uParam0)
{
	...
	*uParam0 = 145;
	...
	func_66(&(uParam0->f_2884));
	func_65(&(uParam0->f_2890));
	func_64(&(uParam0->f_2980));
}
...
void func_82(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_93682 != 10 && Global_93682 != 9)
	{
		...
		func_84(&Global_97130, cParam0, 0, "Start", iParam1, iParam2);
		func_83();
		Global_87890 = 0;
	}
}
...
void func_84(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_22();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_93())
		{
			func_86(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_94(int iParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_95(iParam0, &(Global_106565.f_2357.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_95(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_97(Var7.f_1)) && iVar9 < 51)
			{
...
int func_112(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_128(iVar0))
		{
			if (!bParam3 || func_127(iVar0))
			{
...
Vector3 func_113(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_124(Global_95769);
			break;
		
		case 46:
			if (Global_1589661 != func_123())
			{
				if (func_122(Global_1589661))
				{
					return func_115(2, 2);
				}
				else if (func_114(Global_1589661))
				{
...
void func_132(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_152(iParam3, &Var0, vParam1, fParam2, func_9(iParam0));
...
void func_133(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_151(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106565.f_32743.f_4801 = func_52();
			}
...
void func_134(int iParam0, int iParam1)
{
	...
	func_14(iParam0, &(Global_106565.f_32743.f_5510));
}

int func_135(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || func_146(iParam0)) || !func_136(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_148(iParam0))
		{
		}
...
int func_151(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_105(Global_106565.f_32743.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_105(Global_106565.f_2357.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_105(Global_106565.f_2357.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_152(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_151(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_157(iParam0);
			func_156(uParam1, &(Global_106565.f_32743.f_69[Global_70409.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_166(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	func_167(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_167(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_170(int iParam0)
{
	...
	if (iLocal_39 != 9)
	{
		if (!Global_106565.f_19977.f_14)
		{
			func_1(105, 1, 0);
			Global_106565.f_19977.f_14 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_39)
	{
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					iLocal_30 = SYSTEM::START_NEW_SCRIPT("Traffick_Air", 28000);
					func_80(15);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_106565.f_19977.f_11 = uVar4;
					func_1(105, 0, 0);
					Global_106565.f_19977.f_14 = 0;
					iLocal_39 = 9;
				}
				*iParam0 = 0;
				func_42(&Global_105216, 1);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_31(Global_106565.f_19977.f_11))
			{
				func_171(0);
				iLocal_39 = 1;
			}
...
void func_171(bool bParam0)
{
	...
	if (func_169(Global_106565.f_19977, 128))
	{
		func_42(&(Global_106565.f_19977), 128);
	}
	iLocal_41 = 0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_129()) || func_180()) || func_173()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_181()) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_181() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_174(8, -1)) || func_179()) || func_178()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_174(8, -1) || func_129()) || func_180()) || func_178()) || func_177())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_181()) || Global_25767) || func_175()) || func_174(8, -1)) || func_180()) || func_173()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_181()) || func_180()) || Global_105612) || Global_25767) || func_175()) || Global_37584) || func_174(8, -1)) || func_173()) || func_178()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_178()) || func_129()) || func_180()) || func_179())
						{
							return 0;
						}
						break;
...
int func_183()
{
	...
	{
		return (func_184(0, 15) && func_184(0, 16));
	}
	else
	{
		return 1;
	...
	while (iVar0 < 8)
	{
		if (Global_90645[iVar0 /*17*/] && !Global_90645[iVar0 /*17*/].f_1)
		{
			if (Global_90645[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_190(Global_90645[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
