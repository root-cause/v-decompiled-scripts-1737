...
void func_1()
{
	...
	switch (iLocal_304)
	{
		case 0:
			...
			{
				if (PED::_0xFCF37A457CB96DC0(PLAYER::PLAYER_PED_ID(), vLocal_306, 90f) || iLocal_309)
				{
					func_32("TV_HLP0");
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_90640 && Global_90641) || func_37())
					{
						return 0;
					}
...
{
	return func_48(iParam0, Global_36425);
}
...
void func_50()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_54(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_52(iVar0) && (!func_51(14) || Global_105516))
			{
