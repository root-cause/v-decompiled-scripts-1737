	...
	while (true)
	{
		...
		if (iLocal_55 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_196(Var0.f_28[1]))
					{
						func_288("Trying to set Mary Ann boyfriend component variation");
		...
		if (Var0 == 21)
		{
			func_193(&Var0, vVar1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_188(&Var0, vVar1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_56 == 0)
			{
				if (func_193(&Var0, vVar1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_56 = 1;
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_196(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
void func_185(int iParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_57) >= 900)
	{
		if (func_196(iParam0->f_28[0]))
		{
			if (!func_144())
			{
				func_186(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_57 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_186(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_187(iParam3), 0);
}
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_189(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		else if (func_194(sParam3))
		{
			...
			{
				if (func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_142();
				}
			}
...
int func_217(int iParam0, float fParam1)
{
	...
	if (func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0))
	{
...
{
	if ((func_241() && Global_93682.f_11 == 6) && iParam0 == func_164(&(Global_93682.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_250(&iVar0) || !func_249(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_246(&(uParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_247(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_252(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_246(&(uParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_256(&(uParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
			...
			{
				func_254(&(uParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_254(&(uParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_196(uParam0->f_35[iVar1]))
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_196(uParam0->f_28[1]))
				{
					...
					func_288("Playing Mary Ann's friend anim...");
				}
			}
			func_253();
			iVar1 = 0;
...
void func_256(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_257(iParam0);
...
int func_258(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_246(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
