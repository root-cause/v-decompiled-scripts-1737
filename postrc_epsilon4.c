...
void func_1()
{
	...
	{
		if (((((!func_22() && !PED::IS_PED_FLEEING(iLocal_205)) && !PED::IS_PED_RAGDOLL(iLocal_205)) && !PED::IS_PED_PRONE(iLocal_205)) && !PED::IS_PED_INJURED(iLocal_205)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_205, 0))
		{
		...
		if (func_21(iLocal_205, PLAYER::PLAYER_PED_ID(), 1) > 150f)
		{
			func_3(&iLocal_205);
		}
	}
	...
	{
		if (((((!func_22() && !PED::IS_PED_FLEEING(iLocal_204)) && !PED::IS_PED_RAGDOLL(iLocal_204)) && !PED::IS_PED_PRONE(iLocal_204)) && !PED::IS_PED_INJURED(iLocal_204)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_204, 0))
		{
		...
		if (func_21(iLocal_204, PLAYER::PLAYER_PED_ID(), 1) > 150f)
		{
			func_3(&iLocal_204);
		}
	}
	...
	if (!func_23(iLocal_204) && !func_23(iLocal_205))
	{
		iLocal_37 = 2;
	}
}
...
float func_21(int iParam0, int iParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_24()
{
	...
	while (iVar1 < iVar0)
	{
		if (func_23(uVar2[iVar1]))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_26(55))
			{
			...
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_26(60))
			{
...
{
	if (((!func_11() == iParam0 || func_29()) || func_28()) || Global_71587 != -1)
	{
		if (!func_11() == 1)
		{
		}
