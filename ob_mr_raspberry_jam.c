...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (((((BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iLocal_41) && !ENTITY::IS_ENTITY_DEAD(iLocal_41, 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_57()) && func_56(0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				switch (iLocal_276)
				{
					case 0:
...
void func_1()
{
	...
	{
		case 0:
			if (func_46(vVar0, vVar1) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_41, true), 90f))
			{
				func_70();
		...
		case 2:
			...
			iLocal_278 = PED::CREATE_SYNCHRONIZED_SCENE(func_31(), func_30(), 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_278, func_29(), func_28(iLocal_280), 8f, -2f, 0, 0, 1148846080, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_278, func_27(iLocal_280), func_29(), 8f, -2f, 0, 1148846080);
			...
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				...
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_279, iLocal_278, func_24(iLocal_280), func_29());
			...
			iLocal_283 = 0;
			iLocal_284 = (MISC::GET_GAME_TIMER() + func_23());
			iLocal_277 = 3;
			break;
		...
		case 3:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_278))
			{
				...
				if (iLocal_281)
				{
					...
					if (ENTITY::FIND_ANIM_EVENT_PHASE(func_29(), func_28(iLocal_280), "WalkInterruptible", &fVar3, &fVar4))
					{
				...
				{
					if (func_3(&uLocal_108, "RASPAUD", func_20(), 7, 0, 0, 0))
					{
						iLocal_283 = 1;
					}
				}
...
void func_21()
{
	...
	if (iLocal_281 == 0)
	{
		func_22(&iVar0, &iVar1, &uVar2, &uVar3, 0);
...
void func_22(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
...
void func_34(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_39(PLAYER::PLAYER_ID())) && !func_36(PLAYER::PLAYER_ID(), 0)) && !func_35()) && !bParam4) && !bParam5)
			{
...
int func_52()
{
	if (AUDIO::REQUEST_AMBIENT_AUDIO_BANK(func_53(), 0, -1))
	{
		return 1;
	}
	return 0;
...
int func_56(int iParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (func_47(ENTITY::GET_ENTITY_COORDS(iLocal_41, false), func_51(), 5f, 0))
			{
				return 1;
			}
		}
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_106565.f_7255.f_227[145] == 1)
			{
				if (func_10() == 2)
				{
					if (((((Global_88718[13] != 127 && Global_88718[13] != 135) && Global_88734 != 127) && Global_88734 != 135) && !func_59()) && !func_61())
					{
						return 1;
					}
				}
		...
		case joaat("prop_radio_01"):
			...
			if ((Global_33790[78] != 1 && Global_88718[9] != 117) && Global_88718[11] != 117)
			{
				...
				if ((func_10() == 0 && func_58(130)) && !func_58(131))
				{
					return 1;
				}
			}
...
{
	return func_67(iParam0, Global_36425);
}
...
void func_68()
{
	...
	if (iLocal_282)
	{
		STREAMING::REMOVE_ANIM_DICT(func_29());
	}
	func_69();
	func_70();
...
void func_69()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && func_43(1, 0, 1)) && iLocal_36)
		{
			func_34(0, 1, 1, 0, 0, 0);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
