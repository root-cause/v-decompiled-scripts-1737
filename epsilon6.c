...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_50 = func_511(60);
	uLocal_51 = func_511(14);
	iLocal_94 = 1;
	iLocal_104 = -1;
	iLocal_105 = -1;
	fLocal_118 = 300f;
	...
	else if (func_475() == 0)
	{
		Global_71835 = 1;
		iLocal_49 = 0;
		while (!func_471(&Local_53))
		{
			SYSTEM::WAIT(0);
		}
		Global_71835 = 0;
	}
	if (func_470(Local_53.f_35[0]))
	{
		vLocal_54.x = Local_53.f_35[0];
		func_469(vLocal_54.x, 0);
	...
	if (func_467(Local_53.f_28[0]))
	{
		Local_62 = Local_53.f_28[0];
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_62, 1);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_443(Local_53.f_9, 0, 0, 0, 0, 0);
...
{
	func_9(&(Global_100114.f_2890), vParam0, fParam1);
}
	...
	switch (iLocal_70)
	{
		...
		case 1:
			...
			else
			{
				...
				if (func_233())
				{
					if (func_232(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1) > 300f && !ENTITY::IS_ENTITY_ON_SCREEN(vLocal_54.x))
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
						...
						TASK::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
						TASK::TASK_PERFORM_SEQUENCE(Local_61, uLocal_125);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
						iLocal_70 = 2;
					}
					...
					{
						if (func_232(Local_61, PLAYER::PLAYER_PED_ID(), 1) <= 2.3f)
						{
							if ((MISC::GET_GAME_TIMER() - iLocal_117) > 8000)
							{
								if (func_221(&uLocal_459, "EPS6AUD", "EPS6_FOLLOW", 7, 0, 0, 0))
								{
					...
					switch (iLocal_111)
					{
						...
						case 2:
							...
							else
							{
								...
								TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
								TASK::TASK_PERFORM_SEQUENCE(Local_61, uLocal_125);
								if (func_470(vLocal_54.x))
								{
									VEHICLE::SET_VEHICLE_ENGINE_ON(vLocal_54.x, true, 1, 0);
								}
								TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
								iLocal_111++;
							}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71402[1 /*14*/] = { func_105(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_97(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_97(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71402[1 /*14*/] = { func_105(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_71400 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71402[1 /*14*/] = { func_105(iVar10, 14, uVar15[iVar1], -1) };
			func_73(iParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
			func_88(14);
			if (Global_71400 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_107(int iParam0)
{
	...
	func_108(&(Global_71402[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_92(func_111(iParam1, uParam0->f_2), Global_71399, 0);
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_108(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_108(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_170(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_97(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_97(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_176()
{
	...
	{
		if (func_172(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_181(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_182(&sVar1, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}

void func_182(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_184(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_187()
{
	...
	{
		func_176();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_188(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
void func_234()
{
	if (func_467(Local_61))
	{
		if (func_238(Local_61, 0, 1116471296, 1126825984, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61, true), 3f, 1))
		{
			...
			{
				func_20();
				func_237(&uLocal_459, "EPS6AUD", "EPS6_SHOT", 9, 1, 0);
			}
			else
			{
				func_221(&uLocal_459, "EPS6AUD", "EPS6_SHOT", 9, 1, 0, 0);
			}
			func_236();
		}
		else if ((func_235(PLAYER::PLAYER_PED_ID(), Local_61, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61, true), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_61))
		{
			if (iLocal_69 != 5 && iLocal_69 != 3)
			{
				bLocal_101 = true;
...
{
	if (func_468(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		if (func_468(iParam1))
		{
	...
	if (func_467(PLAYER::PLAYER_PED_ID()) && func_467(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_251(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
bool func_241(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_242(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_242(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_243(iParam2, iParam5) };
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_247(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_247(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_246(vVar1, vVar0);
...
float func_246(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_247(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_254(int iParam0, float fParam1)
{
	...
	{
		if (func_255(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_255(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_247(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_260()
{
	if (func_233())
	{
		if (MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(vLocal_54.x, false), joaat("WEAPON_STICKYBOMB"), 10f, 0))
		{
	...
	switch (iLocal_69)
	{
		...
		case 2:
			...
			if (func_233())
			{
				if (!func_262())
				{
					func_267(ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 200f, 12, 5000, 0, 0);
				}
				if (func_233())
				{
		...
		case 3:
			...
			func_266(55);
			while (((!STREAMING::HAS_MODEL_LOADED(iLocal_625) || !STREAMING::HAS_MODEL_LOADED(Local_59.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_61.f_6)) || !func_265(55))
			{
		...
		case 4:
			...
			if (!func_262())
			{
				while (((((!STREAMING::HAS_MODEL_LOADED(Local_59.f_1) || !CUTSCENE::HAS_CUTSCENE_LOADED()) || !STREAMING::HAS_MODEL_LOADED(vLocal_54.y)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_61.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_265(55))
				{
			...
			{
				while ((((!STREAMING::HAS_MODEL_LOADED(Local_59.f_1) || !STREAMING::HAS_MODEL_LOADED(vLocal_54.y)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_61.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_265(55))
				{
					func_510("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					SYSTEM::WAIT(0);
				}
...
void func_264()
{
	switch (iLocal_69)
	{
		...
		case 5:
			if (!func_470(Local_59))
			{
				Local_59 = VEHICLE::CREATE_VEHICLE(Local_59.f_1, Local_59.f_3, Local_59.f_6, 1, 1, 0);
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_59.f_1, 1);
...
int func_265(int iParam0)
{
	if (!func_173(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(func_511(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_266(int iParam0)
{
	if (!func_173(iParam0))
	{
		STREAMING::REQUEST_MODEL(func_511(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_467(Local_62))
			{
				...
				ENTITY::SET_ENTITY_COORDS(Local_62, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
		...
		case 1:
			...
			{
				ENTITY::SET_ENTITY_HEADING(Local_62, 254.1723f);
				ENTITY::SET_ENTITY_COORDS(Local_62, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
				TASK::CLEAR_PED_TASKS(Local_62);
			}
			else
			{
...
void func_275()
{
	...
	PED::SET_PED_CAN_BE_TARGETTED(Local_62, false);
	TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
	TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	TASK::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
	TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
	TASK::TASK_PERFORM_SEQUENCE(Local_62, uLocal_125);
}
...
void func_276()
{
	switch (iLocal_69)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(vLocal_54.x))
			{
				if (func_467(PLAYER::PLAYER_PED_ID()))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 0))
					{
						func_277(PLAYER::PLAYER_PED_ID(), -2882.42f, 3197.76f, 10.74f, 0, 0, 1);
					}
				}
				VEHICLE::DELETE_VEHICLE(&vLocal_54);
			}
			vLocal_54.x = VEHICLE::CREATE_VEHICLE(iLocal_625, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
			...
			VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(vLocal_54.x, 0);
			VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(vLocal_54.x, true);
			func_469(vLocal_54.x, 0);
		...
		case 2:
			...
			{
				vLocal_54.x = VEHICLE::CREATE_VEHICLE(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
				VEHICLE::SET_VEHICLE_COLOURS(vLocal_54.x, 157, 157);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(vLocal_54.x, 157, 5);
		...
		case 4:
			...
			vLocal_54.x = VEHICLE::CREATE_VEHICLE(vLocal_54.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
			if (func_470(vLocal_54.x))
			{
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
		...
		case 5:
			...
			if (!bLocal_80)
			{
				...
				vLocal_54.x = VEHICLE::CREATE_VEHICLE(vLocal_54.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
				if (func_470(vLocal_54.x))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
					VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(vLocal_54.y, 1);
}

int func_277(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_278()
{
	switch (iLocal_69)
	{
		...
		case 4:
			if (!func_467(Local_61))
			{
				while (!func_282(&Local_61, 55, Local_61.f_2, Local_61.f_5, "JimmyB", 1))
				{
					SYSTEM::WAIT(0);
				}
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_61, 1);
			...
			{
				func_277(Local_61, Local_61.f_2, Local_61.f_5, 0, 1);
				if (func_467(Local_61))
				{
					TASK::TASK_PLAY_ANIM(Local_61, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
					PED::SET_PED_PROP_INDEX(Local_61, 1, 0, 0, false);
			...
			{
				iLocal_126 = OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), ENTITY::GET_ENTITY_COORDS(Local_61, true), 1, true, 0);
			}
		...
		case 5:
			if (!bLocal_80)
			{
				if (!func_467(Local_61))
				{
					while (!func_282(&Local_61, 55, 1683.76f, 3270.74f, 39.78f, 168.3395f, "JimmyB", 1))
					{
						SYSTEM::WAIT(0);
					}
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_61, 1);
					...
					{
						Local_61.f_1 = func_280(Local_61, 1, 1, 9);
					}
					if (func_467(Local_61) && func_233())
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
				...
				{
					func_277(Local_61, 1683.76f, 3270.74f, 39.78f, 168.3395f, 0, 1);
					if (!HUD::DOES_BLIP_EXIST(Local_61.f_1))
					{
						Local_61.f_1 = func_280(Local_61, 1, 1, 9);
					}
...
int func_280(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_281(int iParam0)
{
	if (!func_173(iParam0))
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_511(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
int func_282(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_283(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_283(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_285()
{
	switch (iLocal_69)
	{
		case 0:
			...
			if (!func_262())
			{
				func_277(PLAYER::PLAYER_PED_ID(), -2914.707f, 3234.639f, 9.7863f, 215.2149f, 0, 1);
			}
			break;
		...
		case 1:
			if (func_470(vLocal_54.x))
			{
				func_277(PLAYER::PLAYER_PED_ID(), -2892.93f, 3192.37f, 11.66f, 0, 0, 1);
				PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, -1);
			}
			break;
		...
		case 2:
			if (!func_262())
			{
				if (func_467(PLAYER::PLAYER_PED_ID()) && func_470(vLocal_54.x))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 0))
					{
						PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, -1);
		...
		case 4:
			if (!func_262())
			{
				func_277(PLAYER::PLAYER_PED_ID(), 1681.54f, 3259.38f, 39.77f, 298.33f, 0, 1);
			}
			break;
		...
		case 5:
			if (!func_262())
			{
				func_277(PLAYER::PLAYER_PED_ID(), 1688.45f, 3277.15f, 40.08f, 131.1749f, 1, 1);
			}
			break;
	}
	CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
void func_286(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_359(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_220(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_356(&(Global_93682.f_3));
				if (iVar6 > -1)
				{
...
{
	func_288(&Global_100114, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_288(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_228();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_311(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_310())
		{
			func_306(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_297(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_311(int iParam0, bool bParam1)
{
	...
	iVar0 = func_171(iParam0);
	if (func_173(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
...
void func_312(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_317(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_314(Var7.f_1)) && iVar9 < 51)
			{
...
int func_320(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_324(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return MISC::IS_BIT_SET(func_92(func_325(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
var func_345()
{
	...
	func_355(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_354(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_353(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_348(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_347(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_346(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_351(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_388(1, 1093140480, 0))
			{
				...
				if (func_233())
				{
					ENTITY::SET_ENTITY_COORDS(vLocal_54.x, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
		...
		case 2:
			...
			func_277(vLocal_54.x, 1684.78f, 3255.58f, 41.78f, 284.26f, 0, 1);
			if (STREAMING::_0xBC9823AB80A3DCAC())
			{
				STREAMING::_0x1EE7D8DF4425F053(uLocal_124);
			}
...
void func_364(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_368(PLAYER::PLAYER_ID())) && !func_366(PLAYER::PLAYER_ID(), 0)) && !func_365()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_368(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71588 = 0;
...
int func_370(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_372()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ep_plane", 0))
	{
		...
		if (func_233())
		{
			ENTITY::SET_ENTITY_COORDS(vLocal_54.x, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(vLocal_54.x, 284.26f);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
		}
		else
...
void func_373()
{
	if (func_467(Local_61))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			if (func_467(Local_61) && func_233())
			{
				func_277(Local_61, 1682.13f, 3268.65f, 39.75f, 183.3768f, 0, 1);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
				TASK::TASK_ENTER_VEHICLE(0, vLocal_54.x, 20000, -1, 2f, 1, 0);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
			...
			PED::FORCE_PED_MOTION_STATE(Local_61, -530524, 0, 1, 0);
		}
	}
}
...
int func_374()
{
	if (func_467(PLAYER::PLAYER_PED_ID()))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			...
			func_277(Local_59, Local_59.f_3, Local_59.f_6, 1, 1);
			if (func_470(Local_59))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_59, 1);
			}
...
void func_377(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_378(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_380(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_381(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_381(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_383(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_383(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_247(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_384(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_384(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_384(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_384(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_384(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_384(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_384(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_384(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_384(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_384(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_384(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_384(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_384(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_384(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_384(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_384(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_388(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_392(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_391(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_394()
{
	switch (iLocal_70)
	{
		case 0:
			...
			VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			while ((((!func_265(55) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_61.f_6)) || !STREAMING::HAS_MODEL_LOADED(Local_59.f_1)) || !STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01"))) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
			{
				SYSTEM::WAIT(0);
			}
			if (iLocal_79)
			...
			if (func_233())
			{
				VEHICLE::SET_VEHICLE_ENGINE_ON(vLocal_54.x, false, 0, 0);
			}
			if (!HUD::DOES_BLIP_EXIST(Local_61.f_1))
			{
				Local_61.f_1 = func_280(Local_61, 1, 1, 9);
			...
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				...
				if (func_467(PLAYER::PLAYER_PED_ID()))
				{
					func_401("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
				}
				CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("Jimmy_Boston", 1, 0, 0, 0);
			}
			if (iLocal_127 == -1)
		...
		case 1:
			...
			if (func_467(Local_61))
			{
				if (func_232(PLAYER::PLAYER_PED_ID(), Local_61, 1) < 100f)
				{
				...
				else if (func_232(PLAYER::PLAYER_PED_ID(), Local_61, 1) > 120f)
				{
					if (CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			if (func_233())
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (func_395(PLAYER::PLAYER_PED_ID(), Local_61, 13f, 1))
					{
				...
				else if (func_395(PLAYER::PLAYER_PED_ID(), Local_61, 5f, 1))
				{
					if (func_467(PLAYER::PLAYER_PED_ID()) && func_467(Local_61))
					{
...
void func_396()
{
	if (func_232(PLAYER::PLAYER_PED_ID(), Local_61, 1) <= 15f)
	{
		if (!STREAMING::_0xBC9823AB80A3DCAC())
		{
			if (!STREAMING::_0x7D41E9D2D17C5B2D(uLocal_124))
			{
				func_510("Loading streamvol");
				uLocal_124 = STREAMING::_0x1F3F018BC3AFA77C(1684.85f, 3276.16f, 39.93f, func_397(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_398()
{
	...
	if (func_467(Local_61) && func_467(PLAYER::PLAYER_PED_ID()))
	{
...
void func_400()
{
	if (func_467(Local_61))
	{
		...
		else if (func_232(PLAYER::PLAYER_PED_ID(), Local_61, 1) <= 25f && func_22())
		{
			if (!PED::IS_PED_HEADTRACKING_PED(Local_61, PLAYER::PLAYER_PED_ID()))
			{
	...
	if (!func_22() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_467(Local_61) && func_467(PLAYER::PLAYER_PED_ID()))
		{
			if (func_395(PLAYER::PLAYER_PED_ID(), Local_61, 25f, 1))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_109) > 15000)
				{
					if (func_221(&uLocal_459, "EPS6AUD", "EPS6_BECKON", 8, 0, 0, 0))
					{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			...
			if (func_233())
			{
				if (iLocal_97 == 0)
				{
					if (func_415(vLocal_54.x, Local_60, 1) < 1100f)
					{
						func_286(1, "Landing stage", 0, 0, 0, 1);
						iLocal_97 = 1;
				...
				if (iLocal_98 == 0)
				{
					if (func_415(vLocal_54.x, Local_60, 1) < 350f)
					{
						STREAMING::REQUEST_MODEL(Local_59.f_1);
						func_266(55);
						STREAMING::REQUEST_ANIM_DICT(Local_61.f_6);
						...
						if (((STREAMING::HAS_MODEL_LOADED(Local_59.f_1) && func_265(55)) && STREAMING::HAS_ANIM_DICT_LOADED(Local_61.f_6)) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
						{
							func_278();
							func_264();
							func_15(&uLocal_459, 3, Local_61, "JIMMYBOSTON", 0, 1);
				...
				else
				{
					...
					{
						vLocal_54.z = func_411(vLocal_54.x, 1, 5);
					...
					{
						if (func_415(vLocal_54.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							if (!iLocal_84)
							{
			...
			if (func_470(vLocal_54.x))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(vLocal_54.x, vLocal_121, vLocal_122, 33.25f, 0, true, 2))
				{
					...
					if (VEHICLE::GET_LANDING_GEAR_STATE(vLocal_54.x) == 0 || VEHICLE::GET_LANDING_GEAR_STATE(vLocal_54.x) == 3)
					{
						...
						if (func_407() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 0))
						{
							func_510("*** Finishing Landing cleanup");
							func_406("*** Plane 'entity' health: ", ENTITY::GET_ENTITY_HEALTH(vLocal_54.x));
							func_405("*** Plane engine health: ", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(vLocal_54.x));
							func_405("*** Plane petrol tank health: ", VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(vLocal_54.x));
				...
				else
				{
					...
					VEHICLE::SET_VEHICLE_ENGINE_ON(vLocal_54.x, true, 0, 0);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(vLocal_54.x, 1);
					iLocal_70 = 1;
				}
			}
...
void func_412()
{
	if (func_467(Local_61))
	{
		if (func_232(Local_61, vLocal_54.x, 1) < 17f)
		{
			if (!bLocal_92)
			{
				if (!func_22())
				{
					if (func_221(&uLocal_459, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						bLocal_92 = true;
		...
		if (func_232(Local_61, vLocal_54.x, 1) < 12f)
		{
			func_236();
			iLocal_128 = 5;
			iLocal_70 = 0;
...
void func_413()
{
	...
	else
	{
		...
		{
			Local_60.f_3 = func_414(Local_60, 5, 1);
		}
	}
}

int func_414(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
float func_415(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
void func_417()
{
	...
	if (iLocal_69 >= 1)
	{
		...
		if (func_22())
		{
			...
			{
				if (func_415(PLAYER::PLAYER_PED_ID(), vVar0, 1) > 35f)
				{
					if (func_22())
					{
		...
		if (func_415(PLAYER::PLAYER_PED_ID(), vVar0, 1) > 450f)
		{
			func_7(&Local_62, 1, 0, 1);
		}
	}
	...
	switch (iLocal_73)
	{
		case 0:
			...
			else if (iLocal_74 == 1)
			{
				...
				{
					case 0:
						if (func_232(PLAYER::PLAYER_PED_ID(), Local_62, 1) < 50f)
						{
							if (!func_22())
							{
					...
					case 1:
						if (func_221(&uLocal_129, "EPS6AUD", "EPS6_CULT", 8, 0, 0, 0))
						{
							iLocal_106++;
				...
				if (func_467(PLAYER::PLAYER_PED_ID()) && func_470(vLocal_54.x))
				{
					if (func_232(PLAYER::PLAYER_PED_ID(), Local_62, 1) < 10f || func_232(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1) < 10f)
					{
		...
		case 1:
			if (iLocal_74 == 0)
			{
				if (func_468(Local_62))
				{
					...
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						{
							func_430();
							func_237(&uLocal_129, "EPS6AUD", "EPS6_INCAR", 7, 0, 0);
						}
						else
						{
							func_221(&uLocal_129, "EPS6AUD", "EPS6_INCAR", 8, 1, 0, 0);
						}
					}
					else if (func_22())
					{
						func_428();
						func_237(&uLocal_129, "EPS6AUD", "EPS6_INCAR", 8, 0, 0);
					}
					else
					{
						func_221(&uLocal_129, "EPS6AUD", "EPS6_INCAR", 8, 0, 0, 0);
					}
					iLocal_74 = 1;
				}
			}
			...
			{
				if ((func_467(PLAYER::PLAYER_PED_ID()) && func_470(vLocal_54.x)) && func_468(Local_62))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_232(PLAYER::PLAYER_PED_ID(), Local_62, 1) < 15f || func_232(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1) < 10f)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
							{
								func_258(2);
		...
		case 2:
			if (iLocal_74 == 0)
			{
				if (func_467(Local_62))
				{
					...
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						func_426(&uLocal_129, "EPS6AUD", "EPS6_SPOT", "EPS6_SPOT_1", 8, 1, 0);
						iLocal_116 = 0;
						iLocal_103 = 1;
					...
					{
						func_428();
						func_237(&uLocal_129, "EPS6AUD", "EPS6_SPOT", 8, 0, 0);
					...
					else if (func_221(&uLocal_129, "EPS6AUD", "EPS6_SPOT", 8, 0, 0, 0))
					{
						iLocal_116 = 0;
			...
			else if (iLocal_74 == 1)
			{
				...
				if (func_425())
				{
					if (func_221(&uLocal_129, "EPS6AUD", "EPS6_SHPLNE", 8, 0, 0, 0))
					{
						iLocal_102 = 1;
						func_258(3);
					}
				}
				if (func_239(Local_62, 1126825984))
				{
					if (func_22())
					{
						func_428();
				...
				if (iLocal_103 == 1)
				{
					if (!func_22())
					{
						if (!bLocal_100)
						{
							if (func_424(&uLocal_129, "EPS6AUD", "EPS6_SPOT", "EPS6_SPOT_3", 8, 0, 0))
							{
								iLocal_103 = 0;
				...
				else if ((MISC::GET_GAME_TIMER() - iLocal_116) > 1000 || iLocal_116 == 0)
				{
					...
					if (func_409("EPS6_SPOT"))
					{
						...
						{
							if (func_423(Local_62, PLAYER::PLAYER_PED_ID()) > 10f)
							{
								func_20();
								bLocal_96 = true;
							}
				...
				if (bLocal_96)
				{
					if (func_221(&uLocal_129, "EPS6AUD", "EPS6_TOOFAR", 8, 0, 0, 0))
					{
						func_258(5);
					}
				}
				if (func_470(vLocal_54.x) && func_467(Local_62))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1))
					{
						...
						while (!func_221(&uLocal_129, "EPS6AUD", "EPS6_LEAVE", 8, 0, 0, 0))
						{
							SYSTEM::WAIT(0);
						}
						func_258(4);
		...
		case 3:
			if (iLocal_74 == 0)
			{
				...
				if (iLocal_102 == 0)
				{
					func_421(Local_62, "AIMED_AT_BY_PLAYER", "TOM", 4);
					if (!func_391(Local_62, -1519143300))
					{
						TASK::CLEAR_PED_TASKS(Local_62);
			...
			else if (iLocal_74 == 1)
			{
				if (!func_239(Local_62, 1126825984))
				{
					...
					else if ((MISC::GET_GAME_TIMER() - iLocal_107) > 1200)
					{
						...
						if (iLocal_102 == 0)
						{
							if (func_221(&uLocal_129, "EPS6AUD", "EPS6_LEAVE", 8, 0, 0, 0))
							{
								iLocal_102 = 1;
								func_258(4);
							}
		...
		case 4:
			if (iLocal_74 == 0)
			{
				if (func_468(Local_62))
				{
					if (func_415(Local_62, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						TASK::CLEAR_PED_TASKS(Local_62);
			...
			else if (iLocal_74 == 1)
			{
				if (iLocal_69 == 0)
				{
					if (iLocal_81 == 0)
					{
						if ((!func_409("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							func_420("EPS6_GETIN", 7500, 1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_422(iParam3), 0);
}
...
void func_427()
{
	if (iLocal_73 == 2)
	{
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_467(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
				{
					TASK::CLEAR_PED_TASKS(Local_62);
					vLocal_628 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
			...
			case 2:
				if (func_467(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
				{
					if (func_232(Local_62, PLAYER::PLAYER_PED_ID(), 1) < 5f || TASK::GET_SCRIPT_TASK_STATUS(Local_62, 242628503) == 7)
					{
						TASK::CLEAR_PED_TASKS(Local_62);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_75 = 0;
...
void func_432()
{
	if (func_467(Local_62))
	{
		switch (iLocal_76)
		{
			...
			case 1:
				if (!func_391(Local_62, 713668775))
				{
			...
			case 2:
				if (func_415(Local_62, vLocal_78[iLocal_77 /*3*/], 1) <= 1.2f)
				{
					iLocal_76 = 3;
...
int func_433()
{
	if (func_467(PLAYER::PLAYER_PED_ID()) && func_467(Local_62))
	{
		if (func_252(Local_62, 0, 0, 0, 0))
		{
...
int func_435()
{
	if ((func_238(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_235(PLAYER::PLAYER_PED_ID(), Local_62, 0)) || func_425())
	{
		if (func_238(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			func_510("Player threatened cultist");
		}
		if (func_235(PLAYER::PLAYER_PED_ID(), Local_62, 0))
		{
		...
		if (func_468(Local_62))
		{
			...
			func_421(Local_62, "FIGHT_RUN", "TOM", 4);
		}
		return 1;
	}
	return 0;
...
void func_436()
{
	if (bLocal_100 == 0)
	{
		if (func_468(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_99 == 0)
			{
			...
			else if (func_468(Local_62))
			{
				if (TASK::IS_PED_GETTING_UP(Local_62) || PED::IS_PED_ON_FOOT(Local_62))
				{
					if (!func_22() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (func_221(&uLocal_129, "EPS6AUD", "EPS6_PUSHED", 8, 0, 0, 0))
						{
							iLocal_99 = 0;
							bLocal_100 = true;
						}
...
void func_439()
{
	switch (iLocal_70)
	{
		case 0:
			...
			if (iLocal_72 <= 0)
			{
				func_221(&uLocal_129, "EPS6AUD", "EPS6_LEAVE", 8, 0, 0, 0);
			}
			if (func_233())
			{
				func_406("*** Plane 'entity' health: ", ENTITY::GET_ENTITY_HEALTH(vLocal_54.x));
		...
		case 1:
			...
			if (func_233())
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 0))
				{
					...
					if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
					{
						if (func_415(PLAYER::PLAYER_PED_ID(), Local_60, 0) < 2300f)
						{
							iLocal_70 = 2;
						}
					}
...
void func_440()
{
	...
	switch (iLocal_71)
	{
		...
		case 2:
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (func_441(&uLocal_294, 55, "EPS6AUD", "EPS6_FLIGHT", 11, 1, 0, 0, 0))
				{
					PLAYER::SET_MAX_WANTED_LEVEL(5);
					RECORDING::_0x293220DA1B46CEBC(3f, 10f, 1);
					iLocal_71 = 3;
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_467(Local_62))
			{
				...
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_104, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_62), "EPSILONISM_04_SOUNDSET", 0, 0);
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_105, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_62), "EPSILONISM_04_SOUNDSET", 0, 0);
			}
			if (!HUD::DOES_BLIP_EXIST(Local_62.f_1))
			{
				Local_62.f_1 = func_280(Local_62, 1, 1, 5);
			}
			if (func_233())
			{
				func_406("*** Plane 'entity' health: ", ENTITY::GET_ENTITY_HEALTH(vLocal_54.x));
		...
		case 1:
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 50f)
			{
				...
				else
				{
					...
					{
						if (func_221(&uLocal_129, "EPS6AUD", "EPS6_RUNAWAY", 8, 0, 0, 0))
						{
			...
			else if (iLocal_84)
			{
				if (iLocal_85)
				{
					...
					if (func_424(&uLocal_129, "EPS6AUD", &vLocal_88, &cVar0, 8, 0, 0))
					{
						iLocal_85 = 0;
						iLocal_84 = 0;
					}
...
void func_443(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_445(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_446(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_456(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_272(0)) || func_455(1))
			{
			}
			else
			{
...
int func_471(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_474(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			if (func_467(uParam0->f_28[0]) && func_468(PLAYER::PLAYER_PED_ID()))
			{
...
void func_472(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_4(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_473(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_5(iParam0);
...
void func_491(bool bParam0)
{
	...
	if (!func_503())
	{
		...
		{
			func_181(iVar0, 1, 0);
			func_492(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
