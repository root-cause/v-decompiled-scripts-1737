...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105652[Var0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_105652[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	if (!func_262(&iVar2, &Var0, vVar1, 1f))
	{
		func_261();
	...
	while (true)
	{
		...
		func_200(Var0);
		func_193(&iLocal_53, &(Var0.f_9), vVar1);
		if (Var0 == 44)
		{
			func_185(&Var0, vVar1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_54);
			func_184();
		}
		else if (Var0 == 45)
		{
			func_185(&Var0, vVar1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_55);
			func_182(&Var0);
		}
		if (func_167(&Var0, 0))
		{
...
void func_182(int iParam0)
{
	...
	{
		if (func_126(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_126(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
...
void func_184()
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_58) > 1250)
	{
		AUDIO::PLAY_SOUND_FROM_COORD(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = MISC::GET_GAME_TIMER();
	}
}

int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					func_282("start conversation");
					uVar0 = 16;
					if (*uParam6 == 0)
					{
			...
			if (func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam6 == 1)
			{
				func_282("unpause conversation");
				func_186(0);
				*uParam6 = 2;
			}
		}
...
void func_193(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_201(int iParam0, bool bParam1)
{
	...
	func_109(*iParam0, &Var0);
	if ((func_238(*iParam0) || func_236(*iParam0)) || Global_71835 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_205(&(iParam0->f_48)) && bParam1)
	{
		func_202(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
{
	if ((func_237() && Global_93682.f_11 == 6) && iParam0 == func_165(&(Global_93682.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_250(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_245(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_243(&(uParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_250(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_245(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_126(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
...
int func_263(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_264(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
