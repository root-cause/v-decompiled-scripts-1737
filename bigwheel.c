...
void func_5(var uParam0)
{
	...
	if (*uParam0 == 1)
	{
		...
		if (CAM::DOES_CAM_EXIST(uParam0->f_10))
		{
			...
			{
				func_6(ENTITY::GET_ENTITY_COORDS(uParam0->f_8, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_9, 1), &uVar0, &uVar1, 1);
...
void func_24()
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(iLocal_161, vLocal_166, 1, 0, 0, 1);
...
void func_25(var uParam0)
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(uParam0->f_3, vVar0, 1, 0, 0, 1);
...
void func_31()
{
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
	func_202(1);
	func_201(&uLocal_40, 0, iLocal_158);
	func_201(&uLocal_40, 1, iLocal_159);
	func_199(&uLocal_40, 2, 2, sLocal_160, 0);
	func_199(&uLocal_40, 3, 4, "SCRIPT\FERRIS_WHALE_01", 0);
	func_199(&uLocal_40, 4, 4, "SCRIPT\FERRIS_WHALE_02", 0);
	while (!func_196(&uLocal_40))
	{
		SYSTEM::WAIT(0);
	}
	...
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_171, "GENERATOR", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_173 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_173, "SLOW_SQUEAK", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_174 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_174, "SLOW_SQUEAK", Local_162[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_172 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_172, "CARRIAGE", Local_162[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
}
...
void func_33()
{
	...
	func_43(64, 1, 0, 1, 0);
	iLocal_161 = OBJECT::CREATE_OBJECT(iLocal_158, 0f, 1f, 2f, 1, true, 0);
	ENTITY::SET_ENTITY_COORDS(iLocal_161, vLocal_166, 1, 0, 0, 1);
...
void func_34(var uParam0, int iParam1, bool bParam2)
{
	...
	func_38(uParam0);
	uParam0->f_2 = iParam1;
	uParam0->f_3 = OBJECT::CREATE_OBJECT(iLocal_159, 0f, 1f, 2f, 1, true, 0);
	func_25(uParam0);
	if (bParam2 == 1)
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_62(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
void func_57()
{
	...
	{
		if (func_61(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_60(PLAYER::PLAYER_PED_ID());
			if (func_59(iVar0) && (!func_58(14) || Global_105516))
			{
				if (Global_106565.f_2357.f_539.f_4321 != iVar0 && func_59(Global_106565.f_2357.f_539.f_4321))
				{
...
int func_62(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_63(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_63(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_63(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_63(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_63(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_63(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_63(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_63(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_63(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_63(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_63(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_63(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_63(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_63(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_63(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_63(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_63(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71402[1 /*14*/] = { func_121(iVar10, iParam1, iParam2, -1) };
		if (!func_120(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71402[1 /*14*/] = { func_121(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71402[1 /*14*/] = { func_121(iVar10, 14, uVar12[iVar1], -1) };
			...
			{
				Global_71402[1 /*14*/] = { func_121(iVar10, iVar0, func_79(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71402[1 /*14*/] = { func_121(iVar10, 14, uVar15[iVar1], -1) };
			func_90(iParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
			func_112(14);
			if (Global_71400 == 1)
			{
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_185(iParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_64, Global_106565.f_2357.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71402[1 /*14*/] = { func_121(iParam0, iParam1, iParam2, -1) };
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_185(iParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_61, Global_106565.f_2357.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_112(int iParam0)
{
	...
	{
		func_119(iParam0, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 2, Global_71402[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_123(int iParam0)
{
	...
	func_124(&(Global_71402[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_124(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_128(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_128(Global_2621444, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_117(func_127(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_117(func_126(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_117(iVar1, Global_71399, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_185(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71402[1 /*14*/] = { func_121(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_185(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_185(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71402[2 /*14*/] = { func_121(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_71402[2 /*14*/] = { func_121(iVar0, iVar2, iVar1, -1) };
...
void func_187(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_191(PLAYER::PLAYER_ID())) && !func_189(PLAYER::PLAYER_ID(), 0)) && !func_188()) && !bParam4) && !bParam5)
			{
...
int func_193(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
bool func_196(var uParam0)
{
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_116 || uParam0->f_116 == 0)
	{
		...
		{
			func_198(uParam0, uParam0->f_115);
			uParam0->f_115++;
		}
...
void func_210()
{
	...
	{
		func_213(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
...
void func_217(int iParam0, int iParam1)
{
	...
	{
		func_218(func_56(), iParam1, iParam0);
	}
}
...
int func_218(int iParam0, int iParam1, int iParam2)
{
	...
	return func_219(Global_106565.f_28044[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_222(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_224() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_224() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_223(iParam0));
...
bool func_226(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_224() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_247(int iParam0, int iParam1, int iParam2, float fParam3)
{
	int iVar0;
	int iVar1;
	float fVar2;
