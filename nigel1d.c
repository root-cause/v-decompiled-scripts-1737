...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_50 = func_559(64);
	uLocal_51 = func_559(63);
	...
	if (func_527())
	{
		Global_71835 = 1;
		iLocal_49 = 0;
		while (!func_521(&Local_66, &uLocal_333))
		{
			SYSTEM::WAIT(0);
		}
		func_520(&Local_66, 0, 1);
		Global_71835 = 0;
		func_519("Set up script for replay");
	}
	...
	MISC::CLEAR_BIT(&(Global_106565.f_18568.f_382), 4);
	func_507();
	iVar0 = 0;
	while (iVar0 <= (Local_303 - 1))
	{
		if (func_506(Local_303[iVar0 /*13*/]))
		{
	...
	if (func_527() || func_505(0))
	{
		if (func_505(0) && !func_527())
		{
			iVar1 = 0;
			func_504(PLAYER::PLAYER_PED_ID(), -1291.596f, -12.9214f, 48.5137f, 294.7073f, 0, 1);
		}
		else
		{
			iVar1 = func_503();
		}
		func_502("Replay stage grabbed: ", iVar1);
		if (Global_87889 == 1)
		{
			iVar1++;
		}
		...
		{
			case 0:
				func_502("Replay skipping to stage ", 1);
				func_501(-1291.596f, -12.9214f, 48.5137f, 294.7073f, 1, 0);
				func_493(1, 0);
				break;
			
			case 1:
				func_502("Replay skipping to stage ", 3);
				func_501(-1190.22f, 36.83f, 52.03f, 299f, 1, 0);
				func_493(3, 0);
				break;
			
			case 2:
				func_502("Replay skipping to stage ", 7);
				func_501(-1324.854f, 60.2491f, 52.54f, 94.6913f, 1, 0);
				func_493(7, 0);
				break;
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_477(Local_66.f_9, 0, 0, 0, 0, 0);
		if (func_506(Local_293))
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_270) > 2000)
			{
				if (!iLocal_269)
				{
					func_476(Local_293, 0);
					func_519("Added Mark to headshot watch");
					iLocal_269 = 1;
				}
			}
		}
		...
		{
			if (func_506(PLAYER::PLAYER_PED_ID()))
			{
				switch (iLocal_67)
				{
					case 0:
...
void func_2()
{
	...
	{
		case 0:
			func_519("In INTRO_PHONECALL stage skip");
			if (iLocal_69 == 1)
			{
				if (func_14())
				{
		...
		case 1:
			func_519("In GO_TO_THE_GOLF_CLUB stage skip");
		...
		case 2:
			func_519("Skipping MS_GO_TO_CELBRITY...");
			iLocal_248 = 0;
			if (func_14())
			{
				func_15();
		...
		case 3:
			func_519("In GO_TO_CELBRITY stage skip");
			if (func_14())
			{
				func_15();
			}
		...
		case 4:
			func_519("Skipping MS_CHASE_THE_GOLFER...");
			if (func_5(Local_317))
			{
			...
			if (!func_32())
			{
				...
				{
					func_519("Skip buggy isn't okay, probably going to fail");
				}
			}
			iLocal_260 = 0;
			iLocal_69 = 2;
		...
		case 5:
			func_519("Skipping MS_CHASE_IN_CITY...");
			if (func_5(Local_317))
			{
				ENTITY::SET_ENTITY_HEALTH(Local_317, 450, 0);
				func_519("SKIPPED CITY CHASE SETTING HEALTH TO 450 ");
			}
			if (func_506(iLocal_323))
			{
		...
		case 6:
			func_519("Skipping MS_COLLECT_GOLF_CLUB...");
			if (!func_32())
			{
				if (func_506(PLAYER::PLAYER_PED_ID()))
				{
...
void func_36()
{
	...
	{
		case 0:
			func_519("ENTERING END PHONECALL");
			...
			if (func_506(PLAYER::PLAYER_PED_ID()))
			{
				...
				while (iVar0 <= 2)
				{
					...
					func_289(&(Local_303[iVar0 /*13*/].f_11));
					iVar0++;
				}
				func_289(&iLocal_237);
				...
				func_287(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				func_287(&uLocal_72, 3, 0, "NIGEL", 0, 1);
				func_287(&uLocal_72, 4, 0, "MRSTHORNHILL", 0, 1);
				iLocal_69 = 1;
				func_519("ENTERING END PHONECALL LOOP");
			}
			break;
		...
		case 2:
			func_519("CLEANUP END PHONECALL");
			HUD::CLEAR_PRINTS();
			func_37();
			break;
	}
...
void func_41()
{
	...
	{
		func_43(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
...
int func_64(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71402[1 /*14*/] = { func_115(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71402[1 /*14*/] = { func_115(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_107(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_107(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_65(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_180(iParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_64, Global_106565.f_2357.f_539[iVar0 /*65*/].f_63))
		{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71402[1 /*14*/] = { func_115(iVar10, iParam1, iParam2, -1) };
		if (!func_105(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71402[1 /*14*/] = { func_115(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71402[1 /*14*/] = { func_115(iVar10, 14, uVar12[iVar1], -1) };
							func_83(iParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
							func_98(14);
							if (Global_71400 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_107(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_98(iVar0);
						if (Global_71400 == 1)
						{
			...
			{
				Global_71402[1 /*14*/] = { func_115(iVar10, iVar0, func_73(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71402[1 /*14*/] = { func_115(iVar10, 14, uVar15[iVar1], -1) };
			func_83(iParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
			func_98(14);
			if (Global_71400 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_107(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
{
	Global_71402[1 /*14*/] = { func_115(iParam0, iParam1, iParam2, -1) };
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_98(int iParam0)
{
	...
	{
		func_104(iParam0, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 2, Global_71402[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2539502[iParam0 /*3*/][func_101(iParam2)];
	if (iVar0 != 0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2539502[iParam0 /*3*/][func_101(iParam1)];
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_180(iParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_61, Global_106565.f_2357.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_114(&Var1, -99, -99, Global_106565.f_2357.f_539.f_196[0], Global_106565.f_2357.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_114(&Var1, -99, -99, Global_106565.f_2357.f_539.f_196[1], Global_106565.f_2357.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_114(&Var1, -99, -99, Global_106565.f_2357.f_539.f_196[2], Global_106565.f_2357.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_117(int iParam0)
{
	...
	func_118(&(Global_71402[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_102(func_121(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_102(func_120(iParam1, uParam0->f_2), Global_71399, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_102(iVar1, Global_71399, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_180(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_180(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_180(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71402[2 /*14*/] = { func_115(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_71402[2 /*14*/] = { func_115(iVar0, iVar2, iVar1, -1) };
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_107(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_107(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_184()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_235(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_181(PLAYER::PLAYER_PED_ID());
			if (func_185(iVar0) && (!func_123(14) || Global_105516))
			{
				if (Global_106565.f_2357.f_539.f_4321 != iVar0 && func_185(Global_106565.f_2357.f_539.f_4321))
				{
...
void func_196()
{
	...
	{
		func_184();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_197(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
int func_233(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 1, Global_71402[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
		...
		{
			func_104(iParam1, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 1, Global_71402[1 /*14*/].f_1, 0, 1);
		}
...
int func_234(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 0, Global_71402[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_104(iParam1, Global_71402[1 /*14*/].f_5, Global_71402[1 /*14*/].f_2, 0, Global_71402[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
bool func_238(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
void func_248()
{
	...
	if (func_506(Local_293))
	{
		switch (iLocal_68)
		{
			case 0:
				...
				if (func_266(Local_293, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						...
						func_519("GS_WAIT_FOR_PLAYER, player threatened Glen; attacking...");
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
				{
					if (!func_180(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						...
						func_519("GS_WAIT_FOR_PLAYER, player got too close to Glen (alert_dis); attacking...");
						func_258();
						ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293, PED::GET_PED_BONE_INDEX(Local_293, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
						iLocal_68 = 3;
					}
			...
			case 1:
				...
				{
					func_519("GS_PLAYER_IN_OUTFIT, player threatened Glen or returned a second time; attacking...");
					func_258();
				}
				else
				{
					...
					if ((func_5(Local_317) && func_5(Local_316[5 /*6*/])) && func_506(PLAYER::PLAYER_PED_ID()))
					{
			...
			case 2:
				if (func_266(Local_293, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_519("GS_ANGRY_AT_PLAYER, player threatened Glen; attacking...");
					func_258();
				}
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
				{
			...
			case 3:
				if (((func_5(Local_317) && func_256(Local_293, Local_317, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_317))
				{
			...
			case 7:
				func_519("Celeb crashed or forced out - quitting chase");
				if (iLocal_67 < 6)
				{
	...
	else
	{
		if (!iLocal_272)
		{
			func_519("bReplayCelebDeadCheck tripped, recording last 2 seconds");
			RECORDING::_0x293220DA1B46CEBC(2f, 2f, 0);
			iLocal_272 = 1;
		}
		if (!MISC::IS_BIT_SET(Global_106565.f_18568.f_382, 4))
		{
			MISC::SET_BIT(&(Global_106565.f_18568.f_382), 4);
		}
	}
}
...
int func_249()
{
	if (ENTITY::GET_ENTITY_SPEED(Local_317) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
	{
		...
		{
			TASK::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_317);
			if (func_5(Local_317) && func_506(Local_293))
			{
			...
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (!func_14())
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_284) > 15000)
					{
						if (func_6(Local_293))
						{
							if (func_252(Local_293, PLAYER::PLAYER_PED_ID()) < 40f)
							{
								func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
								func_287(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								switch (iLocal_278)
...
void func_253()
{
	...
	func_519("RESET COURSE SECURITY");
	iLocal_251 = 1;
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		if (func_506(Local_304[iVar0 /*13*/]))
		{
			iLocal_310[iVar0] = 1;
		}
		iVar0++;
...
int func_254()
{
	if (func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (func_255(&uLocal_437, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
		{
			return 1;
		}
	}
...
bool func_255(var uParam0, struct<2> Param1, float fParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
float func_256(int iParam0, int iParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar1;
	...
	if (iLocal_255 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_506(Local_303[iVar0 /*13*/]))
			{
				...
				{
					Local_303[iVar0 /*13*/].f_11 = func_262(Local_303[iVar0 /*13*/], 0, 0, 5);
				}
				func_502("Attack player, security guard: ", iVar0);
			}
			iVar0++;
		}
		if (func_5(Local_317))
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0))
			{
				if (func_6(Local_293))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_321);
						func_519("Making Glen get into vehicle through MAKE_SECURITY_ATTACK()");
						iLocal_68 = 3;
					}
				}
			}
		...
		func_260();
		if (iLocal_67 <= 3 && func_506(Local_293))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293, PED::GET_PED_BONE_INDEX(Local_293, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			if (func_506(Local_298))
			{
...
void func_260()
{
	...
	while (iVar0 <= 5)
	{
		if (func_506(Local_305[iVar0 /*13*/]))
		{
			func_261(iVar0);
			iLocal_308[iVar0] = 3;
		}
...
int func_264()
{
	if ((func_265(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_SNIPERRIFLE") || func_265(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_HEAVYSNIPER")) || func_265(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_REMOTESNIPER"))
	{
		return 1;
	}
	return 0;
...
int func_266(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_506(PLAYER::PLAYER_PED_ID()) && func_506(iParam0))
	{
...
bool func_269(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_506(iParam0) || !func_506(iParam1))
	{
		if (iVar2 != -1)
		{
...
int func_270(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_273(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_275(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_275(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_283(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_275(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_285()
{
	...
	{
		case 0:
			if (func_6(Local_293) && func_506(PLAYER::PLAYER_PED_ID()))
			{
				if (((func_286(PLAYER::PLAYER_PED_ID(), Local_293, 35f, 1) && iLocal_307[0] != 5) && iLocal_307[1] != 5) && iLocal_307[2] != 5)
				{
					if (!func_14())
					{
						func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
...
bool func_286(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_291()
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			func_519("ENTERING LOSE THE COPS");
			iLocal_69 = 1;
			break;
...
void func_292()
{
	if (iLocal_266)
	{
		if (!func_506(Local_293) && func_294())
		{
			func_519("Player achieved FOUR!");
			iLocal_266 = 0;
			func_293(792);
		}
	}
...
void func_295()
{
	...
	else
	{
		...
		while (iVar0 <= 1)
		{
			if (func_506(Local_306[iVar0 /*13*/]))
			{
				func_296(iVar0);
			}
			iVar0++;
				...
				if (func_506(Local_293))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
					{
						...
						else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_306[iParam0 /*13*/], true), 15f, 1))
						{
							...
							if (func_256(PLAYER::PLAYER_PED_ID(), Local_306[iParam0 /*13*/], 1) < 45f)
							{
					...
					else if (func_266(Local_306[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_293, Local_306[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0))
					{
						func_290(Local_306[iParam0 /*13*/], 0);
						iLocal_309[iParam0] = 3;
					}
...
void func_302()
{
	...
	if (iLocal_243 == 0)
	{
		if (func_8(0))
		{
			func_519("Celeb security loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 2)
			{
	...
	while (iVar0 <= 2)
	{
		if (func_506(Local_303[iVar0 /*13*/]))
		{
			if (iLocal_255 == 0 && iLocal_249 == 0)
			{
				if (func_312())
				{
					func_519("Monitor_Security, player has 'mucked about' with the celeb scene; attacking...");
...
void func_304(int iParam0)
{
	...
	if (func_506(PLAYER::PLAYER_PED_ID()) && func_506(Local_303[iParam0 /*13*/]))
	{
		if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 20f)
		{
	...
	{
		case 0:
			if (func_266(Local_303[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 60))
			{
				if (func_268(Local_303[iParam0 /*13*/], 110f))
				{
					...
					func_519("SS_GUARD_AREA, player threatened Celeb security; attacking...");
					func_258();
				}
			}
			else if (CAM::IS_FIRST_PERSON_AIM_CAM_ACTIVE())
			{
				if ((ENTITY::IS_ENTITY_ON_SCREEN(Local_303[iParam0 /*13*/]) && func_268(Local_303[iParam0 /*13*/], 1126825984)) && func_256(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
					...
					func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
					func_519("SS_GUARD_AREA, player tried sniping Celeb security but was spotted; attacking...");
					func_258();
				}
			}
			else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_303[iParam0 /*13*/]))
			{
				if (func_264())
				{
					if (func_268(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						{
							func_519("SS_GUARD_AREA, player aimed Sniper Rifle when security could see them; attacking...");
							func_258();
						}
					}
				}
			...
			else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_180(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (!func_308())
						{
							if (func_268(Local_303[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
							{
								if (func_14())
								{
									func_12();
								...
								{
									func_519("SS_GUARD_AREA, player armed, not wearing outfit, guard has LOS or player within 18m; attacking...");
									func_258();
								}
							}
						}
						else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
						{
							...
							else if (iLocal_249 == 1)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
								{
									...
									{
										func_519("SS_GUARD_AREA, non-outfit, player came back to area after being warned; attacking");
										func_258();
									}
								}
							}
					...
					else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
					{
						...
						else if (iLocal_249 == 1)
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
							{
								...
								{
									func_519("SS_GUARD_AREA, outfit, player came back to area after being warned; attacking");
									func_258();
								}
							}
						}
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0))
			{
				if (!VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), Local_317.f_5))
				{
					if (func_268(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_519("SS_GUARD_AREA, player 50m away from group in non-buggy vehicle; attacking");
							func_258();
						}
					}
				}
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					...
					{
						func_307("Going too fast, going to trigger aggro: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)));
						if (PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 60) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 0))
						{
							if (func_268(Local_303[iParam0 /*13*/], 1126825984))
							{
								if (func_14())
								...
								if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
								{
									func_519("SS_GUARD_AREA, player went too fast too close to security; attacking");
									func_258();
								}
							}
						}
					...
					else if (func_268(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						if (iLocal_254 == 0)
						{
							...
							{
								func_502("'You can't drive through here buddy said by ped id: ", iParam0);
								if (func_6(Local_303[iParam0 /*13*/]))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
								}
		...
		case 1:
			if (!func_308())
			{
				if (func_268(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						func_519("SS_GO_TO_PLAYER, player armed, guard has LOS; attacking...");
						func_258();
					}
				}
			}
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_285) >= 8000)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					...
					if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						...
						iLocal_285 = MISC::GET_GAME_TIMER();
						iLocal_307[iParam0] = 2;
						func_519("Guard: going into SS_WARN_PLAYER ");
					}
				}
			}
			break;
		...
		case 2:
			if (!func_308())
			{
				if (func_268(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						func_519("SS_WARN_PLAYER, player armed, guard has LOS; attacking...");
						func_258();
					}
				}
			}
			else if (!func_180(PLAYER::PLAYER_PED_ID(), 12, 4))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 8f, 8f, 8f, 0, 1, 0) && iLocal_249 == 1))
				{
					...
					func_519("SS_WARN_PLAYER, player got too close, going to aim...");
				}
				else
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) >= 15f)
							{
								...
								func_307("SS_WARN_PLAYER, going too fast: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)));
								func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_519("SS_WARN_PLAYER, player in vehicle going too fast within 9m of guard; attacking...");
								func_258();
							}
						}
					}
					if ((MISC::GET_GAME_TIMER() - iLocal_285) >= 7000)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
						{
							...
							if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
							{
								...
								iLocal_285 = MISC::GET_GAME_TIMER();
								iLocal_307[iParam0] = 3;
								func_519("SS_WARN_PLAYER, player took too long, going to aim...");
							}
						}
						else if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) > 20f)
						{
							TASK::TASK_ACHIEVE_HEADING(Local_303[iParam0 /*13*/], Local_303[iParam0 /*13*/].f_7, 0);
							TASK::TASK_CLEAR_LOOK_AT(Local_303[iParam0 /*13*/]);
							func_519("SS_WARN_PLAYER, player >20m away, returning to SS_GUARD_AREA...");
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
			{
				...
				else if (iLocal_249 == 1)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
					{
						...
						if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_519("SS_WARN_PLAYER, outfit worn, player came back to area after being warned; attacking");
							func_258();
						}
					}
				}
		...
		case 3:
			if (!func_308())
			{
				if (func_268(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						...
						func_519("SS_AIM_AT_PLAYER, player armed, guard has LOS; attacking...");
						if (iLocal_255 == 0)
						{
							func_258();
						}
						else
						{
							...
							{
								Local_303[iParam0 /*13*/].f_11 = func_262(Local_303[iParam0 /*13*/], 0, 0, 5);
							}
							func_502("Attack player, FORCE security guard: ", iParam0);
						}
					}
				}
			}
			else
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_303[iParam0 /*13*/], true), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					...
					func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_519("SS_AIM_AT_PLAYER, bullet detected within 20m of a ped, attacking...");
					func_258();
				}
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_306(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f) && iLocal_249 == 1))
				{
					if (func_14())
					{
						func_12();
					...
					func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_519("SS_AIM_AT_PLAYER, player got too close, attacking...");
					func_258();
				}
				else
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) >= 15f)
							{
								...
								func_307("SS_AIM_AT_PLAYER, going too fast: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)));
								func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_519("SS_AIM_AT_PLAYER, player in vehicle above acceptable speed, within 20m; attacking...");
								func_258();
							}
						}
					}
						...
						if (func_506(Local_293))
						{
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || (MISC::GET_GAME_TIMER() - iLocal_285) >= 12000)
								{
									...
									func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
									func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
									func_519("SS_AIM_AT_PLAYER, player took too long and didn't move away, attacking...");
									func_258();
								}
							}
						}
		...
		case 4:
			if (func_256(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_293, 0) || func_506(Local_293)))
			{
				if (HUD::DOES_BLIP_EXIST(Local_303[iParam0 /*13*/].f_11))
				{
		...
		case 5:
			...
			if (func_266(Local_303[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 60))
			{
				func_519("SS_STANDDOWN, player threatened Glen OR guard thought he'd get run over; attacking...");
				func_258();
			}
			else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_303[iParam0 /*13*/]))
			{
				if (func_264())
				{
					if (func_268(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
						func_519("SS_STANDDOWN, player aiming Sniper Rifle, guard has LOS; attacking...");
						func_258();
					}
				}
			}
...
void func_307(char* sParam0, float fParam1)
{
	sParam0 = sParam0;
	fParam1 = fParam1;
}
...
int func_308()
{
	if (func_265(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED") && func_265(PLAYER::PLAYER_PED_ID()) != joaat("OBJECT"))
	{
...
void func_309()
{
	...
	{
		if (iLocal_67 < 3 || func_256(PLAYER::PLAYER_PED_ID(), Local_293, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_303[iVar0 /*13*/]))
				{
					...
					func_502("Alerted, security guard: ", iVar0);
				}
				iLocal_307[iVar0] = 3;
				iVar0++;
			}
		...
		{
			func_519("Alert called, but guards need to attack instead");
			func_258();
		}
	}
}

void func_310(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
float func_311(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_312()
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_506(Local_303[iVar0 /*13*/]) || func_313(PLAYER::PLAYER_PED_ID(), Local_303[iVar0 /*13*/], 1)) || PED::IS_PED_RAGDOLL(Local_303[iVar0 /*13*/]))
		{
			func_519("HAS_PLAYER_MUCKED_ABOUT(): Player bumped celeb security with vehicle OR celeb security dead");
			return 1;
		}
		iVar0++;
	}
	if ((!func_506(Local_293) || func_313(PLAYER::PLAYER_PED_ID(), Local_293, 1)) || PED::IS_PED_RAGDOLL(Local_293))
	{
		func_519("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return 1;
	}
	if ((!func_506(Local_298) || func_313(PLAYER::PLAYER_PED_ID(), Local_298, 1)) || PED::IS_PED_RAGDOLL(Local_298))
	{
		func_519("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return 1;
	}
	if (func_5(Local_317) && func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0))
		{
			func_519("HAS_PLAYER_MUCKED_ABOUT(): Player in celeb's golf cart");
			return 1;
		}
	}
	else
	{
		func_519("HAS_PLAYER_MUCKED_ABOUT(): Celeb golf cart not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_316[4 /*6*/]) && func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[4 /*6*/], 0))
		{
			func_519("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart behind celeb");
			return 1;
		}
	}
	else
	{
		func_519("HAS_PLAYER_MUCKED_ABOUT(): Golf cart behind celeb not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_316[5 /*6*/]) && func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[5 /*6*/], 0))
		{
			func_519("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart next to celeb");
			return 1;
		}
	}
	else
	{
		func_519("HAS_PLAYER_MUCKED_ABOUT(): Golf cart next to celeb not OK, player destroyed it?");
		return 1;
	}
	return 0;
}
...
void func_314()
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			func_519("ENTERING LOSE THE SECURITY ");
			iLocal_69 = 1;
			break;
...
void func_316()
{
	switch (iLocal_69)
	{
		case 0:
			...
			func_519("ENTERING COLLECT GOLF CLUB ");
			iLocal_69 = 1;
			break;
...
void func_318()
{
	if (iLocal_265 == 0)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			...
			func_519("*** Played special Nigel 1D police report ***");
			iLocal_265 = 1;
		}
	}
}
...
{
	if (func_255(&uLocal_333, ENTITY::GET_ENTITY_COORDS(iParam0, true)))
	{
		return 1;
	}
	return 0;
...
void func_320()
{
	if (iLocal_262 == 0)
	{
		if (func_506(Local_328.f_1) && iLocal_67 == 6)
		{
	...
	if (func_506(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_67 < 6)
		{
			if (func_506(Local_293))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 140f, 140f, 140f, 0, 1, 0) && !func_269(PLAYER::PLAYER_PED_ID(), Local_293, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_323()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_293) && func_506(Local_328.f_1))
	{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (func_506(Local_328.f_1) && func_506(Local_293))
			{
				...
				{
					func_519("Glen still holding club, reattach to bag");
					ENTITY::DETACH_ENTITY(Local_328.f_1, 1, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, iLocal_323, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1);
				}
			}
			MISC::_SET_UNK_MAP_FLAG(2);
			func_519("ENTERING CHASE IN CITY ");
			func_289(&iLocal_237);
		...
		case 1:
			...
			if (bLocal_267)
			{
				if (func_506(Local_328.f_1) && func_506(iLocal_323))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
...
int func_325()
{
	if (func_5(Local_317))
	{
		if (func_506(Local_293))
		{
			...
			if ((func_249() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317, 0, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317, 1, 0))
			{
				func_519("Buggy stuck or front tyres burst in city - returning true");
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317))
				{
					TASK::REMOVE_WAYPOINT_RECORDING("NIGEL1DGOLF");
					TASK::REMOVE_WAYPOINT_RECORDING("NIGEL1DGOLF2");
			...
			{
				func_519("Buggy health below threshold - returning true");
				iLocal_242 = 1;
				return 1;
			}
			if (!PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
			{
				func_519("Celeb not in buggy while monitoring chase - returning true");
				return 1;
			}
		}
		else
		{
			func_519("Celeb dead - returning true");
			return 1;
		}
	}
	else
	{
		func_519("Buggy somehow not ok - returning true");
		return 1;
	}
	return 0;
}
...
void func_329(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
...
void func_330(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_335(char* sParam0)
{
	if (!func_336(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_322(sParam0)) || func_322("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_336(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_344() || func_343(Global_4456448.f_161209)) || func_342())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_341(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_340(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_337(int iParam0)
{
	if (iParam0 != func_339())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER::PLAYER_ID()) && func_338(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_347(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_350(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_358(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_360()
{
	...
	{
		case 0:
			func_519("CHASE THE GOLFER ");
			iLocal_282 = MISC::GET_GAME_TIMER();
			iLocal_283 = MISC::GET_GAME_TIMER();
			iLocal_284 = MISC::GET_GAME_TIMER();
			HUD::SET_BLIP_SCALE(iLocal_237, 1f);
			func_374(&(Local_316[3 /*6*/]));
			if (func_506(iLocal_323) && func_5(Local_317))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_323))
				{
					func_519("Reattaching bag to buggy!?");
			...
			if ((func_506(Local_328.f_1) && func_506(Local_293)) && func_5(Local_317))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_328.f_1))
				{
					func_519("Reattaching club to bag!?");
		...
		case 1:
			...
			if (func_361() || !func_506(Local_293))
			{
				func_33("N1D_COLLECT", 7500, 5);
				func_35(6);
			}
...
int func_361()
{
	if (func_5(Local_317))
	{
		if (func_506(Local_293))
		{
			...
			if ((func_249() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317, 0, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317, 1, 0))
			{
				...
				TASK::CLEAR_PED_TASKS(Local_293);
				func_290(Local_293, 1);
				func_519("*** Celeb cart stuck or a front wheel is burst - chase monitor returning True");
				return 1;
			}
			else
			{
			...
			{
				iLocal_242 = 1;
				func_519("*** Celeb cart below drop club threshold - chase monitor returning True");
				return 1;
			}
			if (!PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
			{
				func_519("*** Celeb no longer in vehicle - chase monitor returning True");
				return 1;
			}
			...
			{
				func_362();
				func_502("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_317));
	...
	{
		func_519("*** Celeb cart wrecked/not OK - chase monitor returning True");
		func_290(Local_293, 1);
		return 1;
	}
	return 0;
	...
	else
	{
		...
		while (iVar0 <= 5)
		{
			if (func_369(iVar0))
			{
				...
				{
					iLocal_308[iVar0] = 4;
					func_502("This Ambient Golfer is now dead: ", iVar0);
					func_367(iVar0);
				}
			}
			if (func_506(Local_305[iVar0 /*13*/]))
	...
	switch (iLocal_308[iParam0])
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, 0))
				{
					...
					func_519("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle); alerted...");
					func_309();
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_266(Local_305[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						if (!func_308())
						{
							...
							func_261(iParam0);
							func_519("AS_PLAYGOLF, player threatened ambient golfer; attacking...");
							func_309();
							iLocal_308[iParam0] = 1;
						}
						else
						{
							...
							if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								...
								func_519("Played aggro line from ambient golfer...");
							}
					...
					else if (func_268(Local_305[iParam0 /*13*/], 1126825984))
					{
						if (!func_308())
						{
							...
							func_261(iParam0);
							func_519("AS_PLAYGOLF, player armed and ambient golfer has LOS; attacking...");
							func_309();
							iLocal_308[iParam0] = 1;
						}
					}
			...
			{
				if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 11f, 11f, 11f, 0, 1, 0) && PED::HAS_PED_RECEIVED_EVENT(Local_305[iParam0 /*13*/], 60)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_305[iParam0 /*13*/]))
				{
					if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						func_297(Local_305[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
					}
					func_502("This ambient golfer nearly got run over and is now attacking player: ", iParam0);
					PED::SET_PED_CAN_BE_TARGETTED(Local_305[iParam0 /*13*/], true);
					TASK::TASK_COMBAT_PED(Local_305[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					func_366();
					iLocal_308[iParam0] = 1;
			...
			else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, 1))
			{
				...
				func_519("AS_PLAYGOLF, bullet in area of ambient golfer (in vehicle); attacking...");
				func_309();
				iLocal_308[iParam0] = 1;
			}
			...
			{
				func_519("Player damaged an ambient golfer with their vehicle (or another vehicle damaged them?)");
				if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					func_297(Local_305[iParam0 /*13*/], "GENERIC_FUCK_YOU", 34);
				}
		...
		case 1:
			if (func_266(Local_305[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) && !func_308())
			{
				...
				func_519("AS_ALERTED, player threatened ambient golfer and was armed; attacking...");
				func_309();
				func_261(iParam0);
				iLocal_308[iParam0] = 3;
			}
		...
		while (iVar0 <= 5)
		{
			if (func_506(Local_305[iVar0 /*13*/]))
			{
				if (func_368(Local_305[iParam0 /*13*/], Local_305[iVar0 /*13*/], 20f))
				{
					...
					{
						func_502("Making this Ambient Golfer flee from dead ped: ", iVar0);
						func_261(iVar0);
					}
				}
			}
...
void func_375()
{
	...
	{
		case 0:
			func_519("ENTERING GET THE CLUB 1 ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
		...
		case 2:
			HUD::CLEAR_PRINTS();
			if (func_506(Local_293) && !bLocal_264)
			{
				func_35(4);
			}
			else
...
void func_377(int iParam0)
{
	...
	Global_106565.f_2357.f_539.f_2332[iParam0] = 1;
}
...
void func_379()
{
	...
	if (iLocal_258 == 0)
	{
		if (func_9(0))
		{
			func_519("Concierge scene loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 3)
			{
...
void func_380()
{
	...
	while (iVar0 <= 3)
	{
		if (func_506(Local_292[iVar0 /*13*/]))
		{
			func_381(iVar0);
		}
		iVar0++;
...
void func_383()
{
	if (func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_319(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				HUD::SET_BLIP_FLASHES(iLocal_237, 1);
			}
		}
		else if (!HUD::DOES_BLIP_EXIST(iLocal_237))
		{
			func_519("Recreated mission blip");
			iLocal_237 = func_262(Local_293, 1, 0, 5);
		}
		else
		{
			HUD::SET_BLIP_FLASHES(iLocal_237, 0);
		}
	}
}
...
{
	if (func_255(&uLocal_385, ENTITY::GET_ENTITY_COORDS(iParam0, false)))
	{
		return 1;
	}
	return 0;
...
void func_385()
{
	switch (iLocal_69)
	{
		case 0:
			...
			func_519("ENTERING GO TO CELEBRITY ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
		...
		case 1:
			...
			func_248();
			func_376();
			if (func_506(Local_293) && func_506(PLAYER::PLAYER_PED_ID()))
			{
				if (func_286(PLAYER::PLAYER_PED_ID(), Local_293, 50f, 1) || iLocal_68 == 3)
				{
					iLocal_69 = 2;
				}
				else if (func_32())
				...
				{
					if (func_286(PLAYER::PLAYER_PED_ID(), Local_293, 150f, 1))
					{
						iLocal_69 = 2;
					}
				}
...
void func_386(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_458(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		else
		{
			...
			{
				iVar6 = func_455(&(Global_93682.f_3));
				if (iVar6 > -1)
				{
...
{
	func_388(&Global_100114, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_388(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_244();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_419(&(uParam0->f_2884), 0);
		func_418(PLAYER::PLAYER_PED_ID());
		func_411(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_410())
		{
			func_406(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
{
	func_399(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_396(iParam1, 145, 0);
	uParam0->f_11 = func_395(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_397(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_399(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_402(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_400(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_403(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
int func_407(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2571340[iParam0 /*3*/][func_101(iParam1)];
...
void func_411(int iParam0, bool bParam1)
{
	...
	if (func_185(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_412(iParam0, &(Global_106565.f_2357.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_412(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_417(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_414(Var7.f_1)) && iVar9 < 51)
			{
...
int func_420(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
bool func_421(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_422(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_443())
		{
			*uParam0 = func_427(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
int func_424(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_42() == 0)
		{
			return MISC::IS_BIT_SET(func_102(func_425(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_427(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_442(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_428(iVar0, 0), true);
...
Vector3 func_428(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_438(Global_95769);
			break;
		
		case 46:
			if (Global_1589661 != func_339())
			{
				if (func_437(Global_1589661))
				{
					return func_430(2, 2);
				}
				else if (func_429(Global_1589661))
				{
...
Vector3 func_432(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_450(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_456(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_457(Global_106565.f_9079.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_457(Global_106565.f_9079.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_457(Global_106565.f_9079.f_99.f_205[11]);
			break;
		
		case 90:
			return func_457(Global_106565.f_9079.f_99.f_205[7]);
			break;
		
		case 93:
			return func_457(Global_106565.f_9079.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_458(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
void func_461()
{
	...
	{
		case 0:
			func_519("ENTERING GO TO GOLF CLUB ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
			...
			{
				func_519("Glen was not alive when trying to create the blip in GO_TO_THE_GOLF_CLUB() init");
				func_465();
				iLocal_237 = func_262(Local_293, 1, 0, 5);
			}
			func_462(0);
			func_519("ENTERING GO TO GOLF CLUB LOOP ");
			if (func_505(0) && iLocal_71)
			{
				func_17(1, 1, 1);
			}
			MISC::_SET_UNK_MAP_FLAG(0);
		...
		case 1:
			if (iLocal_252 == 0)
			{
				func_519("Glen created in GO_TO_THE_GOLF_CLUB() SS_UPDATE");
				func_465();
			}
			else
			{
...
void func_462(int iParam0)
{
	if (iLocal_312 != 5 || iParam0 == 1)
	{
		...
		{
			iLocal_238 = func_463(-1377.18f, 55.39f, 53.7f, 0);
...
int func_463(vector3 vParam0, bool bParam1)
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(vParam0);
	HUD::SET_BLIP_SCALE(iVar0, func_464(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	HUD::SET_BLIP_ROUTE(iVar0, bParam1);
	return iVar0;
}

float func_464(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0)
	{
		return fParam1;
...
void func_465()
{
	while (iLocal_252 == 0)
	{
		if (func_466(0))
		{
			...
			func_519("Celeb created!");
			iLocal_252 = 1;
		}
		else
		{
			func_519("Waiting for celeb assets...");
		}
		SYSTEM::WAIT(0);
	}
}
...
void func_467()
{
	...
	{
		case 0:
			func_519("ENTERING PHONE CALL 3 ");
			func_287(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_287(&uLocal_72, 3, 0, "NIGEL", 0, 1);
			func_287(&uLocal_72, 4, 0, "MRSTHORNHILL", 0, 1);
			if (iLocal_71 == 1)
...
void func_470()
{
	...
	func_3(&Local_317);
	func_472(&(Local_328.f_1));
	func_472(&iLocal_323);
	func_472(&Local_332);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_472(&(Local_331[iVar0 /*6*/]));
		iVar0++;
	}
...
void func_477(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_479(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_478(char* sParam0)
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_479(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_480(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_490(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_346(0)) || func_489(1))
			{
			}
			else
			{
...
{
	return func_492(iParam0, Global_36425);
}
...
void func_493(int iParam0, int iParam1)
{
	...
	if (iLocal_70 == 3)
	{
		func_519("We are trying to skip to Get The Club...");
	}
	else if (iLocal_70 == 1)
	{
		func_519("We are trying to skip to Go to Golf Club...");
	}
	iLocal_71 = 0;
	func_1(iLocal_70);
}
...
void func_496(bool bParam0, bool bParam1)
{
	...
	func_497(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, bParam1, 1, 1, 1);
}

void func_497(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_498(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_500(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
...
void func_501(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_527())
	{
...
int func_504(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_507()
{
	...
	func_511(&uLocal_333);
	func_510(&uLocal_333, -1313.714f, -27.2202f, 48.0314f);
	func_510(&uLocal_333, -1294.066f, -27.0136f, 47.5724f);
	func_510(&uLocal_333, -1069.844f, -143.769f, 39.7493f);
	func_510(&uLocal_333, -925.2529f, -89.9079f, 38.3457f);
	func_510(&uLocal_333, -1010.948f, 40.0643f, 49.9277f);
	func_510(&uLocal_333, -1122.838f, 233.7037f, 64.7587f);
	func_510(&uLocal_333, -1282.578f, 188.8798f, 59.2769f);
	func_510(&uLocal_333, -1328.153f, 192.0178f, 57.8136f);
	func_510(&uLocal_333, -1386.75f, 167.32f, 57.11f);
	func_510(&uLocal_333, -1411.5f, 109.64f, 51.49f);
	func_510(&uLocal_333, -1399.63f, -10.83f, 51.93f);
	func_510(&uLocal_333, -1359.54f, 18.93f, 52.52f);
	func_510(&uLocal_333, -1342.27f, 16.92f, 52.16f);
	func_509(&uLocal_333);
	func_508(&uLocal_385, &uLocal_333, 100f);
	func_511(&uLocal_437);
	func_510(&uLocal_437, -1100.2f, 77.1233f, 53.2703f);
	func_510(&uLocal_437, -1040.69f, 97.3963f, 51.9067f);
	func_510(&uLocal_437, -977.9333f, -5.5166f, 45.6548f);
	func_510(&uLocal_437, -1039.687f, -35.872f, 45.4867f);
	func_510(&uLocal_437, -1062.19f, -2.8635f, 49.6013f);
	func_509(&uLocal_437);
	iLocal_71 = 1;
}

void func_508(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_510(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_520(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_506(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_506(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_506(uParam0->f_41[iVar0]))
		{
...
int func_521(var uParam0, var uParam1)
{
	...
	switch (iLocal_49)
	{
		case 0:
			...
			func_511(uParam1);
			func_510(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_510(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_510(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_510(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_510(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_510(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_510(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_510(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_510(uParam1, -1386.75f, 167.32f, 57.11f);
			func_510(uParam1, -1411.5f, 109.64f, 51.49f);
			func_510(uParam1, -1379.52f, 111.05f, 54.28f);
			func_510(uParam1, -1371.77f, 24.07f, 52.88f);
			func_510(uParam1, -1342.27f, 16.92f, 52.16f);
			func_509(uParam1);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_526(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_49 = 2;
...
void func_528(int iParam0)
{
	...
	MISC::_SET_UNK_MAP_FLAG(0);
	func_529(&Local_66, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_529(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_534(uParam0, iParam1);
	func_532(uParam0, bParam2);
	func_530(uParam0, bParam3);
}

void func_530(var uParam0, bool bParam1)
{
	func_531(&(uParam0->f_41), bParam1);
}
...
int func_541(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_544())
	{
		...
		{
			iVar2 = func_455(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_542()
{
	...
	iVar0 = func_458(&(Global_93682.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
