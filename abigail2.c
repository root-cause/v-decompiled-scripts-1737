...
void __EntryFunction__()
{
	...
	if (func_456(Local_54.f_28[0]))
	{
		iLocal_61 = Local_54.f_28[0];
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_61, 1, 1);
	}
	func_455();
	if (func_454())
	{
	...
	while (true)
	{
		...
		func_361(Local_54.f_9, 0, 0, 0, 0, 0);
		if (func_456(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_59)
			{
				case 0:
...
void func_9()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_60 = 2;
			...
			{
				if (!func_224(iLocal_61, 1805844857))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_61, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
				}
				if (iLocal_230 == 0)
				{
					if (((!func_223() && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_210(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_223()) && (MISC::GET_GAME_TIMER() - iLocal_235) > 10000) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_210(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_15()
{
	...
	{
		func_17(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71402[1 /*14*/] = { func_91(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_83(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_83(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71402[1 /*14*/] = { func_91(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_83(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_74(iVar0);
						if (Global_71400 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71402[1 /*14*/] = { func_91(iVar10, 14, uVar15[iVar1], -1) };
			func_59(iParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
			func_74(14);
			if (Global_71400 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_83(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 1) || FILES::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, joaat("HAT"), 0) || FILES::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_93(int iParam0)
{
	...
	func_94(&(Global_71402[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_94(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_94(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_83(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_83(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	{
		if (func_158(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar1, {func_164(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar1, 0, Global_93719, 0);
		func_168(&uVar1, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}
...
void func_168(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (MISC::COMPARE_STRINGS(uParam0, &Global_90782, 0, -1) != 0)
	{
		return;
	}
	STATS::PLAYSTATS_MISSION_OVER(uParam0, uParam1, uParam2, uParam3, uParam4, Global_87889);
...
void func_173()
{
	...
	{
		func_162();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_174(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
bool func_192(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	else
	{
		...
		if (MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) != MISC::GET_HASH_KEY("standard_global_reg"))
		{
			if (iParam2 == 0)
			{
				if (Global_33392[iParam0] && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var3, 1) < 200f)
				{
					bVar5 = false;
					Global_1647687 = 1;
				}
...
void func_229()
{
	if (func_456(iLocal_61))
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_242) > 1000)
		{
			...
			func_230(&uLocal_42, iLocal_61, "ABGAIL2_HINT", 0, 1, 1, 1);
		}
	}
	else
	{
...
void func_231(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_232(uParam0, iParam1, vParam2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_232(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_258(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_253(uParam0, bParam5, bParam7, 0))
			{
				func_249(uParam0, iParam1, vParam2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_238(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_246() || func_245(Global_4456448.f_161209)) || func_244())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_243(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_242(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_239(int iParam0)
{
	if (iParam0 != func_241())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER::PLAYER_ID()) && func_240(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_249(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_252(vParam2, 0f, 0f, 0f, 0))
	{
		if (ENTITY::IS_ENTITY_A_PED(iParam1))
		{
...
bool func_252(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_253(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_256(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_254(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_260()
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_62) && func_456(iLocal_61))
	{
		iLocal_62 = func_261(iLocal_61, 1, 0, 5);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_62) && HUD::GET_BLIP_COLOUR(iLocal_62) != 1)
	{
		HUD::SET_BLIP_AS_FRIENDLY(iLocal_62, 0);
...
void func_262()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_223()) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_210(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_260();
				}
				if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
			if ((iLocal_233 == 0 && iLocal_232 == 1) && !func_223())
			{
				if (func_456(iLocal_61))
				{
...
void func_264()
{
	...
	{
		case 0:
			uLocal_243 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
			func_292();
			if (func_456(iLocal_61))
			{
				func_290();
				if (func_3(iLocal_56))
				{
					...
					func_289(&iLocal_62, "", "", &iLocal_63, &iLocal_64, 1, 0);
					TASK::OPEN_SEQUENCE_TASK(&uLocal_236);
					...
					TASK::CLOSE_SEQUENCE_TASK(uLocal_236);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_61, uLocal_236);
				}
				else
				{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_61, vLocal_239, 5f, 5f, 5f, 0, 1, 0))
			{
				func_228(3);
			}
			else
			{
				func_265(&iLocal_62, "", "", &iLocal_63, iLocal_64, 0);
				if (iLocal_231 == 0)
				{
					if (((func_456(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 1)) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_210(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_223()) && (MISC::GET_GAME_TIMER() - iLocal_234) > 10000) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_210(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = MISC::GET_GAME_TIMER();
						iLocal_237++;
					}
...
int func_269()
{
	...
	if (func_456(iLocal_56))
	{
		if (func_270(iLocal_61, 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			return 1;
		}
...
int func_270(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_456(PLAYER::PLAYER_PED_ID()) && func_456(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_283(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_271(int iParam0, float fParam1)
{
	...
	if (func_456(PLAYER::PLAYER_PED_ID()) && func_456(iParam0))
	{
		if (func_282(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_273(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_273(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar2 = func_281(iParam0, iParam1);
	if (!func_456(iParam0) || !func_456(iParam1))
	{
		if (iVar2 != -1)
		{
			func_280(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_274(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_274(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_275(iParam2, iParam5) };
...
int func_277(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_279(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar1 = { func_279(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_278(vVar1, vVar0);
...
float func_278(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_286(int iParam0, float fParam1)
{
	...
	{
		if (func_287(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_287(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_279(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_290()
{
	if (func_456(iLocal_61))
	{
		...
		func_291(&uLocal_65, 3, iLocal_61, "ABIGAIL", 0, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_61, 128, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_61, 4, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_61, 1024, 1);
		PED::SET_PED_CONFIG_FLAG(iLocal_61, 281, 1);
...
void func_292()
{
	if (!func_456(iLocal_56))
	{
		iLocal_56 = VEHICLE::CREATE_VEHICLE(iLocal_55, vLocal_57, fLocal_58, 1, 1, 0);
	...
	if (func_456(iLocal_56))
	{
		...
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 1);
			...
			switch (iLocal_241)
			{
				...
				case 1:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0, 0, 0, 0, 0, 0);
						func_334(500, 0);
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_491(16)) && func_456(iLocal_61))
						{
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_456(iLocal_61))
							{
								...
								func_333(iLocal_61, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
...
void func_298(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_300() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_300() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_299(iParam0));
...
bool func_302(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_300() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_325(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_329(PLAYER::PLAYER_ID())) && !func_327(PLAYER::PLAYER_ID(), 0)) && !func_326()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_329(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_333(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_335(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_336(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_338(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_339(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_339(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_343(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				if (VEHICLE::IS_VEHICLE_MODEL(iVar0, joaat("TAXI")))
				{
					...
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0 + vParam1 / Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iVar0, 1), 1) < 20f)
						{
							bVar1 = true;
							bVar2 = false;
						}
			...
			if (bVar1)
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (bVar2)
					{
						MISC::CLEAR_AREA_OF_VEHICLES(vParam3, 5f, 0, 0, 0, 0, 0, 0);
...
int func_343(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_279(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_344(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_344(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_344(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_344(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_344(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_344(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_344(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_344(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_344(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_344(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_344(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_344(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_344(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_344(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_344(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_344(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_344(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_347(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_351(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_354()
{
	...
	if ((!func_223() && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_55))
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 1);
		if (func_456(Local_54.f_35[0]))
		{
...
void func_356()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_351(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_361(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_363(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_364(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_374(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_248(0)) || func_373(1))
			{
			}
			else
			{
...
void func_377(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			func_383(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, vLocal_57, fLocal_58);
			func_228(2);
			break;
		
		case 2:
			func_383(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, vLocal_57, fLocal_58);
			func_228(2);
			break;
	...
	if (!func_382())
	{
		func_380(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_379(0, -1, 1);
	func_378(1, 1, 1);
}
...
void func_380(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
...
void func_383(vector3 vParam0, float fParam1, vector3 vParam2, float fParam3, vector3 vParam4, float fParam5, vector3 vParam6, float fParam7)
{
	int iVar0;
	
	if (func_340(vParam0))
	{
		while (!func_388(&iVar0, 0, vParam2, fParam3, 1, 0))
		{
			SYSTEM::WAIT(0);
		}
	...
	{
		func_333(PLAYER::PLAYER_PED_ID(), vParam0, fParam1, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_55);
	...
	while (!func_384(&iLocal_61, 16, vParam4, fParam5, "RC ABIGAIL 2", 1))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_56 = VEHICLE::CREATE_VEHICLE(iLocal_55, vParam6, fParam7, 1, 1, 0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
	func_292();
	if (func_340(vParam4))
...
int func_388(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	var uVar0;
	var uVar1;
	struct<97> Var2;
	...
	if (func_159(iParam1))
	{
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, uParam3, 0, 0, 0);
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, 1, 1, 0);
				...
				func_444(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_389(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_159(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_394(*iParam1, 0, &uVar0))
		{
...
int func_394(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_420(iVar0, bParam1, uParam2) && !func_419(PLAYER::PLAYER_ID())) && !func_403(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_401(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_399(iParam0)) && !bVar1) && !(func_398(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_396(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_395(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("SENTINEL2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_418(PLAYER::PLAYER_ID()) || func_417(PLAYER::PLAYER_ID()))
	{
		if (func_404(iParam0))
		{
			return 1;
...
int func_405(int iParam0)
{
	...
	if (func_406(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_420(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_401(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_424(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_341(iParam0, 0, 0)) || func_341(iParam0, 1, 0)) || func_341(iParam0, 2, 0)) || func_440(iParam0) != 145) || func_439(iParam0)) || func_438(iParam0)) || func_395(iParam0)) || func_437(iParam0)) || !func_427(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_438(iParam0))
		{
		}
...
int func_444(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_416(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_447(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_447(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_446(uParam0);
	if (func_445(*uParam0))
	{
...
void func_457(int iParam0)
{
	func_7(&uLocal_42, 0, 0);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
	func_6(&iLocal_62);
	func_468(&iLocal_61, 1, 0, 1);
	if (func_456(iLocal_56))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_56, 1);
	}
	func_387(&iLocal_56);
	func_346();
	func_467(&uLocal_65, 3);
	func_458(&Local_54, 0, 0, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_243, 0);
	if (iParam0 == 1)
	{
