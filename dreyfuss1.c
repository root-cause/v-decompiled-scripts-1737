...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_397(Local_82.f_9, 0, 0, 0, 0, 0);
...
void func_9()
{
	switch (iLocal_88)
	{
		...
		case 1:
			if (!bLocal_281)
			{
				if (func_431(iLocal_89))
				{
					if (!func_236())
					{
						bLocal_281 = func_224(&uLocal_98, "DREY1AU", "DREY1_END", "DREY1_END_2", 7, 0, 0);
					}
				}
				else if (!func_236())
				{
					bLocal_281 = func_224(&uLocal_98, "DREY1AU", "DREY1_END", "DREY1_END_1", 7, 0, 0);
				}
			}
			else if (!func_236())
			{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_78(func_97(iParam1, uParam0->f_2), Global_71399, 0);
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&sVar1, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}
...
{
	if (MISC::IS_BIT_SET(Global_93682.f_20, 17))
	{
		return 0;
	}
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_431(iLocal_89))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(iLocal_89, uLocal_93);
		...
		case 1:
			...
			if (!func_431(iLocal_89))
			{
				...
				if (!MISC::IS_BIT_SET(Global_106565.f_18568.f_382, 0))
				{
					MISC::SET_BIT(&(Global_106565.f_18568.f_382), 0);
				}
				func_290(4);
			}
			else if (func_288(PLAYER::PLAYER_PED_ID(), iLocal_89) > 250f)
			{
			...
			{
				func_257(&uLocal_305, iLocal_89, 0, 0, 1, 1, 1);
				func_254(&iLocal_90, "", "", &uLocal_298, iLocal_299, 0);
				func_241();
...
void func_241()
{
	if (!bLocal_280)
	{
		if (func_253(PLAYER::PLAYER_PED_ID(), iLocal_89, fLocal_267, 1))
		{
			if (PED::IS_PED_BEING_JACKED(iLocal_89))
			{
				bLocal_280 = func_252(&uLocal_98, "DREY1AU", "DREY1_HURT", 7, 0, 0, 0);
			}
			else
			{
				bLocal_280 = func_252(&uLocal_98, "DREY1AU", sLocal_274, 7, 0, 0, 0);
			}
		}
	}
	else if (!func_236())
	{
		if (func_244(1) == 0)
		{
			func_242(&iLocal_289, &iLocal_284, 32, &(iLocal_278[iLocal_284]), "DREY1_CHASE2", sLocal_271[iLocal_284], 0);
		}
	}
}
...
void func_242(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_297)
		{
			if (!*iParam0)
			{
				if ((func_243(iLocal_89) && !PED::IS_PED_RAGDOLL(iLocal_89)) && !TASK::IS_PED_IN_WRITHE(iLocal_89))
				{
					if (func_253(PLAYER::PLAYER_PED_ID(), iLocal_89, fLocal_267, 1))
					{
						if (!func_236())
						{
							...
							{
								*uParam3 = func_224(&uLocal_98, "DREY1AU", sParam4, sParam5, 7, 0, 0);
							}
							if (*uParam3 && !bParam6)
							{
	...
	else if ((bParam6 && !iLocal_304 == 0) && !func_236())
	{
		if (*iParam1 < (iParam2 - 1))
		{
			*iParam1++;
...
int func_244(int iParam0)
{
	if (iLocal_304 == 0)
	{
		if (func_245(iLocal_89, 1, 0, 0, 0) && iLocal_287 < 3)
		{
			func_237();
			iLocal_304 = 2;
		}
	...
	if (iLocal_304 == 1)
	{
		func_242(&iLocal_290, &iLocal_288, 4, &(iLocal_282[iLocal_288]), "DREY1_HURT", sLocal_273[iLocal_288], 1);
	}
	else if (iLocal_304 == 2)
	{
		func_242(&iLocal_291, &iLocal_287, 3, &(iLocal_279[iLocal_287]), "DREY1_SHOOT", sLocal_272[iLocal_287], 1);
	}
	return iLocal_304;
}
...
int func_248(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_250(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_250(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_249(vVar1, vVar0);
...
float func_249(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_250(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_253(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_256(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_256(sParam2, 0, 0))
					{
...
bool func_256(char* sParam0, int iParam1, int iParam2)
{
...
void func_259(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_260(uParam0, iParam1, vParam2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_260(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_266(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_274() || func_273(Global_4456448.f_161209)) || func_272())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_271(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_270(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_267(int iParam0)
{
	if (iParam0 != func_269())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER::PLAYER_ID()) && func_268(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_293()
{
	...
	{
		case 0:
			PATHFIND::SET_ROADS_IN_AREA(Local_83, Local_83.f_3, 1, 1);
			MISC::_SET_UNK_MAP_FLAG(2);
			if (func_431(Local_82.f_35[0]))
			{
				iVar0 = 0;
				while (iVar0 < 3)
				{
		...
		case 1:
			...
			else
			{
				if (func_431(Local_82.f_35[0]))
				{
					...
					{
						func_242(&iLocal_292, &iLocal_285, 7, &(iLocal_277[iLocal_285]), "DREY1_BUMP", sLocal_270[iLocal_285], 0);
					}
					func_242(&iLocal_293, &iLocal_286, 31, &(iLocal_276[iLocal_286]), "DREY1_CHASE1", sLocal_269[iLocal_286], 0);
					if (((!iLocal_265 && !iLocal_266) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_89)) && !ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, true, 0))
					{
				...
				func_244(0);
				func_257(&uLocal_305, iLocal_89, 0, 0, 1, 1, 1);
				if (((!iLocal_265 && func_253(PLAYER::PLAYER_PED_ID(), iLocal_89, 10f, 1)) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_89))
				{
...
int func_295()
{
	if (func_431(Local_82.f_35[0]))
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_89, Local_82.f_35[0], 0))
		{
			...
			{
				func_297();
				if (func_296(vLocal_295[0 /*3*/], vLocal_295[2 /*3*/], 2f))
				{
					return 0;
				}
				else
...
bool func_296(vector3 vParam0, vector3 vParam1, float fParam2)
{
...
int func_299()
{
	if (func_243(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_82.f_35[0]))
		{
			if (func_431(Local_82.f_35[0]))
			{
				if (func_253(iLocal_89, Local_82.f_35[0], 5f, 1))
				{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_3(Local_82.f_35[0]))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(Local_82.f_35[0], true, 1, 0);
			...
			if (func_431(iLocal_89))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_90))
				{
					iLocal_90 = func_308(iLocal_89, 1, 0, 5);
				}
				func_307(&iLocal_90, "", "", &uLocal_298, &iLocal_299, 1, 0);
				if (func_3(Local_82.f_35[0]))
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(iLocal_89, uLocal_92);
					uLocal_263 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], true), 100f, 10f, 0);
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_94))
			{
				...
				iLocal_94 = VEHICLE::CREATE_VEHICLE(iLocal_95, -1482.366f, 529.0344f, 117.2725f, 201.5764f, 1, 1, 0);
		...
		case 1:
			...
			else
			{
				...
				if (func_244(1) == 0)
				{
					func_242(&iLocal_294, &iLocal_283, 5, &(iLocal_275[iLocal_283]), "DREY1_CHASE0", sLocal_268[iLocal_283], 0);
				}
				if (iLocal_264)
				{
					if (func_431(iLocal_89))
				...
				if ((func_302(242628503) && TASK::GET_SEQUENCE_PROGRESS(iLocal_89) > 0) && func_298())
				{
					func_290(3);
				}
			}
...
int func_303()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_82.f_35[0]))
	{
		if (func_302(242628503))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], vLocal_80, 20f, 20f, 100f, 0, true, 0))
				{
					sLocal_274 = "DREY1_CGONE";
					iLocal_265 = 1;
					func_290(3);
				...
				else if (!ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], vLocal_80, 5f, 5f, 100f, 0, true, 0))
				{
					if (!func_304(iLocal_89, Local_82.f_35[0], 1126825984, 0))
					{
						sLocal_274 = "DREY1_CGONE";
						iLocal_265 = 1;
						func_290(3);
...
int func_304(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_250(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_305()
{
	if (func_243(iLocal_89) && func_3(Local_82.f_35[0]))
	{
...
void func_311()
{
	switch (iLocal_88)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_441()) && func_431(iLocal_89)) && func_289(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) > 4f)
			{
		...
		case 1:
			switch (iLocal_318)
			{
				case 0:
					...
					{
						func_388();
						if ((!func_236() && func_431(iLocal_89)) && func_252(&uLocal_98, "DREY1AU", "DREY1_RCM_LI", 8, 0, 0, 0))
						{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_372(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, vLocal_300, fLocal_301, 1, 1, 1, 0, 0);
							func_372(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, vLocal_300, fLocal_301, 1, 1, 1, 0, 0);
							func_372(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, vLocal_300, fLocal_301, 1, 1, 1, 0, 0);
							func_324(vLocal_300, fLocal_301, 0, 145);
						}
						else
						{
							func_372(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, vLocal_302, fLocal_303, 1, 1, 1, 0, 0);
							func_372(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, vLocal_302, fLocal_303, 1, 1, 1, 0, 0);
							func_372(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, vLocal_302, fLocal_303, 1, 1, 1, 0, 0);
							func_324(vLocal_302, fLocal_303, 0, 145);
						}
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_431(iLocal_89))
						{
...
int func_319(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_321(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_322(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_324(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_371(24) != Global_97130.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_325(Global_97130.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_325(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_359(iParam3, &Var0, vParam1, fParam2, func_362(iParam0));
		func_326(iParam3, iParam0, 0);
	}
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_343(iParam0, 0, 0)) || func_343(iParam0, 1, 0)) || func_343(iParam0, 2, 0)) || func_362(iParam0) != 145) || func_342(iParam0)) || func_341(iParam0)) || func_340(iParam0)) || func_339(iParam0)) || !func_329(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_341(iParam0))
		{
		}
...
void func_372(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_373(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_373(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_375(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_375(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_250(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_376(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_376(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_376(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_376(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_376(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_376(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_376(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_376(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_376(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_376(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_376(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_376(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_376(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_376(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_376(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_376(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
bool func_378(vector3 vParam0, int iParam1)
{
	return func_379(Global_97130.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_379(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_382(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_386(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_385(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_388()
{
	...
	if (iLocal_320 == 0)
	{
		if (func_431(iLocal_89))
		{
			if (func_289(PLAYER::PLAYER_PED_ID(), iLocal_89, 1) < 3f)
			{
				iLocal_320 = 1;
...
void func_390()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_386(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_397(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_399(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_400(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_410(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_276(0)) || func_409(1))
			{
			}
			else
			{
...
void func_413(int iParam0)
{
	...
	if (!func_424())
	{
		...
		func_423(PLAYER::PLAYER_PED_ID(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_94);
	func_4(&iLocal_89);
	func_2(&(Local_82.f_35[0]));
	...
	if (!func_424())
	{
		func_416(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 100f, 12, 5000, 0, 0);
	}
	func_415(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_416(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
...
void func_418()
{
	if (!func_431(Local_82.f_35[0]))
	{
		...
		Local_82.f_35[0] = VEHICLE::CREATE_VEHICLE(iLocal_96, vLocal_80, fLocal_81, 1, 1, 0);
...
void func_419()
{
	if (!func_431(iLocal_89))
	{
		while (!func_421(&iLocal_89, 68, -1472.9f, 483.3f, 115.2f, 75f, 1))
		{
			SYSTEM::WAIT(0);
		}
	}
	if (func_431(iLocal_89))
	{
		func_420(&uLocal_98, 3, iLocal_89, "DREYFUSS", 0, 1);
...
int func_421(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_423(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_430()
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_79, 1);
	func_426();
	MISC::CLEAR_BIT(&(Global_106565.f_18568.f_382), 0);
	HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_420(&uLocal_98, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_419();
	func_418();
}
...
int func_434(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				func_435(&(uParam0->f_35[0]), iVar0[1], vLocal_80, fLocal_81);
...
int func_436(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_421(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_442()
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_79, 0);
	func_189(99, 0, 1, 1, 0);
	func_395(&iLocal_321, 0);
	func_443(&Local_82, 0, 0, 0);
...
void func_452(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_453()
{
	...
	func_7(&uLocal_305, 0, 0);
	func_432(1);
	func_456(&uLocal_98, 1);
	func_456(&uLocal_98, 3);
	func_6(&iLocal_90);
	if (func_243(iLocal_89))
	{
		PED::SET_PED_KEEP_TASK(iLocal_89, true);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_89, 0, 1);
	}
	func_452(&iLocal_89, 1, 0, 1);
	func_449(&iLocal_94);
	func_454();
	PATHFIND::SET_ROADS_IN_AREA(Local_83, Local_83.f_3, true, 1);
	VEHICLE::_REMOVE_SPEED_ZONE(uLocal_263);
}
