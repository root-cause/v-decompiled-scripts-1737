...
void __EntryFunction__()
{
	...
	if (func_296())
	{
		Global_71835 = 1;
		iLocal_77 = 0;
		while (!func_284(&Local_81))
		{
			SYSTEM::WAIT(0);
		}
		func_283(&Local_81, 0, 1);
		Global_71835 = 0;
	}
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_265(Local_81.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_82)
		{
			case 0:
				func_257();
...
void func_1()
{
	...
	{
		case 0:
			func_232("Doing setup for leadout");
		...
		case 1:
			if (iLocal_92 == 1)
			{
				func_232("Skip detected, waiting 500ms...");
			...
			if (!iLocal_94)
			{
				if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					...
					func_232("Done Josh leadout anim");
					iLocal_94 = 1;
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
						func_220(&uLocal_97, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
						func_220(&uLocal_97, 5, Local_81.f_28[0], "Josh", 0, 1);
						if (func_210(&uLocal_97, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
							func_232("Leadout convo done");
							iLocal_95 = 1;
						}
					}
				}
				...
				{
					func_232("Leadout done, end mission");
					iLocal_83 = 2;
				}
				...
				{
					func_232("Too close, stopping scene");
					if (func_281(Local_81.f_28[0]))
					{
						TASK::CLEAR_PED_TASKS(Local_81.f_28[0]);
						func_232("Stopping Josh?");
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
				...
				if (func_209(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_281(Local_81.f_28[0]))
					{
			...
			{
				func_232("Leadout ended early, end mission");
				iLocal_83 = 2;
			}
			break;
		
		case 2:
			func_283(&Local_81, 0, 0);
			if (func_281(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
...
{
	func_205(58, 2, 1);
	while (!func_202(-1816533207, 0, 4, 58, 6000, 6000, 65, 0, -1, 17, 1))
	{
		SYSTEM::WAIT(0);
	}
	func_3(322, 1);
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_224(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_230(0, iParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_228(PLAYER::PLAYER_ID())) && !func_226(PLAYER::PLAYER_ID(), 0)) && !func_225()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_228(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71588 = 0;
...
int func_230(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_233()
{
	...
	{
		func_232("Trying to set Josh component variation");
		if (func_281(Local_81.f_28[0]))
		{
	...
	switch (iLocal_83)
	{
		...
		case 1:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				func_232("Done Trevor exit");
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				func_232("Exit state for Josh...");
				if (!iLocal_94)
				{
					func_232("Played lead-out on Josh exit state");
					func_234(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
						func_232("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
			...
			{
				func_232("Exit state for camera...");
				if (!iLocal_94)
				{
					func_232("Played lead-out on camera exit state");
					func_234(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
						func_232("Done Josh leadout anim on cam exit state cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -1871534317, false, 1, 1);
						iLocal_94 = 1;
					}
			...
			{
				func_232("cutscene not active...");
				if (!iLocal_94)
				{
					func_232("Played lead-out on not cutscene active");
					func_234(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
						func_232("Done Josh leadout anim on non active cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
...
int func_234(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_235(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_237(bool bParam0)
{
	...
	func_224(1, 1, 0, 0, 0, 0);
}

void func_238(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_239(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_239(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_243(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_243(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_245(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_244(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_244(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_244(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_244(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_244(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_244(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_244(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_244(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_244(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_244(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_244(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_244(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_244(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_244(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_244(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_244(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_249(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_255(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_257()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			{
				func_232("Doing setup for leadin");
				func_220(&uLocal_97, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
				func_220(&uLocal_97, 5, Local_81.f_28[0], "Josh", 0, 1);
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1leadinout");
			...
			{
				func_232("Skipping setup for leadin (wrong area)");
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1leadinout");
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, 0);
			...
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
						{
							...
							func_232("Done Josh leadin anim");
							bLocal_90 = true;
						}
					}
					else
					{
						...
						{
							func_232("Cannot play lead-in, re-requesting cutscene with new sections");
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("JOSH_1_INT_CONCAT", 13, 8);
						}
						func_232("Replay in progress, skipping leadin");
						iLocal_83 = 2;
					}
				}
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_86))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_86) > 0.15f)
					{
						if (!iLocal_91)
						{
							if (func_210(&uLocal_97, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
								func_232("Leadin convo done");
								iLocal_91 = 1;
							}
						}
					}
					...
					{
						func_232("Leadin anim done, launch cutscene");
						iLocal_83 = 2;
					}
					if (func_209(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 2.5f)
					{
				...
				{
					func_232("Leadin not playing, launch cutscene");
					iLocal_83 = 2;
				}
			}
			else
...
void func_259()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_255(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_265(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_267(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_278(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_263(0)) || func_277(1))
			{
			}
			else
			{
...
{
	return func_280(iParam0, Global_36425);
}
...
void func_283(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_281(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_281(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_281(uParam0->f_41[iVar0]))
		{
...
int func_284(var uParam0)
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_295(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_77 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_289(&(uParam0->f_28[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
...
void func_286(int iParam0, bool bParam1)
{
	...
	func_287(iParam0, iLocal_79, vVar0, fVar1);
...
void func_287(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_288(iParam0);
...
void func_297()
{
	...
	if (func_310())
	{
		func_232("...Random Character Script was triggered so additional cleanup required");
	}
	func_309(&(Local_81.f_28[0]), 1, 1, 1);
	func_298(&Local_81, 1, 0, 0);
...
void func_311(bool bParam0)
{
	...
	if (!func_328())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_312(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_313(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_319())
	{
		...
		{
			iVar2 = func_314(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_315()
{
	...
	iVar0 = func_316(&(Global_93682.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_319()
{
	...
	{
		if (func_314(&(Global_93682.f_3)) > -1)
		{
			return 1;
		}
	}
