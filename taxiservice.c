	...
	else
	{
		if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		{
			if (!PED::IS_PED_INJURED(Global_105597) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(Global_105597, Global_105596, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Global_105597, Global_105596, PLAYER::PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
					}
				}
				else if (!PED::IS_PED_FLEEING(Global_105597))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_SMART_FLEE_PED(Global_105597, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
					}
				}
		...
		else if (!PED::IS_PED_INJURED(Global_105597) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(Global_105597, Global_105596, 0))
			{
				...
				{
					TASK::TASK_VEHICLE_DRIVE_WANDER(Global_105597, Global_105596, 12f, 790699);
				}
			}
			PED::SET_PED_KEEP_TASK(Global_105597, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, false);
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(Global_105596, 0))
				{
					...
					{
						TASK::TASK_LEAVE_VEHICLE(iVar2, Global_105596, 64);
					}
				}
			}
			if (iVar0 > 1)
				...
				if (!PED::IS_PED_INJURED(Global_105597) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_811, "leanover_idle", 3))
						{
							...
							{
								TASK::TASK_VEHICLE_TEMP_ACTION(Global_105597, Global_105596, 1, 1000000);
							}
						}
					}
				}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				if (!PED::IS_PED_INJURED(Global_105597) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					...
					TASK::TASK_VEHICLE_TEMP_ACTION(Global_105597, Global_105596, 24, 5000);
				}
				iLocal_89 = MISC::GET_GAME_TIMER();
				iLocal_810 = 8;
			}
	...
	if (!PED::IS_PED_INJURED(Global_105597) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
		{
			...
			else if (!func_2(Global_105597, -272084098))
			{
				...
				TASK::TASK_VEHICLE_PARK(Global_105597, Global_105596, vVar0, fVar1, 3, 60f, 0);
			}
		}
	}
}
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
			{
				if (!PED::IS_PED_INJURED(Global_105597))
				{
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_811, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_811, "leanover_idle", 3))
					{
						...
						{
							TASK::TASK_CLEAR_LOOK_AT(Global_105597);
						}
						TASK::TASK_PLAY_ANIM(Global_105597, &cLocal_811, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					...
					else if (!func_2(Global_105597, 242628503))
					{
						...
						else
						{
							...
							TASK::CLEAR_PED_TASKS(Global_105597);
							TASK::TASK_CLEAR_LOOK_AT(Global_105597);
							PED::SET_DRIVER_ABILITY(Global_105597, 0.5f);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_800);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_105596, Global_105603, fVar1, iVar0, 45f);
							TASK::TASK_VEHICLE_PARK(0, Global_105596, Global_105603, Global_105609, iLocal_110, 60f, 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_800);
							TASK::TASK_PERFORM_SEQUENCE(Global_105597, iLocal_800);
...
int func_168(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iVar3))
	{
		...
		if (bVar4)
		{
			TASK::TASK_ENTER_VEHICLE(iVar3, Global_105596, 20000, iVar6, 2f, 9437185, 0);
			bVar5 = true;
		}
	}
	if (iVar0 > 1)
...
int func_169()
{
	...
	{
		iLocal_56 = 1;
		if (TASK::GET_SCRIPT_TASK_STATUS(Global_105597, 242628503) == 7)
		{
			return 1;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105597))
	{
		if (!PED::IS_PED_INJURED(Global_105597))
		{
			...
			if (!PED::IS_PED_FLEEING(Global_105597) && !PED::IS_PED_IN_COMBAT(Global_105597, 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(Global_105597, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_105596))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105596, 0))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(Global_105597, -258271821) != 1 && TASK::GET_SCRIPT_TASK_STATUS(Global_105597, -258271821) != 0)
								{
									...
									TASK::TASK_VEHICLE_DRIVE_WANDER(0, Global_105596, 12f, 790699);
									TASK::CLOSE_SEQUENCE_TASK(iVar0);
									TASK::TASK_PERFORM_SEQUENCE(Global_105597, iVar0);
									TASK::CLEAR_SEQUENCE_TASK(&iVar0);
								}
							}
							else
							{
								TASK::TASK_SMART_FLEE_PED(Global_105597, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							}
						}
						else
						{
				...
				else if (TASK::GET_SCRIPT_TASK_STATUS(Global_105597, -1146898486) != 1 && TASK::GET_SCRIPT_TASK_STATUS(Global_105597, -1146898486) != 0)
				{
					TASK::TASK_WANDER_STANDARD(Global_105597, 1193033728, 0);
				}
			}
		}
	}
