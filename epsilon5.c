...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_338(60);
	uLocal_79 = func_338(14);
	sLocal_83 = "Marnie";
	fLocal_253 = 40f;
	fLocal_254 = 0.35f;
	fLocal_255 = 0f;
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_274(Local_84.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_81)
		{
			case 0:
				func_254();
...
void func_7()
{
	...
	{
		func_198(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
...
void func_200(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_206(Global_37597[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_206(Global_37597[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_201(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_202(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::_GET_LABEL_TEXT(func_203(iParam1)), 0));
		}
		else
		{
			func_202(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::_GET_LABEL_TEXT(func_203(iParam1)), 0));
		}
		switch (Global_14553)
		{
			case 0:
...
int func_222(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_228(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_230(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_232(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_233(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_237(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_237(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_239(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_238(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_238(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_238(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_238(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_238(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_238(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_238(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_238(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_238(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_238(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_238(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_238(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_238(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_238(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_238(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_238(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_238(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_239(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_244(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_251(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_254()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (func_266(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 1) >= 4.5f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					...
					CAM::_0xF8BDBF3D573049A1(fLocal_254);
					CAM::_0xD1F8363DFAD03848(fLocal_255);
					CAM::_0x5D7B620DAE436138(fLocal_256);
					CAM::_0xC92717EF615B6704(fLocal_257);
			...
			if (iLocal_252 == 0)
			{
				if (func_266(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 1) <= 2.5f)
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmepsilonism5"))
			{
				if (func_243(Local_84.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						...
						{
							func_264(&uLocal_85, 4, Local_84.f_28[0], "MARNIE", 0, 1);
							func_264(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			...
			if (func_243(Local_84.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 3))
				{
					if (iLocal_251 == 0)
					{
						...
						{
							if (func_255(&uLocal_85, "EPS5AUD", "EP5_RCM_LI", 8, 0, 0, 0))
							{
								iLocal_251 = 1;
							}
						}
...
void func_268()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_251(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_274(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_276(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_277(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_287(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_272(0)) || func_286(1))
			{
			}
			else
			{
...
int func_292(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_293(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_215(PLAYER::PLAYER_PED_ID()))
				{
...
int func_293(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_294(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_294(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_316(bool bParam0)
{
	...
	if (!func_333())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_317(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_318(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_324())
	{
		...
		{
			iVar2 = func_319(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
