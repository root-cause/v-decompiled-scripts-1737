...
void __EntryFunction__()
{
	...
	if (func_100(ENTITY::GET_ENTITY_COORDS(iScriptParam_603, true)))
	{
		func_101();
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	...
	bVar2 = true;
	vLocal_568 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_603, true) };
											...
											if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
											{
												if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
												{
													...
													if (func_61(3, &Var7))
													{
														...
														iLocal_570 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_573, ENTITY::GET_ENTITY_ROTATION(iScriptParam_603, 2), 2, false, false, 1065353216, 0, 1065353216);
...
void func_9(int iParam0, var uParam1)
{
	...
	while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iVar0) && !func_62(iParam0, 1))
	{
		func_39();
	}
...
int func_10(int iParam0, int iParam1)
{
	...
	iLocal_598 = MONEY::WITHDRAW_VC(iParam1);
	bLocal_577 = true;
	if (Global_71590 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_11(1918, 1, -1);
...
void func_51(bool bParam0, bool bParam1)
{
	...
	if (Global_71590)
	{
		...
		if (bParam0)
		{
			...
			{
				func_52(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTON(2, 7, true));
			}
			func_31("MPATM_NAV");
			if (MISC::IS_PC_VERSION())
			{
...
void func_53(int iParam0)
{
	...
	switch (iLocal_569)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
				{
					...
					iLocal_570 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_573, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1065353216, 0, 1065353216);
		...
		case 1:
			...
			{
				iLocal_570 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_573, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1065353216, 0, 1065353216);
...
int func_62(int iParam0, int iParam1)
{
	...
	{
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_568, 1.5f, 1.5f, 1.5f, false, true, 1))
		{
			return 1;
		}
	}
