	...
	while (iVar1 < 34)
	{
		...
		if (Global_106565.f_14135[iVar3 /*104*/].f_24 != 0)
		{
			if (Global_106565.f_14135[iVar3 /*104*/].f_99[Global_14553] == 1)
			{
				...
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_106565.f_14135[iVar3 /*104*/].f_18.f_2);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_106565.f_14135[iVar3 /*104*/].f_18.f_1);
