		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					{
						Local_52 = { Local_51 };
						bVar3 = !func_117(uLocal_58, 64);
						func_121(&uLocal_58, 128);
						if (!func_99(3) && !Global_93716)
						{
							if (func_117(uLocal_58, 2097152))
							{
								if ((!func_117(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_98())) && !Global_93716)
								{
									func_110(10);
									break;
								}
						...
						if ((!func_89(6) || Global_105612) || func_88())
						{
							bVar3 = false;
						}
						if (func_117(uLocal_58, 1))
						...
						if (bVar3)
						{
							...
							if (fLocal_57 < ((fLocal_77 * fLocal_77) + 4f))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
									func_85(&uLocal_58, 128);
									bVar3 = false;
									if (!func_117(uLocal_58, 1024))
									{
										func_78("MG_GET_ON_FOOT", -1);
										func_85(&uLocal_58, 1024);
									}
								}
								else if (func_117(uLocal_58, 1024))
								{
									func_121(&uLocal_58, 1024);
				...
				case 6:
					if (!func_117(uLocal_58, 256))
					{
						...
						{
							func_85(&uLocal_58, 256);
						}
					}
					if (func_117(Global_105216, 262144))
					{
						func_121(&Global_105216, 262144);
						func_36();
					}
					if (func_117(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						func_31(&iLocal_71);
						func_121(&uLocal_58, 256);
						func_30();
						if (bVar0)
						{
							func_121(&uLocal_58, 2);
						}
						else if (func_117(uLocal_58, 2))
						{
							if (func_117(Global_105216, 0))
							{
								func_29(&iLocal_62);
								iLocal_62 = -1;
								func_121(&uLocal_58, 2);
						...
						if (iLocal_63 != -1)
						{
							if (func_117(Global_105216, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_93719, 0);
								func_28(func_39(iLocal_63), 0, Global_93719, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_93719, 0);
								func_28(func_39(iLocal_63), 0, Global_93719, 0, 0);
							}
						}
						func_4();
						func_121(&Global_105216, 0);
...
void func_7()
{
	if (func_117(Global_106565.f_20005.f_9, 1))
	{
		func_121(&(Global_106565.f_20005.f_9), 1);
		if (iLocal_91 == Global_106565.f_20005.f_8)
		{
			if (Global_106565.f_20005.f_8 != 2)
			{
				Global_106565.f_20005.f_8++;
				if (Global_106565.f_20005.f_8 == 1)
				{
					func_111(108, 1, 0);
					func_20(114, 1, 0, 1, 0);
				}
				else if (Global_106565.f_20005.f_8 == 2)
				{
					func_111(109, 1, 0);
					func_20(115, 1, 0, 1, 0);
				}
				if (iLocal_88 && Global_106565.f_20005.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		MISC::CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
		MISC::CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
	}
}
...
void func_60()
{
	...
	else if ((PED::IS_PED_INJURED(iLocal_85) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(89, ENTITY::GET_ENTITY_COORDS(iLocal_85, true), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(116, ENTITY::GET_ENTITY_COORDS(iLocal_85, true), 40f))
	{
		func_78("TRI_DEATH", -1);
		iVar0 = iLocal_69;
		func_72(iLocal_69);
...
void func_65()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_68(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_66(iVar0) && (!func_101(14) || Global_105516))
			{
				if (Global_106565.f_2357.f_539.f_4321 != iVar0 && func_66(Global_106565.f_2357.f_539.f_4321))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_96()) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_25767) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_96()) || func_93()) || Global_105612) || Global_25767) || func_95()) || Global_37584) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_87)
	{
		...
		{
			vVar1 = { func_106(iLocal_91 == 1, 2434.162f, 4282.774f, 35.5112f, func_106(iLocal_91 == 0, -1231.203f, -2051.531f, 12.9317f, func_106(iLocal_91 == 2, 1591.099f, 3814.026f, 33.2697f, 0f, 0f, 0f))) };
			fVar0 = func_105(iLocal_91 == 1, 264.0724f, func_105(iLocal_91 == 0, 256.2876f, func_105(iLocal_91 == 2, 222.6197f, 0f)));
		...
		{
			vLocal_79 = { func_106(iLocal_91 == 1, 2434.955f, 4282.711f, 35.5333f, func_106(iLocal_91 == 0, -1230.361f, -2051.761f, 12.918f, func_106(iLocal_91 == 2, 1591.686f, 3813.401f, 33.3371f, 0f, 0f, 0f))) };
			fVar0 = func_105(iLocal_91 == 1, 264.3256f, func_105(iLocal_91 == 0, 253.044f, func_105(iLocal_91 == 2, 220.7912f, 0f)));
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			fVar0 = func_105(iLocal_91 == 1, 79.9315f, func_105(iLocal_91 == 0, 77.5972f, func_105(iLocal_91 == 2, 47.2081f, 0f)));
		...
		{
			func_104(iLocal_91, iVar8, &vVar5, &vVar6, &fVar7);
			if (!func_103(vVar5))
			{
...
void func_104(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_106(bool bParam0, vector3 vParam1, vector3 vParam2)
{
	if (bParam0)
	{
		return vParam1;
...
{
	return func_116(iParam0, Global_36425);
}
...
void func_118()
{
	...
	if (Global_106565.f_20005.f_8 == -1)
	{
		Global_106565.f_20005.f_8 = 0;
	}
	if (Global_106565.f_20005.f_8 < iLocal_91)
	{
		func_85(&uLocal_58, 8388608);
	}
}
...
void func_126(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		func_127(&(Global_17411.f_5660[iVar0 /*10*/]));
