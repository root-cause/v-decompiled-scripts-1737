...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_53(uParam0) || func_49(uParam0)) || func_48(uParam0)) || !func_47(uParam0)) || func_45(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1671295.f_4, 2)) || func_44(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					if (func_49(uParam0))
					{
						func_43(&(uParam0->f_6), 4, "POD_TOO_MANY", 0, 0, 0, 0);
					}
					else
					{
						func_41(&(uParam0->f_6));
				...
				else if (uParam0->f_6 == -1)
				{
					...
					{
						if (func_39(uParam0->f_9) && !Global_262145.f_26042)
						{
							func_43(&(uParam0->f_6), 4, "MPTV_WALKOFF", 0, 0, 0, 0);
						}
						else
						{
							func_43(&(uParam0->f_6), 4, "MPJAC_SIT", 0, 0, 0, 0);
						}
					}
				}
				else if (PAD::IS_CONTROL_JUST_PRESSED(0, 51))
				{
					...
					{
						MISC::SET_BIT(&(Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_4), 15);
						func_35(157);
					}
				}
			}
		...
		case 4:
			...
			if (uParam0->f_1.f_1 == 3)
			{
				...
				{
					if (!func_32(&(uParam0->f_7), 13))
					{
						CAM::_0x2A2173E46DAECD12(0, 1);
						func_31(&(uParam0->f_7), 13);
					}
				}
			}
			PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
			vVar2 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_30(uParam0), func_29(uParam0), 0, 2) };
			vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_30(uParam0), func_29(uParam0), 0f, 2) };
			iVar4 = vVar3.z;
			fVar5 = 0.05f;
		...
		case 5:
			...
			vVar7 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_30(uParam0), func_29(uParam0), 0f, 2) };
			fVar8 = vVar7.z;
		...
		case 6:
			if (func_32(&(uParam0->f_7), 10) || func_15())
			{
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		if ((uParam0->f_13 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BLOCK_INTERRUPT"))) && !func_32(&(uParam0->f_7), 12))
		{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_7), 0)) && !func_32(&(uParam0->f_7), 4)) && !func_11()) && !func_9(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
					if (uParam0->f_1.f_1 == 1 || uParam0->f_1.f_1 == 0)
					{
						...
						{
							func_43(&(uParam0->f_6), 4, "MPOF_AC_PC_EXIT", 0, 0, 0, 0);
						}
						else
						{
							func_43(&(uParam0->f_6), 4, "MPOF_AC_EXIT", 0, 0, 0, 0);
						}
					}
					else if (PAD::_IS_INPUT_DISABLED(2))
					{
						func_43(&(uParam0->f_6), 4, "MPOFSEAT_PCEXIT", 0, 0, 0, 0);
					}
					else
					{
						func_43(&(uParam0->f_6), 4, "MPOFSEAT_EXIT", 0, 0, 0, 0);
					}
				}
				if (uParam0->f_13 == 6)
				{
...
{
	uParam0->f_1.f_1 = func_38(uParam0->f_16[uParam0->f_9 /*14*/].f_13);
	uParam0->f_1.f_2 = func_37(uParam0);
	uParam0->f_1.f_3 = 3;
	uParam0->f_1.f_4 = 3;
}
...
int func_39(int iParam0)
{
	switch (iParam0)
	{
		...
		case 6:
		case 7:
			if (Global_93734.f_338 == 486476725)
			{
				return 1;
			}
			break;
...
{
	Stack.Push(!func_32(&(uParam0->f_7), 5));
...
int func_48(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && func_55(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_49(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_55(PLAYER::GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_50(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_54(int iParam0, vector3 vParam1, int iParam2)
{
...
void func_61(var uParam0)
{
	...
	func_62(&(uParam0->f_7), 0, func_26(0));
...
int func_79(int iParam0)
{
	if (iParam0 != func_51())
	{
		if (func_52(iParam0, 1, 1))
		{
			...
			{
				return func_80(Global_2424047[iParam0 /*416*/].f_309.f_5) == 14;
			}
		}
	}
	return 0;
...
void func_83(var uParam0)
{
	...
	MISC::CLEAR_BIT(&(Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_4), 15);
}
...
void func_85()
{
	func_86(0, &uLocal_188, 0, 1);
	func_86(1, &uLocal_188, 1, 1);
	func_86(2, &uLocal_188, 2, 1);
	func_86(3, &uLocal_188, 3, 1);
	func_86(4, &uLocal_188, 4, 1);
	func_86(5, &uLocal_188, 5, 1);
	func_86(6, &uLocal_188, 6, 1);
	func_86(7, &uLocal_188, 7, 1);
	func_86(8, &uLocal_188, 8, 1);
	func_86(9, &uLocal_188, 9, 1);
	func_86(10, &uLocal_188, 10, 1);
	func_86(11, &uLocal_188, 11, 1);
	func_86(12, &uLocal_188, 12, 1);
	func_86(13, &uLocal_188, 13, 1);
	func_86(14, &uLocal_188, 14, 1);
	func_86(15, &uLocal_188, 15, 1);
	func_86(16, &uLocal_188, 16, 1);
	func_86(17, &uLocal_188, 17, 1);
	func_86(18, &uLocal_188, 18, 1);
	func_86(19, &uLocal_188, 19, 1);
	func_86(20, &uLocal_188, 20, 1);
	func_86(21, &uLocal_188, 21, 1);
	func_86(22, &uLocal_188, 22, 1);
	func_86(23, &uLocal_188, 23, 1);
	func_86(24, &uLocal_188, 24, 1);
	func_86(25, &uLocal_188, 25, 1);
	func_86(26, &uLocal_188, 26, 1);
	func_86(27, &uLocal_188, 27, 1);
	func_86(28, &uLocal_188, 28, 1);
	func_86(29, &uLocal_188, 29, 1);
	func_86(30, &uLocal_188, 30, 1);
}
...
void func_86(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_88(func_90(), func_89(iParam3, fVar1)) + vVar0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_88(func_87(), func_89(iParam3, fVar1)) + vVar0 };
