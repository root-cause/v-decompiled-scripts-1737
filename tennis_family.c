...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_306(uParam1))
	{
		...
		case 12:
			...
			{
				TASK::TASK_STAND_STILL(func_264(uParam0[iParam4 /*94*/]), -1);
			}
			break;
		...
		case 20:
			...
			if (func_270(uParam1) != iParam3 && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0[iParam3 /*94*/]), 242628503) == 7)
			{
				func_231(uParam0->f_1657, 1);
				func_235(uParam0[iParam3 /*94*/], uParam0, func_271(uParam1), iParam3, 0, 0);
...
{
	if (!((!PED::IS_PED_INJURED(func_264(uParam0)) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_264(uParam0))) && MISC::ARE_STRINGS_EQUAL(TASK::GET_TASK_MOVE_NETWORK_STATE(func_264(uParam0)), "running")))
	{
		TASK::TASK_MOVE_NETWORK_BY_NAME(func_264(uParam0), sParam1, fParam2, 0, "mini@tennis", 4);
	}
}
...
void func_53(var uParam0, var uParam1)
{
	...
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 242628503) != 1)
		{
			vVar0 = { uParam0->f_37 - uParam1->f_29 * Vector(0.93f, 0.93f, 0.93f) };
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_264(uParam0), uParam1->f_29 + vVar0, 2f, 20000, 1048576000, 0, 1193033728);
			func_58(uParam0, 2048);
			func_54("FAR_FROM_COURT", -1);
		}
	}
	else if (func_104(uParam0, 2048) && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 713668775) != 1)
	{
	...
	if (iParam3 != iParam4 && ((func_104(uParam0, 512) && uParam0->f_31 != 4) || uParam0->f_31 == 4))
	{
		if (func_153(uParam0, vVar11, bVar6))
		{
			...
			else if (iVar4 == 75 && func_145(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				{
					TASK::CLEAR_PED_TASKS(func_264(uParam0));
...
void func_178(var uParam0, var uParam1, bool bParam2)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		if (bParam2)
		{
			if (!PED::IS_PED_INJURED(func_264(uParam0)))
			{
				TASK::TASK_LOOK_AT_ENTITY(func_264(uParam0), *uParam1, -1, 6, 2);
			}
		}
		else if (!PED::IS_PED_INJURED(func_264(uParam0)))
		{
			TASK::TASK_CLEAR_LOOK_AT(func_264(uParam0));
		}
	}
}
...
{
	if (!PED::IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	...
	{
		if (!PED::IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_264(uParam0[iParam1 /*94*/])))
		{
			if (MISC::ARE_STRINGS_EQUAL(TASK::GET_TASK_MOVE_NETWORK_STATE(func_264(uParam0[iParam1 /*94*/])), "Intro") && TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(func_264(uParam0[iParam1 /*94*/])))
			{
				TASK::REQUEST_TASK_MOVE_NETWORK_STATE_TRANSITION(func_264(uParam0[iParam1 /*94*/]), "running");
			}
		}
	}
	return 1;
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			if (!bParam6 && bParam7)
			{
				...
				TASK::TASK_PLAY_ANIM(0, func_195(func_196(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
			...
			TASK::TASK_PERFORM_SEQUENCE(func_264(uParam0), uParam0->f_54);
...
void func_235(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		if (!PED::IS_PED_INJURED(func_264(uParam0)) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_264(uParam0)))
		{
			if (MISC::ARE_STRINGS_EQUAL(TASK::GET_TASK_MOVE_NETWORK_STATE(func_264(uParam0)), "Intro") && TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(func_264(uParam0)))
			{
				TASK::REQUEST_TASK_MOVE_NETWORK_STATE_TRANSITION(func_264(uParam0), "running");
			}
			...
			if (TASK::GET_TASK_MOVE_NETWORK_EVENT(func_264(uParam0), "IdleStarted"))
			{
			...
			TASK::SET_TASK_MOVE_NETWORK_SIGNAL_BOOL(func_264(uParam0), &(uParam1->f_1670), 1);
			TASK::SET_TASK_MOVE_NETWORK_SIGNAL_FLOAT(func_264(uParam0), "Speed", uParam0->f_62);
		}
	}
	...
	switch (func_147(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_75(uParam0) == 75)
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(func_264(uParam0), vVar1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), vVar2, false, true, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 2106541073) == 7) && !func_227(&(uParam0->f_4), 256))
				{
					func_234(&(uParam0->f_4), 0);
					func_216(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, vVar1) <= (0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 2106541073) == 7)
				{
...
void func_272(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!PED::IS_PED_INJURED(func_264(uParam0[iVar0 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = TASK::GET_SEQUENCE_PROGRESS(func_264(uParam0[iVar0 /*94*/]));
	}
	if (!PED::IS_PED_INJURED(func_264(uParam0[iVar1 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_264(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
		*uParam3 = TASK::GET_SEQUENCE_PROGRESS(func_264(uParam0[iVar1 /*94*/]));
	}
...
int func_304(var uParam0, int iParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			TASK::TASK_SEEK_COVER_FROM_PED(func_264(uParam0[(1 - iParam1) /*94*/]), PLAYER::PLAYER_PED_ID(), -1, 0);
		}
		return 1;
	}
	if (PED::IS_PED_INJURED(iVar0))
