...
int func_2(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Race_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Race_Creator", 28000);
...
int func_5(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Deathmatch_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Deathmatch_Creator", 28000);
...
int func_6(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Capture_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Capture_Creator", 28000);
...
int func_7(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Survival_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Survival_Creator", 28000);
...
int func_8(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_LTS_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_LTS_Creator", 28000);
...
int func_9(int iParam0)
{
	if (!MISC::IS_BIT_SET(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Mission_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Mission_Creator", 28000);
...
int func_16()
{
	if (MISC::IS_BIT_SET(Global_1371947.f_102, 1))
	{
		return 1;
	}
	if (MISC::IS_BIT_SET(Global_1371947.f_102, 2))
	{
		MISC::CLEAR_BIT(&(Global_1371947.f_102), 2);
		return 2;
	}
	if (MISC::IS_BIT_SET(Global_1371947.f_102, 3))
	{
		MISC::CLEAR_BIT(&(Global_1371947.f_102), 3);
		return 3;
	}
	return 0;
}
