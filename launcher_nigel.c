...
void __EntryFunction__()
{
	...
	{
		func_314("Force cleanup [TERMINATING]");
		if (Var0 != -1)
		{
			if (Global_105652[Var0 /*10*/].f_9 != -1)
			{
				func_314("Relinquishing candidate id...");
				func_313(&(Global_105652[Var0 /*10*/].f_9));
			}
		}
		func_295(&Var0, &Var3, 1);
	}
	if (!func_292(&iVar4, &Var0, vVar1, 1f))
	{
		func_291();
		func_314("SCRIPT TERMINATED");
	...
	while (!func_248(&Var0, &uVar2))
	{
		SYSTEM::WAIT(0);
		if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_314("Player out of range [TERMINATING]");
			func_295(&Var0, &Var3, 1);
		}
	}
	if (Var0 == 43)
	...
	while (true)
	{
		...
		func_213(Var0);
		func_206(&iLocal_68, &(Var0.f_9), vVar1);
		if (Var0 == 42)
		{
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(func_205(), 4, 0, 0, func_204());
				func_314("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_203(&uLocal_56) && Var0 == 37)
		{
			func_200(Var0.f_28[1], &uLocal_56, Var0);
		}
		if (Var0 == 37)
		{
			func_196(&Var0, vVar1, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_70);
		}
		else if (Var0 == 42)
		{
			func_191(&Var0, vVar1, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0 == 43)
		{
			func_189(&Var3, &(Var0.f_35[0]), &(Var0.f_28[1]));
			func_191(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar5 = false;
		if (Var0 == 41)
		{
			if (func_187(&Var0, &uVar2) || func_186(&Var0))
			{
				bVar5 = true;
			}
		}
		else if (func_171(&Var0, 0))
		{
			bVar5 = true;
		}
		if (bVar5)
...
int func_2(int iParam0)
{
	...
	if (!func_165())
	{
		while (!func_156(*iParam0))
		{
			...
			{
				func_314("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_112(iParam0))
	{
		func_314("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_112(int iParam0)
{
	...
	if (func_141(&(iParam0->f_1)))
	{
		...
		{
			func_314("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
		}
		else
		{
			func_314("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
int func_141(char* sParam0)
{
	...
	func_314("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
...
int func_156(int iParam0)
{
	...
	iVar0 = func_158(&(Global_105652[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_161(iParam0, Global_36425);
}
...
int func_163()
{
	return func_164(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_166(int iParam0, int iParam1)
{
	...
	{
		case 0:
			*iParam1 = func_167(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_167(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_167(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*iParam1 = func_167(414f, -761f, 29f, 0);
		...
		case 9:
			*iParam1 = func_167(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_167(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_167(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*iParam1 = func_167(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_167(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*iParam1 = func_167(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_167(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*iParam1 = func_167(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*iParam1 = func_167(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_167(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 386);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_167(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 149);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_167(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_167(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*iParam1 = func_167(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_167(vector3 vParam0, bool bParam1)
{
	int iVar0;
	...
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_177(2))
							{
								if (func_175(iParam0->f_27))
								{
									...
									func_314("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				else if (func_126(iParam0->f_28[0]))
				{
					if (func_173(iParam0))
					{
						if (func_177(2))
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, true, 0))
					{
						if (func_177(2))
						{
							...
							{
								func_174(iParam0->f_27, *iParam0);
								func_314("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*iParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, true, 0))
				{
					if (func_177(2))
					{
						...
						{
							func_174(1, *iParam0);
							func_314("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, true, 0))
						{
							if (func_177(2))
							{
								...
								{
									func_174(iParam0->f_27, *iParam0);
									func_314("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_174(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			func_314("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_314("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				if (func_126(iParam0->f_28[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0->f_28[iVar0], true), 7.5f, 1))
					{
						...
						{
							func_314("Player damaged the N1D peds but it's not safe to trigger the mission!");
						}
					}
				}
				else if (func_177(2))
				...
				{
					func_314("Player killed a N1D ped but it's not safe to trigger the mission!");
				}
			}
			iVar0++;
		}
...
{
	if (func_188(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (func_177(2))
		{
			if (func_175(iParam0->f_27))
...
bool func_188(var uParam0, struct<2> Param1, float fParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		switch (*iParam0)
		{
			...
			case 1:
				if ((MISC::GET_GAME_TIMER() - iParam0->f_2) > iParam0->f_3)
				{
					...
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_190(0), 0);
...
int func_191(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_196(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_177(2))
		{
			if (!func_144())
			{
				if (((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && func_126(iParam0->f_28[1])) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					func_314("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_194(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_194(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_192(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_314("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (((func_198(sParam3) && !*uParam8 == 1) && func_126(PLAYER::PLAYER_PED_ID())) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_314("pause conversation");
				func_197(1);
				*uParam8 = 1;
			}
			if (func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
				func_314("unpause conversation");
				func_197(0);
				*uParam8 = 2;
			}
		}
...
int func_214(var uParam0, bool bParam1)
{
	...
	if (Global_71590)
	{
		func_314("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_109(*uParam0, &Var0);
	if ((func_247(*uParam0) || func_245(*uParam0)) || Global_71835 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_314("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_241(*uParam0))
	{
		...
		func_314("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_314("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_314("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	...
	if (func_125(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], 0))
				{
					func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), 0))
				{
					func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_176(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("TOWTRUCK") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_176(uParam0->f_35[iVar0]))
								{
									...
									{
										func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_176(iVar3))
						{
							...
							{
								func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_314("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
	...
	if (func_125(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_314("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_314("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
						{
							...
							func_314("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_239(*uParam0))
					{
						if (!func_155(*uParam0))
						{
							if (func_234(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_314("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_314("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_222(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_314("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_221(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_314("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_314("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_126(uParam0->f_41[0]))
						{
...
bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_225(&(Local_49[iVar2 /*4*/]), vVar1, iParam1, &(Local_49[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar2 /*4*/].f_3) < iParam4);
}

int func_225(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_226(iParam2, iParam5) };
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_230(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_230(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_229(vVar1, vVar0);
...
int func_236(int iParam0, float fParam1)
{
	...
	{
		if (func_237(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_237(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_230(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_246() && Global_93682.f_11 == 6) && iParam0 == func_164(&(Global_93682.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_248(int iParam0, var uParam1)
{
	...
	func_314("Created initial scene");
	return 1;
}
...
int func_249(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcmnigel3", "base", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_253(&(uParam0->f_28[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_251(&(uParam0->f_35[0]), iLocal_55, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_126(uParam0->f_35[0]))
				{
			...
			if (!func_250(&(uParam0->f_28[1]), &(uParam0->f_35[0])))
			{
				bVar2 = false;
			}
			if (bVar2)
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_252(iParam0);
...
int func_253(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_254(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_259(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_260(42, 1);
			func_258(&(uParam0->f_48), "rcmnigel2", "base_nigel", "base_nigel");
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::REQUEST_MODEL(iVar0[iVar1]);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_253(&(uParam0->f_28[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_251(&(uParam0->f_35[0]), iLocal_55, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_126(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_35[0], 5, false);
			...
			{
				func_251(&(uParam0->f_35[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_126(uParam0->f_35[1]))
				{
...
int func_264(var uParam0, var uParam1)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_267(uParam1);
			func_266(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_266(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_266(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_266(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_266(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_266(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_266(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_266(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_266(uParam1, -1386.75f, 167.32f, 57.11f);
			func_266(uParam1, -1411.5f, 109.64f, 51.49f);
			func_266(uParam1, -1379.52f, 111.05f, 54.28f);
			func_266(uParam1, -1371.77f, 24.07f, 52.88f);
			func_266(uParam1, -1342.27f, 16.92f, 52.16f);
			func_265(uParam1);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_257(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_268(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_257(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_269(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_257(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_251(&(uParam0->f_35[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_126(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[0], 1084227584);
		...
		case 3:
			...
			func_251(&(uParam0->f_35[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_126(uParam0->f_35[1]))
			{
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[1], 27, 27);
			}
			func_271(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			func_271(&(uParam0->f_28[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			...
			func_271(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_125(uParam0->f_28[2]))
			{
			...
			func_270(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_126(uParam0->f_41[0]))
			{
...
void func_270(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_216(iParam0);
...
void func_271(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_272(iParam0);
...
int func_273(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			uParam0->f_27 = 1;
			func_274(4, 0);
			func_314(" SetupScene_NIGEL_1A - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, FALSE)	");
		...
		case 1:
			if (!func_257(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			func_271(&(uParam0->f_28[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_271(&(uParam0->f_28[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_125(uParam0->f_28[1]))
			{
			...
			func_271(&(uParam0->f_28[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_271(&(uParam0->f_28[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_271(&(uParam0->f_28[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_271(&(uParam0->f_28[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_125(uParam0->f_28[2]))
			{
			...
			func_251(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_126(uParam0->f_35[0]))
			{
...
var func_278(int iParam0, int iParam1)
{
	struct<5> Var0;
...
struct<6> func_280(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
int func_281(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcmnigel1", "base_nigel", "base_nigel");
			func_258(&uLocal_56, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_51 = 1;
			break;
		...
		case 2:
			bVar3 = true;
			if (!func_253(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!func_253(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_251(&(uParam0->f_35[0]), iLocal_55, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_126(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_35[0], 5, false);
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(uParam0->f_28[1]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[1], true);
...
int func_283(int iParam0)
{
	...
	if (Global_71590)
	{
		func_314("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_106565.f_9079 && !func_107(1))
	{
		func_314("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_284(iParam0))
	{
		Global_105652[iParam0 /*10*/].f_1 = 1;
		func_314("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_93682.f_11 == 6)
	{
		if (Global_93682 < 9)
		{
			...
			{
				func_314("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_105652[iParam0 /*10*/].f_1 = 1;
		func_314("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
void func_291()
{
	func_314("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_292(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_293((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_293((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_314("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_293(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_294(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_294(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_295(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_314("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		if (*iParam0 == 38)
		{
			func_274(4, 1);
			func_312(iParam0);
			func_314(" Script_Cleanup - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, TRUE)");
		}
		else if (*iParam0 == 39)
		{
			func_310(iParam0);
	...
	if (iLocal_68 != -1)
	{
		func_314("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_212(&iLocal_68);
	}
	switch (*iParam0)
	{
...
void func_310(var uParam0)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_125(uParam0->f_28[1]))
		{
			if (func_311(uParam0->f_28[1], 1785177548))
			{
...
void func_312(var uParam0)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_125(uParam0->f_28[0]))
		{
			if (func_311(uParam0->f_28[0], 1785177548))
			{
...
void func_316()
{
	func_314("Running start routines.");
	Global_106283++;
}
