...
void __EntryFunction__()
{
	...
	while (!func_48(&uLocal_41) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_51();
		func_54(PLAYER::PLAYER_PED_ID());
		SYSTEM::WAIT(0);
	}
	if (func_54(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
		if (func_47(PLAYER::GET_PLAYERS_LAST_VEHICLE(), joaat("BAGGER")))
		{
			func_33(-1633.43f, -1111.998f, 11.02252f, -1661.27f, -1142.66f, 25.51722f, 12f, -1630.952f, -1107.58f, 12.0215f, 51.9704f, 1, 1, 1, 0, 0);
		}
		else if (func_47(PLAYER::GET_PLAYERS_LAST_VEHICLE(), joaat("SANDKING")))
		{
	...
	func_29();
	func_28();
	func_27(&Local_164, 1, 0);
	SYSTEM::WAIT(0);
	func_27(&Local_165, 2, 0);
	Local_164.f_11 = 1;
	func_20(1);
	SYSTEM::WAIT(0);
	func_15();
	if (func_54(PLAYER::PLAYER_PED_ID()) && func_54(Local_164.f_9))
	{
	...
	SYSTEM::WAIT(0);
	if (func_54(PLAYER::PLAYER_PED_ID()) && func_54(Local_165.f_9))
	{
...
void func_33(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_34(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_34(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_44(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_36(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_37(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_44(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_45(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_45(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_45(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_45(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_45(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_45(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_45(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_45(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_45(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_45(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_45(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_45(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_45(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_45(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_45(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_45(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_45(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_55(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_184(bool bParam0)
{
	...
	{
		HUD::CLEAR_HELP(1);
		MISC::CLEAR_BIT(&Global_71838, 7);
		func_1(500, 1);
	}
	func_225(303, 0, 0);
	func_224(&Local_169, 0, 1);
	func_223(&iLocal_182);
	func_223(&iLocal_183);
	func_54(PLAYER::PLAYER_PED_ID());
	...
	func_221();
	func_220(PLAYER::PLAYER_PED_ID(), -1631.348f, -1112.651f, 12.0206f);
...
void func_191(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_193() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_193() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_196(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_193() /*10778*/].f_6165.f_10, iParam0);
}
...
Vector3 func_220(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_226()
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_229() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
