...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_232(Local_77.f_9, 0, 0, 0, 0, 0);
			...
			switch (iLocal_80)
			{
				case 0:
					if (func_222(1, 1093140480, 0))
					{
						...
						if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1736361794))
						{
							...
							OBJECT::_SET_DOOR_ACCELERATION_LIMIT(1736361794, 0, 1, 0);
						}
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_215(PLAYER::PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
...
void func_206(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_210(PLAYER::PLAYER_ID())) && !func_208(PLAYER::PLAYER_ID(), 0)) && !func_207()) && !bParam4) && !bParam5)
			{
...
int func_215(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_216(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_217(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_222(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_229(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_228(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
int func_229(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_232(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_234(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_235(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_246(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_245(0)) || func_244(1))
			{
			}
			else
			{
...
void func_262(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_265(bool bParam0)
{
	...
	if (!func_285())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_266(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_267(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_273())
	{
		...
		{
			iVar2 = func_268(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
