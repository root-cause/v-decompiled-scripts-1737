...
void func_14()
{
	switch (Global_26006)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_20[Global_26008]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_20[Global_26008]))
					{
						Global_26009 = 0;
					}
					else
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_22[Global_26008]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_22[Global_26008]))
					{
						Global_26009 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_23[Global_26008]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_23[Global_26008]))
					{
						Global_26009 = 0;
					}
					else
