...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105652[Var0 /*10*/].f_9 != -1)
			{
				...
				func_266(&(Global_105652[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_196(Var0);
		func_189(&iLocal_53, &uLocal_54, &(Var0.f_9), vVar1, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_182(&Var0, vVar1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_167(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_182(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_145())
		{
			if (((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_188(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_187(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
				func_185(&uVar0, cParam2, sParam3, 7, 0, 0);
				uParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_183(sParam3))
		{
			if (func_126(PLAYER::PLAYER_PED_ID()))
			{
				if (func_188(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_143();
				}
			}
...
void func_189(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_188(PLAYER::PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_192(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_188(PLAYER::PLAYER_PED_ID(), vParam4, 1);
					fVar1 = func_188(PLAYER::PLAYER_PED_ID(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_188(PLAYER::PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_193(iParam0);
				}
			}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_237(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
