...
void __EntryFunction__()
{
	...
	while (iLocal_275 && func_42(5, 0))
	{
		...
		{
			if (iLocal_109 == 258 && func_39(13) == 2)
			{
				func_62();
			}
		}
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_357))
			{
				if (!iLocal_361)
				{
					...
					else
					{
						...
						{
							func_15(&uLocal_110, func_16(), PLAYER::PLAYER_PED_ID(), &Local_351, 0, 1);
						}
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_354))
						{
							func_15(&uLocal_110, 4, iLocal_276[0], &Local_354, 0, 1);
						}
...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_19(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_105516))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91041, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91042, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
							{
						...
						if (iLocal_109 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
								{
...
int func_23(int iParam0, float fParam1)
{
	int iVar0;
	vector3 vVar1;
	int iVar2;
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_26140[iVar0 /*23*/].f_16 == 9)
			{
			}
			else
			{
				vVar1 = { func_25(iVar0, 0) };
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (MISC::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
					{
						vVar4 = { func_25(iVar0, iVar2) };
						if (!func_24(vVar4))
						{
...
int func_26(int iParam0)
{
	...
	while (iVar1 < 1)
	{
		if (!func_28(vLocal_288[iVar1 /*3*/], 0f, 0f, 0f, 0))
		{
			if (func_27(PLAYER::PLAYER_PED_ID(), vLocal_283 + vLocal_287[iVar1 /*3*/], vLocal_288[iVar1 /*3*/], (fLocal_284 + fLocal_289[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
...
int func_27(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3, int iParam4, bool bParam5, int iParam6)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iParam0))
	{
		...
		if (!bParam2)
		{
			...
			if (func_30(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_30(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_31(int iParam0, float fParam1)
{
	...
	{
		if (func_32(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_32(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_34(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_34(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_33(vVar1, vVar0);
...
int func_35(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_40()
{
	...
	if ((func_10(0) || func_10(3)) || func_10(2))
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_41())
		{
			return 1;
		}
	}
	...
	if (Global_2437364.f_74)
	{
		return 1;
	}
	if (Global_91190.f_44 == 1)
	{
		if (Global_91190.f_46 == 0)
		{
			return 1;
		}
	}
...
int func_42(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_93403) && iParam1 != 0)
		{
			Global_93403 = 0;
		}
	}
...
void func_51()
{
	...
	iLocal_109 = Global_93085;
	func_55(iLocal_109, &vLocal_283, &fLocal_284, &cVar0);
	func_53(iLocal_109, &sLocal_290, &cLocal_306, &cLocal_322, &uVar1, &uVar2);
	...
	switch (iLocal_109)
	{
		...
		case 165:
			...
			Local_357 = { func_52("MICS3_IG_2", 3) };
			fLocal_360 = 0.2f;
			break;
...
struct<4> func_52(char* sParam0, int iParam1)
{
	struct<4> Var0;
...
int func_53(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
	...
	switch (iParam0)
	{
		...
		case 305:
			func_54(iParam0, sParam1, sParam2, sParam3);
			return 1;
			break;
...
void func_54(int iParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
int func_55(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	...
	if (func_57(iParam0, uParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
...
int func_57(int iParam0, var uParam1, char* sParam2)
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106565.f_2357.f_539.f_2310[0];
			StringCopy(sParam2, func_61(Global_106565.f_2357.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106565.f_2357.f_539.f_2310[1];
			StringCopy(sParam2, func_61(Global_106565.f_2357.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106565.f_2357.f_539.f_2310[2];
			StringCopy(sParam2, func_61(Global_106565.f_2357.f_539.f_2314[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_60(iParam0, &vVar0, uParam1))
			{
		...
		case 9:
			return func_57(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_57(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_57(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_57(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_57(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_57(303, uParam1, sParam2);
			break;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_58(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_58(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_58(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_58(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 60:
			if (func_58(iParam0, 59, uParam2, uParam3))
			{
		...
		case 77:
			if (func_58(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
		...
		case 131:
			...
			{
				case 13:
					if (func_58(iParam0, 130, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) };
						*uParam3 = (*uParam3 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f));
						return 1;
...
int func_60(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		...
		case 9:
			return func_60(8, uParam1, uParam2);
			break;
