...
void __EntryFunction__()
{
	...
	iLocal_96 = 600000;
	iLocal_363 = -1;
	func_301(ScriptParam_368);
	while (true)
	{
		func_300();
		if (func_290() || !func_289(PLAYER::PLAYER_ID(), 0, 1))
		{
			func_287();
		}
		switch (func_286(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_285() == 2)
				{
			...
			case 2:
				if (func_285() == 2)
				{
					...
					{
						if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 4))
						{
							func_33(1);
							func_32(0);
							func_25();
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		switch (Local_97.f_5.f_2)
		{
				...
				if (MISC::IS_BIT_SET(Local_97.f_5.f_3, 1))
				{
					if (MISC::IS_BIT_SET(Local_97.f_5.f_3, 0))
					{
						if (!func_20(&(Local_97.f_5)) || func_19(&(Local_97.f_5), 5000, 0))
						{
							...
							{
								if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 0))
								{
									MISC::SET_BIT(&(Local_97.f_5.f_73), iVar1);
									Local_97.f_5.f_72++;
									if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 6))
									{
										Local_97.f_5.f_5[iVar0] = -1;
									}
								}
			...
			case 1:
				...
				{
					if (func_289(iVar0, 1, 1))
					{
						if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 8))
						{
							if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 0))
							{
					...
					if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 0))
					{
						if (func_289(iVar0, 1, 1))
						{
							if (Local_97.f_5.f_38[iVar0] == -1)
							{
								...
								if (iVar3 > -1)
								{
									if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 0))
									{
										if (Local_97.f_5.f_38[iVar0] == -1)
										{
										...
										else if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 3))
										{
											Local_97.f_5.f_38[iVar0] = Local_97.f_5.f_38[iVar3];
										}
										else if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 3))
										{
				...
				while (iVar1 <= 19)
				{
					if (!bVar0)
					{
						...
						if (func_12(iVar1))
						{
							...
							if (iVar12 != -1)
							{
								if (Global_2423876.f_87[iVar12] == 0)
								{
									if (!MISC::IS_BIT_SET(*iParam1, iVar1))
									{
...
int func_12(int iParam0)
{
	...
	if (iVar0 != -1)
	{
		if (MISC::IS_BIT_SET(Global_2423876.f_64, iVar0))
		{
			if (!MISC::IS_BIT_SET(Global_2423876.f_62, iVar0))
			{
				return 1;
			}
		}
...
int func_13(int iParam0)
{
	...
	while (iVar1 <= 31)
	{
		...
		{
			if (func_289(iVar2, 0, 1))
			{
				if (!MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 4))
				{
					if (MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 3))
					{
						iVar0 = 1;
					}
				}
		...
		if (iVar1 == -1)
		{
			if (iVar0 != iParam0)
			{
				if (MISC::IS_BIT_SET(*uParam1, iVar0))
				{
					if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 0))
					{
						if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 3))
						{
							if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 2))
							{
								if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 8))
								{
									if (Local_97.f_5.f_5[iVar0] == -1)
...
void func_21()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (func_289(iVar1, 0, 1))
		{
			if (!MISC::IS_BIT_SET(Global_1589819[iLocal_171 /*818*/].f_146, 4))
			{
				MISC::CLEAR_BIT(&iLocal_197, 1);
			}
		}
		if (MISC::IS_BIT_SET(Global_1589819[iLocal_171 /*818*/].f_146, 0))
		{
			if (func_289(iVar1, 0, 1))
			{
				if (iVar2 > -1)
		...
		else if (func_289(iVar1, 0, 1))
		{
			if (MISC::IS_BIT_SET(Global_1589819[iLocal_171 /*818*/].f_146, 12))
			{
				if (Local_97.f_5.f_5[iLocal_171] != -1)
				{
					Local_97.f_5.f_5[iLocal_171] = -1;
...
void func_32(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 0))
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 0);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 0))
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 0);
	}
}
...
void func_33(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 4))
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 4);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 4))
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 4);
	}
}
...
int func_34(var uParam0)
{
	...
	if (*uParam0 > 0)
	{
		...
		if (!MISC::IS_BIT_SET(uParam0->f_1, 2))
		{
			...
			{
				if ((func_281(PLAYER::PLAYER_ID(), 1) || func_280()) || func_279() != 0)
				{
					func_277(uParam0);
				...
				if (!func_281(PLAYER::PLAYER_ID(), 1))
				{
					if (!func_280())
					{
						if (func_279() == 0)
						{
							...
							MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 2);
							if (*uParam0 > 1)
							{
								*uParam0 = 1;
							}
		...
		if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 5))
		{
			if (func_281(PLAYER::PLAYER_ID(), 1) || func_280())
			{
				MISC::SET_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 5);
				*uParam0 = 0;
				func_32(0);
				func_276(0);
				func_24(8, 0);
		...
		if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 9))
		{
	...
	switch (*uParam0)
	{
		case 0:
			iVar3 = PLAYER::PLAYER_ID();
			if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 13))
			{
				if (MISC::IS_BIT_SET(Global_2528542.f_1717, 6) || MISC::IS_BIT_SET(Global_2528542.f_1719, 31))
				{
					if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 0))
					{
						if (!func_274())
								...
								if (!func_280())
								{
									if (func_279() == 0)
									{
										if (func_164())
										{
											if (func_147(uParam0))
											{
												Global_1648421.f_1 = -1;
												func_32(1);
												func_275();
												if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 5))
												{
													MISC::CLEAR_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 5);
												}
											}
										}
									}
				...
				if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 0))
				{
					...
					if (MISC::IS_BIT_SET(Global_1648421, 1))
					{
						iVar3 = PLAYER::PLAYER_ID();
			...
			else
			{
				if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 0))
				{
					MISC::CLEAR_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 0);
					MISC::CLEAR_BIT(&(uParam0->f_1), 0);
					MISC::CLEAR_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 2);
					MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 16);
					func_32(0);
				}
				if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 12))
				{
					if (Local_97.f_5.f_38[iVar3] == -1 && Local_97.f_5.f_5[iVar3] == -1)
					{
						MISC::CLEAR_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 12);
					}
				}
				...
				{
					MISC::CLEAR_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 13);
					func_18(&(uParam0->f_6));
				}
			}
			break;
		...
		case 1:
			...
			{
				if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 16))
				{
					MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 16);
				}
				...
				if (iVar0 > -1 && func_141(iVar0, 1))
				{
					...
					{
						if (func_289(iVar4, 0, 1))
						{
							if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 4) && !MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 5))
							{
			...
			else
			{
				...
				if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 2))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_10(iVar1)) < (15f * 15f) || (iVar0 == -1 && func_139(25f))) || func_138(1101004800, 1117126656))
						{
							...
							MISC::SET_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 2);
						}
					}
				}
				else
				{
					...
					if (MISC::IS_BIT_SET(Global_1648421, 15))
					{
			...
			if (iVar0 > -1 && func_141(iVar0, 1))
			{
					...
					if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 2))
					{
						if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 12))
						{
							if (func_20(&(uParam0->f_10)))
							{
								...
								{
									MISC::SET_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 12);
									MISC::SET_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 13);
									if (HUD::DOES_BLIP_EXIST(uParam0->f_4))
									{
										HUD::REMOVE_BLIP(&(uParam0->f_4));
									}
				...
				if (!MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 12))
				{
					if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 2) && MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 2))
					{
						MISC::CLEAR_BIT(&(uParam0->f_1), 12);
						MISC::CLEAR_BIT(&iLocal_197, 11);
					...
					else if (MISC::IS_BIT_SET(Global_1589819[iVar3 /*818*/].f_146, 2))
					{
						if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 2))
						{
							func_116();
					...
					if (!func_111())
					{
						if (iVar0 > -1 && func_141(iVar0, 1))
						{
							...
							if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar4))
							{
								if (func_289(iVar4, 1, 1))
								{
									if (!MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 16))
									{
										Var5 = { func_136(iVar4) };
										if (NETWORK::NETWORK_IS_FRIEND(&Var5))
										{
						...
						if (!MISC::IS_BIT_SET(uParam0->f_1, 3) && !MISC::IS_BIT_SET(uParam0->f_1, 14))
						{
							...
							MISC::SET_BIT(&(uParam0->f_1), 3);
							MISC::SET_BIT(&(Global_1589819[iVar3 /*818*/].f_146), 8);
						}
					}
				}
				else
...
void func_85(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 17))
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 17);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 17))
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 17);
	}
}
...
int func_86(var uParam0)
{
	...
	iVar0 = Local_97.f_5.f_5[PLAYER::PLAYER_ID()];
	if (MISC::IS_BIT_SET(Global_1589819[NETWORK::PARTICIPANT_ID_TO_INT() /*818*/].f_146, 2))
	{
		if (func_144(1167, -1, 0) > iLocal_363)
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 10);
			if (iVar0 > -1)
			{
				iVar1 = iVar0;
				if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
				{
					if (func_289(iVar1, 1, 1))
					{
						if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 2))
						{
							Global_1648421.f_1 = iVar0;
							MISC::SET_BIT(&Global_1648421, 14);
						}
					}
				}
			}
	...
	if ((MISC::IS_BIT_SET(uParam0->f_1, 7) && !MISC::IS_BIT_SET(uParam0->f_1, 10)) && !MISC::IS_BIT_SET(uParam0->f_1, 9))
	{
		...
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 11);
			return 1;
		}
	}
	return 0;
...
int func_87()
{
	...
	if (iVar0 > -1)
	{
		if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 11))
		{
			return 1;
		}
	}
...
int func_88()
{
	...
	if (iVar0 > -1)
	{
		if (MISC::IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_146, 10))
		{
			return 1;
		}
	}
...
int func_94()
{
	if (((((((((((((((!func_289(PLAYER::PLAYER_ID(), 1, 1) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_100(8, -1)) || func_100(15, -1)) || func_99()) || func_100(3, -1)) || HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) || func_281(PLAYER::PLAYER_ID(), 1)) || func_280()) || func_98()) || func_97()) || func_96()) || HUD::IS_PAUSE_MENU_ACTIVE()) || NETWORK::NETWORK_IS_IN_TUTORIAL_SESSION()) || func_95())
	{
		return 0;
	}
	return 1;
...
bool func_95()
{
	return MISC::IS_BIT_SET(Global_2528542.f_1723, 12);
}
...
void func_101(var uParam0)
{
	...
	if (func_64())
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 2))
			{
				if (iLocal_363 > -1)
				{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_1, 7))
	{
		if (!func_109())
		{
			...
			{
				if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 2) && ((SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("am_hold_up")) == 0 && !MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 16)) && !func_108()))
				{
...
void func_102(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_2528542.f_1723, 21))
		{
			MISC::SET_BIT(&(Global_2528542.f_1723), 21);
		}
	}
	else if (MISC::IS_BIT_SET(Global_2528542.f_1723, 21))
	{
		MISC::CLEAR_BIT(&(Global_2528542.f_1723), 21);
	}
}
...
int func_109()
{
	...
	iVar0 = Local_97.f_5.f_38[PLAYER::PLAYER_ID()];
	iVar1 = func_11(iVar0);
	if (MISC::IS_BIT_SET(Global_2423876.f_65, iVar1))
	{
		return 1;
	}
	if (iVar0 > -1)
...
void func_110(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_1, 1) && !MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 8))
	{
		if (iVar0 > -1)
		{
			if (MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 6))
			{
				MISC::CLEAR_BIT(&(Global_1589819[iVar1 /*818*/].f_146), 6);
			}
			if (!func_141(iVar0, 1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_1), 0);
	...
	else
	{
		if (*uParam0 < 3)
		{
			if (!MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 6))
			{
				MISC::SET_BIT(&(Global_1589819[iVar1 /*818*/].f_146), 6);
			}
		}
		else if (MISC::IS_BIT_SET(Global_1589819[iVar1 /*818*/].f_146, 6))
		{
			MISC::CLEAR_BIT(&(Global_1589819[iVar1 /*818*/].f_146), 6);
		}
		if (iVar0 > -1)
...
{
	return HUD::DOES_BLIP_EXIST(Global_2416063[iParam0]);
}
...
void func_126(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 7))
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 7);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 7))
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 7);
	}
}
...
int func_141(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 4))
		{
			return 0;
		}
	}
	if (MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 8))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 5))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 12))
	{
		return 0;
	}
	return 1;
		...
		case 0:
			...
			else if (func_19(&(uParam0->f_14), 7000, 0))
			{
				if (func_162())
				{
					...
					else if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 16))
					{
						func_140("FM_IHELP_LCP", 0);
						MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 16);
		...
		case 1:
			...
			else if (func_162())
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
				{
					...
					if ((!func_20(&uLocal_364) || func_19(&uLocal_364, 20000, 0)) || MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 16))
					{
						if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 16))
						{
							MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 16);
...
char* func_158(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2572505[iParam0 /*3*/][func_51(iParam1)];
...
struct<6> func_159()
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1663123.f_10)))
	{
		iVar2 = func_144(8474, -1, 0);
		if (iVar2 == 0)
		{
			StringCopy(&Var0, ".", 24);
		}
			...
			if (!MISC::IS_BIT_SET(iLocal_197, 3))
			{
				if (!MISC::IS_BIT_SET(iLocal_197, 5) || (MISC::IS_BIT_SET(iLocal_197, 5) && func_19(&uLocal_193, 60000, 0)))
				{
					if (func_268())
					{
						...
						{
							func_266(19, 3, 0);
							func_265(&uLocal_198, 1, 0, "Lamar", 0, 1);
						...
						else
						{
							...
							if (func_261(&uLocal_198, 19, "FM_1AU", "FM_HOLD", iVar0, 0))
							{
...
int func_166(int iParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, char* sParam5, char* sParam6, bool bParam7, int iParam8)
{
	...
	return func_167(&uVar0, iParam0, func_258(), sParam1, iVar1, 3, iParam8, sParam2, bParam3, iParam4, sParam5, sParam6, -1);
}
...
int func_167(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, bool bParam8, int iParam9, char* sParam10, char* sParam11, int iParam12)
{
	...
	iVar1 = func_257(sParam2, sParam3);
	iVar2 = 0;
...
int func_174(var uParam0, int iParam1, var uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, bool bParam9, int iParam10, char* sParam11, char* sParam12)
{
	struct<2> Var0;
	...
	if (iParam5 == 8)
	{
		return func_242(uParam0, sParam3, sParam4);
	}
	if (iParam5 == 4)
	{
		StringCopy(&Var0, "CELL_226", 16);
		return func_239(uParam0, iParam1, sParam3, sParam4, &Var0);
	}
	if (iParam5 == 1 || iParam5 == 7)
	{
		...
		return func_223(uParam0, iParam1, sParam3, sParam4, iParam7);
	}
	if (iParam5 == 5)
	{
		return func_222(iParam1, uParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 2)
	{
		return func_212(iParam1, uParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 3)
	{
		return func_211(iParam1, uParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 6)
	{
		return func_175(iParam1, uParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);
	}
	return 0;
}

int func_175(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, char* sParam7, char* sParam8)
{
	bool bVar0;
	
	func_210();
	bVar0 = true;
	if (func_177(iParam0, uParam1, sParam2, bVar0, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_176(120000);
		return 1;
	}
...
int func_177(int iParam0, var uParam1, char* sParam2, bool bParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar3 = 0;
	sVar4 = func_203(sParam5, bParam6, &iVar3);
	uVar5 = func_201(iParam7, &iVar3);
	iVar6 = 0;
	...
	{
		bVar12 = func_200(iParam0, sParam2, iVar10, sVar4, uVar5, sVar2, iVar3, iVar11, 1, iVar9, 0, bVar7, iVar8, 0, iVar6, sParam8, sParam9);
	}
	else
	{
...
int func_182(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_14726)
	{
		...
		{
			func_187(Global_14534, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_183(1);
			func_187(Global_14534, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_184(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_184(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_187(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_191()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_192(Global_4268043[iVar2 /*104*/].f_18, Global_4268043[Global_4269292 /*104*/].f_18))
		{
...
int func_192(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
void func_196()
{
	...
	{
		if (func_199(Global_106565.f_2357.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_198(PLAYER::PLAYER_PED_ID());
			if (func_197(iVar0) && (!func_186(14) || Global_105516))
			{
				if (Global_106565.f_2357.f_539.f_4321 != iVar0 && func_197(Global_106565.f_2357.f_539.f_4321))
				{
...
int func_200(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
...
char* func_203(char* sParam0, bool bParam1, int iParam2)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		return sLocal_18;
...
void func_208(int iParam0)
{
	...
	func_209(&(Global_1383710[iVar2 /*5*/]));
...
int func_211(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, char* sParam7, char* sParam8)
{
	bool bVar0;
	
	func_210();
	bVar0 = false;
	return func_177(iParam0, uParam1, sParam2, bVar0, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

int func_212(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, char* sParam7, char* sParam8)
{
	bool bVar0;
	
	bVar0 = false;
	return func_213(iParam0, uParam1, sParam2, bVar0, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

int func_213(int iParam0, var uParam1, char* sParam2, bool bParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	if (!iVar3 == 0 || !MISC::IS_STRING_NULL_OR_EMPTY(sVar2))
	{
		bVar12 = func_221(iParam0, sParam2, iVar10, sVar4, uVar5, sVar2, iVar3, iVar11, 1, iVar9, 0, bVar7, iVar8, 0, iVar6, sParam8, sParam9);
	}
	else
	{
		bVar12 = func_215(iParam0, sParam2, iVar10, iVar11, 1, iVar9, 0, bVar7, iVar8, 0);
	}
	if (!bVar12)
	{
		return 0;
...
int func_215(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_216(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (bParam7 == 1)
		{
			Global_3130 = iParam6;
...
int func_216(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_218()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_219(Global_106565.f_14135[iVar2 /*104*/].f_18, Global_106565.f_14135[Global_16933 /*104*/].f_18))
		{
			Global_16933 = iVar2;
		}
		iVar2++;
...
int func_219(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_221(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
	...
	MISC::CLEAR_BIT(&Global_2423, 10);
	iVar0 = 3;
	if (func_216(iParam0, sParam1, iParam2, iParam6, sParam3, sParam5, uParam4, iParam7, iParam8, iParam9, bParam11, iParam12, iParam13, iParam14, sParam15, sParam16, iVar0) == 1)
	{
		if (bParam11 == 1)
		{
			Global_3130 = iParam10;
...
int func_222(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, char* sParam7, char* sParam8)
{
	bool bVar0;
	...
	func_214();
	bVar0 = true;
	if (func_213(iParam0, uParam1, sParam2, bVar0, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_176(120000);
		return 1;
	}
...
int func_223(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
	...
	{
		bVar0 = func_229(uParam0, iParam1, sParam2, sParam3, iVar1, 0, 0, 1);
	}
	if (bVar0)
	{
...
int func_229(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	Global_15920 = 0;
	Global_2621441 = 0;
	return func_230(sParam3, iParam4, bParam7);
}
...
int func_239(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	}
	...
	if (func_241(uParam0, iParam1, sParam2, sParam3, 9, sParam4, 0, 0, 1))
	{
		func_240();
		func_226();
		func_179();
...
bool func_241(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	...
	Global_2621441 = 0;
	return func_230(sParam3, iParam4, bParam8);
}

int func_242(var uParam0, char* sParam1, char* sParam2)
{
	if (func_244(uParam0, sParam1, sParam2, 12, 0, 0, 0))
	{
		func_243();
		func_179();
		func_225();
...
int func_256(int iParam0, int iParam1, int iParam2)
{
	...
	return func_248(iParam0, iParam1, iParam2);
}

int func_257(char* sParam0, char* sParam1)
{
	char cVar0[64];
...
void func_259(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 28);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 28);
	}
}
...
int func_261(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
	char* sVar0;
	bool bVar1;
	int iVar2;
...
int func_268()
{
	...
	if (func_269(PLAYER::PLAYER_ID(), 0))
	{
		return 0;
	}
	return 1;
...
bool func_270()
{
	return Global_2449538.f_2846.f_41;
}
...
{
	return MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 28);
}
...
void func_276(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 3))
		{
			MISC::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 3);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146, 3))
	{
		MISC::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_146), 3);
	}
}
...
void func_277(var uParam0)
{
	...
	{
		func_278("FM_HTUT_WAT");
	}
	if (func_127("FM_HTUT_HLD"))
	{
		func_278("FM_HTUT_HLD");
	}
	if (func_127("FM_HTUT_HLS"))
	{
		func_278("FM_HTUT_HLS");
	}
	if (HUD::DOES_BLIP_EXIST(uParam0->f_4))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_4));
...
void func_301(struct<21> Param0)
{
	func_305(func_306(Param0), Param0);
	func_303(0, -1, 0);
	...
	MISC::CLEAR_BIT(&Global_1648421, 1);
	MISC::CLEAR_BIT(&Global_1648421, 15);
	MISC::CLEAR_BIT(&Global_1648421, 14);
	func_24(8, 1);
	if (!func_273(PLAYER::PLAYER_ID()))
	{
		func_259(1);
...
void func_305(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_288();
