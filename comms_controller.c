...
void __EntryFunction__()
{
	...
	Global_36976 = MISC::GET_GAME_TIMER() + 20000;
	iVar0 = 0;
				...
				if (iLocal_90 == 1)
				{
					if (func_135(0))
					{
						if (func_134())
						{
							...
							if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 3))
							{
								if (func_129())
								{
									iLocal_90 = 2;
...
void func_11(int iParam0)
{
	...
	while (iVar1 < Global_106565.f_7682.f_198)
	{
		...
		{
			func_12(Global_106565.f_7682.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_23(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_26()
{
	...
	func_32(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_31(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_30(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_29(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_28(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_27(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_38(char* sParam0, int iParam1)
{
	...
	{
		if (func_37(sParam0) && !HUD::IS_HELP_MESSAGE_FADING_OUT())
		{
			HUD::CLEAR_HELP(0);
		}
	}
...
void func_65(int iParam0)
{
	...
	if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 3))
	{
		...
		if (iVar0 != -1)
		{
			if (func_66(PLAYER::PLAYER_PED_ID(), iVar0, (Global_36426[iVar0 /*5*/].f_3 * 0.35f)))
			{
				func_139(&iParam0, 0);
				func_123(0);
				iLocal_90 = 0;
...
void func_67()
{
	...
	if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 1))
	{
		if (!func_48(26))
		{
			if (func_75())
...
{
	iParam0->f_1 = (func_69(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_75()
{
	if (MISC::IS_BIT_SET(Global_2424, 23))
	{
		if (Global_15919 == 1)
		{
			return 1;
...
int func_81()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89546[iVar0]))
		{
			return 0;
		}
	}
...
int func_84()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_91190[2]))
	{
		return 0;
	}
	return 1;
...
int func_85()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_91190[1]))
	{
		return 0;
	}
	return 1;
...
int func_86()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_91190[0]))
	{
		return 0;
	}
	return 1;
...
float func_88(var uParam0)
{
	if (func_90(uParam0))
	{
		...
		{
			return (func_69(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
bool func_95()
{
	return MISC::IS_BIT_SET(Global_106565.f_18568[26 /*6*/], 3);
}
...
int func_97()
{
	...
	if (Global_88714 == -1)
	{
		Global_88714 = MISC::GET_GAME_TIMER();
	}
	if ((MISC::GET_GAME_TIMER() - Global_88714) > 240000)
	{
		Global_88714 = -1;
		return 1;
	}
...
int func_108()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (SYSTEM::VDIST2(func_98(181, 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 40000f)
		{
			return 1;
		}
	}
	...
	if ((MISC::GET_GAME_TIMER() - Global_88714) > 30000)
	{
		Global_88714 = -1;
		return 1;
	}
...
void func_118(int iParam0)
{
	...
	if (Global_36972 != -1)
	{
		if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 1) && !Global_106565.f_7682.f_913)
		{
			func_139(iParam0, 0);
		}
		else
		{
			...
			if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 15))
			{
				switch (func_58())
				{
					case 0:
				...
				MISC::CLEAR_BIT(&(Global_106565.f_7682[Global_36972 /*15*/].f_1), 15);
			}
			if (func_48(3))
			{
				if (!func_47(1))
...
void func_139(int iParam0, int iParam1)
{
	...
	if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 1))
	{
		if (!Global_106565.f_7682.f_913)
		{
			MISC::SET_BIT(&(Global_106565.f_7682[Global_36972 /*15*/].f_1), 10);
	...
	if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 10) || iParam1)
	{
		...
		if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 8))
		{
			func_143(&(Global_106565.f_7682[Global_36972 /*15*/]));
		}
	}
	else if (MISC::IS_BIT_SET(Global_106565.f_7682[Global_36972 /*15*/].f_1, 11))
	{
...
void func_170(int iParam0)
{
	...
	while (iVar0 < Global_106565.f_7682.f_866 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_36976 || MISC::IS_BIT_SET(Global_106565.f_7682.f_765[iVar0 /*10*/].f_1, 21)) || iVar1)
		{
...
int func_172(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(uParam0->f_2, func_186()) || bVar2)
	{
		iVar1 = 0;
		while (iVar1 < 3)
		{
...
void func_177(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_182(Global_37597[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_182(Global_37597[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
int func_188(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (MISC::IS_BIT_SET(iParam0, func_186()) && !MISC::IS_BIT_SET(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!MISC::IS_BIT_SET(iParam0, func_186()))
		{
			return 0;
		}
	}
	...
	if (func_9(iVar4))
	{
		...
		switch (iParam1)
		{
			...
			default:
				if (func_9(iParam1))
				{
					iVar6[0] = func_61(iParam1);
				}
				else
				{
					iVar6[0] = func_189(iParam1);
				}
				iVar6[1] = 0;
				break;
		}
...
void func_206(var uParam0)
{
	...
	switch (iLocal_83)
	{
		case 0:
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (func_229(48))
				{
					...
					{
						if ((((!ENTITY::DOES_ENTITY_EXIST(func_223(60)) && !ENTITY::DOES_ENTITY_EXIST(func_223(61))) && Global_71586 == -1) && !func_222()) && !func_221())
						{
							if (func_58() == 0)
							{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > Global_36976)
			{
				iLocal_83++;
			}
			break;
...
bool func_214(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_230(var uParam0)
{
	...
	while (iVar0 < Global_106565.f_7682.f_650)
	{
		...
		if (func_9(iVar1))
		{
			if (MISC::IS_BIT_SET(Global_106565.f_7682.f_199[iVar0 /*15*/].f_2, iVar1))
			{
					...
					if (*uParam0 >= Global_36977[Global_106565.f_7682.f_199[iVar0 /*15*/].f_6])
					{
						...
						if (!bVar2)
						{
							...
							if (iVar3 < 9)
							{
								...
								while (iVar4 < 3)
								{
									if (MISC::IS_BIT_SET(Global_106565.f_7682[iVar3 /*15*/].f_2, iVar4))
									{
										func_8(iVar4);
									}
									iVar4++;
...
{
	if (MISC::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		switch (func_58())
		{
			case 0:
				func_161(&Global_36807, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				break;
			
			case 1:
				func_161(&Global_36807, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				break;
			
			case 2:
				func_161(&Global_36807, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				break;
		}
	}
	switch (uParam0->f_6)
		...
		if (func_229(Global_106565.f_7682.f_137[iVar0 /*15*/].f_6))
		{
			if (*uParam0 >= Global_36977[Global_106565.f_7682.f_137[iVar0 /*15*/].f_6])
			{
				...
				if (iVar1 == -1)
				{
					...
					while (iVar2 < 3)
					{
						if (MISC::IS_BIT_SET(Global_106565.f_7682.f_137[iVar0 /*15*/].f_2, iVar2))
						{
							func_8(iVar2);
						}
						iVar2++;
	...
	if (func_9(func_58()))
	{
		if (MISC::IS_BIT_SET(uParam0->f_2, func_186()))
		{
			...
			if (func_64(*uParam0) == 1)
			{
				...
				func_242(uParam0->f_12, &cVar1);
				func_242(uParam0->f_13, &cVar2);
				if (func_241(&Global_36807, uParam0->f_6, &Var0, &(Var0.f_4), 12, &(Var0.f_8), &cVar1, &cVar2, 1, 0, 0, 0))
				{
			...
			else
			{
				...
				if (func_232(&Global_36807, uParam0->f_6, &Var3, &cVar4, 12, 1, 0, 0, 0))
				{
					if (MISC::IS_BIT_SET(uParam0->f_1, 13))
					{
						*uParam1 = 1;
...
void func_246(int iParam0)
{
	...
	while (iVar0 < Global_106565.f_7682.f_764 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_36976 || MISC::IS_BIT_SET(Global_106565.f_7682.f_651[iVar0 /*14*/].f_1, 21)) || iVar1)
		{
...
int func_249(var uParam0)
{
	...
	if (uParam0->f_10 != -1)
	{
		func_263(uParam0->f_10, &cVar4);
		StringConCat(&Var3, &cVar4, 16);
		if (uParam0->f_11 != -1)
		{
			func_263(uParam0->f_11, &cVar5);
	...
	if (MISC::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		if (func_262(uParam0->f_6, &Var3, iVar1, iVar0, 0, iVar2, 0, 1, 0, uParam0->f_13))
		{
			if (!MISC::IS_BIT_SET(uParam0->f_1, 18))
			{
				...
				while (iVar6 < 3)
				{
					if (MISC::IS_BIT_SET(uParam0->f_2, iVar6) && iVar6 != func_186())
					{
						switch (iVar6)
						{
							case 0:
						...
						if (func_250(uParam0->f_6, iVar7, &Var3, iVar1, 0, 0, iVar2, 0, 0, 0, uParam0->f_13))
						{
						}
					}
					iVar6++;
		...
		if (uParam0->f_12 >= 2 || MISC::IS_BIT_SET(uParam0->f_1, 19))
		{
			...
			while (iVar8 < 3)
			{
				if (MISC::IS_BIT_SET(uParam0->f_2, iVar8))
				{
					...
					if (func_250(uParam0->f_6, iVar10, &Var3, iVar1, iVar0, 0, iVar2, 0, 0, 0, uParam0->f_13))
					{
						bVar9 = true;
					}
				}
...
int func_251(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14726)
	{
		if (Global_14553.f_1 == 6)
		{
			...
			func_252(1);
			func_255(Global_14534, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_253(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_267(int iParam0)
{
	...
	while (iVar0 < Global_106565.f_7682.f_136 && !iLocal_78)
	{
		...
		if (MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_1, 0))
		{
			iVar1 = 0;
			...
			if ((*iParam0 >= Global_36976 || MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_1, 21)) || iVar1)
			{
				if (Global_106565.f_7682[iVar0 /*15*/].f_3 == Global_106565.f_7682.f_919[func_58()] || !MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_2, func_186()))
				{
...
int func_268(var uParam0, var uParam1)
{
	...
	if (MISC::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		...
		if (func_64(*uParam0) == 1)
		{
			...
			func_242(uParam0->f_12, &cVar3);
			func_242(uParam0->f_13, &cVar4);
			if (MISC::IS_BIT_SET(uParam0->f_1, 12))
			{
				if (func_272(&Global_36807, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar3, &cVar4, 0, 0, 1))
				{
			...
			else if (func_271(&Global_36807, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar3, &cVar4, 0, 0, 1))
			{
				if (uParam0->f_3 == 5 || MISC::IS_BIT_SET(uParam0->f_1, 12))
				{
					func_133(1);
		...
		{
			func_78(*uParam0, &Var5);
			if (MISC::IS_BIT_SET(uParam0->f_1, 9))
			{
				if (func_270(&Global_36807, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
				{
					if (uParam0->f_3 == 5 || MISC::IS_BIT_SET(uParam0->f_1, 12))
					{
						func_133(1);
			...
			{
				if (func_232(&Global_36807, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 1, 0, 0, 0))
				{
					if (uParam0->f_3 == 5 || MISC::IS_BIT_SET(uParam0->f_1, 12))
					{
						func_133(1);
			...
			{
				if (func_269(&Global_36807, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
				{
					func_133(1);
					if (MISC::IS_BIT_SET(uParam0->f_1, 13))
					{
			...
			else if (func_270(&Global_36807, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
			{
				if (MISC::IS_BIT_SET(uParam0->f_1, 12))
				{
					func_133(1);
...
void func_274(int iParam0)
{
	...
	while (iVar0 < Global_106565.f_7682.f_136 && !iLocal_78)
	{
		...
		if (!MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_1, 0))
		{
			...
			if ((*iParam0 >= Global_36976 || iVar1) || MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_1, 21))
			{
				if (Global_106565.f_7682[iVar0 /*15*/].f_3 == Global_106565.f_7682.f_919[func_58()] || !MISC::IS_BIT_SET(Global_106565.f_7682[iVar0 /*15*/].f_2, func_186()))
				{
