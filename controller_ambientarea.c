		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_26101[iVar0 /*7*/])))
			{
				if (func_12(iVar0, vVar2))
				{
					...
					{
						if (SCRIPT::IS_THREAD_ACTIVE(Global_26101[iVar0 /*7*/].f_5))
						{
							PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(Global_26101[iVar0 /*7*/].f_5, 1);
						}
...
void func_1(int iParam0)
{
	...
	if (HUD::GET_LENGTH_OF_LITERAL_STRING(sVar0) != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(iVar1) == 0)
		{
			...
			Global_26101[iParam0 /*7*/].f_5 = SYSTEM::START_NEW_SCRIPT(sVar0, iVar2);
...
{
	vParam1.z = 0f;
	if (!SCRIPT::IS_THREAD_ACTIVE(Global_26101[iParam0 /*7*/].f_5))
	{
		return 1;
	}
	...
	if (SYSTEM::VDIST2(Global_26101[iParam0 /*7*/].f_2, vParam1) > (Global_26101[iParam0 /*7*/].f_1 + 400f))
	{
		return 1;
	}
	return 0;
