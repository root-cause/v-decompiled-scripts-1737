...
{
	if (func_13(&uLocal_232, "GNRCAUD", func_30(iParam0), 8, 0, 0, 0))
	{
		iLocal_219 = -1;
	}
}
...
void func_31()
{
	...
	{
		if (!func_36(&uLocal_230))
		{
			func_35(&uLocal_230, 0, 0);
		}
		else if (func_34(&uLocal_230, iLocal_218, 0))
		{
...
void func_37()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_RETURN_VALUE_READY(uLocal_398) && GRAPHICS::IS_SCALEFORM_MOVIE_RETURN_VALUE_READY(uLocal_399))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_398);
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_399);
			switch (iVar0)
			{
				case 102:
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "SHOW_OVERLAY");
	func_44(sParam0);
...
bool func_47(int iParam0)
{
	...
	return MISC::IS_BIT_SET(func_48(5463, -1, 0), iParam0);
}
		...
		if (iVar1 != -1)
		{
			...
			switch (iParam2)
			{
				...
				case 2:
					...
					Global_2449538.f_6351 = { func_145(PLAYER::PLAYER_ID()) };
					break;
			}
			...
			func_58(uParam0, 0, 0, 0f, 0f, 0f, &uVar2, 0f, 0f, 0f, 1, 0, &uVar2, &iVar3, iVar3, 0, 0, 1, 0, 0);
...
void func_58(var uParam0, int iParam1, int iParam2, vector3 vParam3, var uParam4, vector3 vParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	func_123(uParam0, iParam1, 1, iParam10, 1);
	...
	if (func_109(iParam1))
	{
		*uParam4 = { func_108(iParam1, iParam2) };
		vVar1 = { func_107(iParam1, iParam2) };
		fVar2 = func_106(iParam1, iParam2);
	}
	if (!func_105(*uParam4))
	{
		vVar0 = { *uParam4 };
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_105(vVar0))
		{
			if (func_121(PLAYER::PLAYER_ID(), 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_102()) && !ENTITY::IS_ENTITY_DEAD(func_102(), 0))
				{
					vVar0 = { ENTITY::GET_ENTITY_COORDS(func_102(), 1) };
					vVar1 = { 0f, 0f, ENTITY::GET_ENTITY_HEADING(func_102()) };
					if (func_101(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_682, 1, 0))
					{
			...
			if ((func_100(PLAYER::PLAYER_ID()) || func_98(PLAYER::PLAYER_ID())) && func_97())
			{
	...
	else if (func_96(Global_4456448.f_138474) || iParam14)
	{
	...
	else if (func_94(Global_4456448.f_138474) || iParam13)
	{
	...
	{
		func_90();
		func_89(&vVar3, 144, Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_25);
		if (!func_105(vVar3))
		{
			vVar0 = { vVar3 };
		}
		func_83(&vVar3, 144, Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_25);
		vVar1 = { vVar3 };
	}
	...
	if (func_120() && !bParam11)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				func_73(PLAYER::PLAYER_ID(), 0, 4, 0);
	...
	func_59(func_120(), ((iParam12 || iParam13) || iParam14));
}
...
void func_59(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_60())
			{
				func_73(PLAYER::PLAYER_ID(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_73(PLAYER::PLAYER_ID(), 0, 319492, 0);
			}
		}
		else
		{
			func_73(PLAYER::PLAYER_ID(), 0, 57348, 0);
		}
	}
}
...
int func_61()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_63(iVar0, 1) && !func_62(iVar0, 1))
		{
			return 1;
		}
	}
...
int func_65()
{
	if (func_121(PLAYER::PLAYER_ID(), 0))
	{
		if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_682 != func_67())
		{
			if (func_66(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_682, 0, 1))
			{
				if (func_101(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_682, 1, 0))
				{
					return 0;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_121(PLAYER::PLAYER_ID(), 0) && !func_78()))
				{
...
void func_84(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*uParam2 = { func_86(iParam1, iParam3) };
	...
	vVar1 = { func_85(vVar1, -Var0[0 /*6*/].f_3.f_2) };
	vVar1 = { func_85(vVar1, Var0[1 /*6*/].f_3.f_2) };
...
int func_89(var uParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		...
		case 42:
		case 43:
			func_84(iParam2, iParam1, &vVar0, -1, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 64:
		case 65:
			func_84(iParam2, iParam1, &vVar0, 61, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 84:
		case 85:
			func_84(iParam2, iParam1, &vVar0, 83, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 81:
		case 82:
			func_84(iParam2, iParam1, &vVar0, 77, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 75:
		case 76:
			func_84(iParam2, iParam1, &vVar0, 73, 0);
			*uParam0 = { vVar0 };
			return 1;
		...
		case 89:
		case 90:
			func_84(iParam2, iParam1, &vVar0, 88, 0);
			*uParam0 = { vVar0 };
			return 1;
			return 0;
	}
...
var func_102()
{
	if (ENTITY::DOES_ENTITY_EXIST(func_104()))
	{
		return func_104();
	}
	return func_103();
...
{
	if (!GRAPHICS::ANIMPOSTFX_IS_RUNNING(func_111(0)))
	{
		GRAPHICS::ANIMPOSTFX_PLAY(func_111(iParam0), 0, 1);
	}
}
...
char* func_111(int iParam0)
{
	...
	if (func_112(Global_4456448.f_161209) && MISC::IS_BIT_SET(Global_4456448.f_162445.f_2808, 2))
	{
...
void func_126(int iParam0)
{
	...
	if (func_128() == 0 || HUD::IS_PAUSE_MENU_ACTIVE())
	{
		func_127(1);
...
void func_130(int iParam0)
{
	...
	if ((func_128() == 1 || HUD::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_127(0);
...
void func_158()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_43(0);
...
void func_159()
{
	if (func_160())
	{
		if (!MISC::IS_BIT_SET(iLocal_216, 0))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "GET_CURRENT_SELECTION");
			uLocal_398 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "GET_CURRENT_SCREEN_ID");
			uLocal_399 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_161()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	PAD::ENABLE_CONTROL_ACTION(2, 189, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_397, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (PAD::_IS_INPUT_JUST_DISABLED(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "SET_ANALOG_STICK_INPUT");
			iLocal_400 = iVar0;
			iLocal_401 = iVar1;
...
void func_163()
{
	...
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_397, 255, 255, 255, 255, 0);
	func_171();
	func_166(0);
	func_164(1);
}
...
int func_179(int iParam0)
{
	if (iParam0 != func_67())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER::PLAYER_ID()) && func_66(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
{
	func_177();
	uLocal_397 = GRAPHICS::_REQUEST_SCALEFORM_MOVIE_2("COVERT_OPS");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_397))
	{
		SYSTEM::WAIT(0);
	}
	...
	func_226(1);
	func_73(PLAYER::PLAYER_ID(), 0, 0, 0);
...
void func_184()
{
	...
	{
		func_186(1);
		func_185(&uLocal_232, 2, 0, "AGENT14", 0, 1);
	}
}
...
void func_187()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "SET_PLAYER_DATA");
...
void func_188(int iParam0)
{
	...
	sVar4 = func_223(&(Global_68863[func_41(iParam0) /*6*/]));
	fVar5 = 0f;
	fVar6 = 0f;
	if (bVar3)
	{
	...
	if (iVar1 != -1)
	{
		if (!func_220())
		{
			...
			{
				if (!func_36(&uLocal_228))
				{
					func_35(&uLocal_228, 0, 0);
				}
				else if (func_34(&uLocal_228, 750, 0))
				{
					iVar1 = -1;
				}
				else
			...
			if (iVar1 != -1)
			{
				func_189(&fVar5, &fVar6, 0, 9, 0, 0, MISC::GET_HASH_KEY(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_397, "ADD_MISSION");
...
void func_189(float fParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_194(iParam2, iParam3, 0, iParam4, iParam5);
	iVar1 = func_193(iParam6);
...
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_397);
	func_226(iParam1);
	func_228(0);
	func_231();
	...
	if (bParam0)
	{
		func_73(PLAYER::PLAYER_ID(), 1, 0, 0);
	}
