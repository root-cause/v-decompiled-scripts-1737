...
void func_14(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < 3)
	{
		...
		iVar2 = 0;
		iVar3 = 0;
		iVar2 = MISC::_0xF2D49816A804D134(0, *uParam2);
		(*uParam1)[iVar0] = iVar2;
	...
	if (func_8(iParam0, uParam3))
	{
		...
		{
			iVar2 = MISC::_0xF2D49816A804D134(0, 12);
			uParam1->f_8 = iVar2;
		}
	}
}
...
int func_64(int iParam0)
{
	...
	if (Local_47[iLocal_100 /*21*/].f_17 == 8)
	{
		...
		else
		{
			...
			WEAPON::_ADD_PED_AMMO(PLAYER::PLAYER_PED_ID(), uVar0, uVar1);
		}
	}
...
void func_212(bool bParam0)
{
	...
	if (Global_262145.f_25805)
	{
		...
		STATS::_PLAYSTATS_CASINO_SLOTMACHINE_L(&Var0);
		func_4(&Local_83);
		Local_83.f_2 = 0;
		Local_83.f_3 = 0;
		Local_83.f_4 = 0;
