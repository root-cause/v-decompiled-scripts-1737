...
void __EntryFunction__()
{
	...
	if (func_514())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_100114.f_2890.f_12.f_66))
				{
					func_441(&iLocal_344, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_441(&iLocal_344, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				func_440(vLocal_339, fLocal_119, 1, 0);
				iLocal_61 = 2;
				func_429(1, 0);
				break;
			
			case 1:
				func_441(&iLocal_344, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_440(vLocal_336, 254.9762f, 0, 0);
				func_429(4, 0);
				break;
	...
	else if (func_428(0))
	{
		...
		{
			func_426(PLAYER::PLAYER_PED_ID(), vLocal_339, fLocal_119, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_337 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_415();
			func_414();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_340, fLocal_120, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_341, fLocal_121, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_426(Local_68.f_9, vLocal_336, 0f, 0, 0);
					if (!func_70())
					{
						func_426(PLAYER::PLAYER_PED_ID(), vLocal_336, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
int func_36()
{
	if (func_58(vLocal_337, Local_75.f_1, 210f))
	{
		if (!iLocal_113)
		{
		...
		{
			if (func_58(vLocal_337, Local_79.f_1, 150f))
			{
		...
		{
			if (func_58(vLocal_337, Local_80.f_1, 150f))
			{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (iLocal_62 == 4)
			{
				...
				if (func_100(&Local_75, &Local_77, &iLocal_141))
				{
					iLocal_105 = 1;
				}
			}
			...
			else
			{
				if (!iLocal_95)
				{
					...
					if (iLocal_62 == 4)
					{
						if (func_22(Local_75))
						{
							if (func_105(Local_75, vLocal_337, 35f))
							{
								func_90(&uLocal_157, 4, Local_75, "MAUDE", 0, 1);
								if (func_74(&uLocal_157, cLocal_151, &vLocal_323, 4, 0, 0, 0))
								{
									iLocal_95 = 1;
								}
							}
					...
					else if (func_74(&uLocal_157, cLocal_151, &vLocal_323, 4, 0, 0, 0))
					{
						iLocal_95 = 1;
					}
				}
		...
		while (iVar0 <= (iLocal_134 - 1))
		{
			if (iLocal_67 == 4)
			{
				if (func_22(Local_69[iVar0 /*20*/]))
				{
					...
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_69[iVar0 /*20*/], 0);
					if (Global_105274 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_69[iVar0 /*20*/], 0);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_69[iVar0 /*20*/], 1);
					}
				}
			}
			func_41(&(Local_69[iVar0 /*20*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_131 > 0)
...
void func_111(int iParam0)
{
	...
	{
		func_109(&(Local_69[iVar0 /*20*/].f_6));
		iVar0++;
	}
}
		...
		case 1:
			if (func_113(iLocal_138, 500))
			{
				if (!iLocal_96)
				{
					...
					if (func_74(&uLocal_157, cLocal_151, "BBC_PK1", 4, 0, 0, 0))
					{
						iLocal_96 = 1;
					}
				}
...
{
	if (func_22(Local_69[iParam0 /*20*/]))
	{
		...
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iParam0 /*20*/], 1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iParam0 /*20*/], 3, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iParam0 /*20*/], 5, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iParam0 /*20*/], 0, 1);
		...
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_69[iParam0 /*20*/], 1), 45f, 0, 0);
		}
		else
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_69[iParam0 /*20*/], 1), 35f, 0, 0);
		}
		...
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_69[iParam0 /*20*/], 0);
...
void func_308()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		func_376(Local_68.f_9, &iLocal_135, 1126825984, 7);
		...
		switch (iLocal_60)
		{
			case 0:
				...
				vLocal_342 = { ENTITY::GET_ENTITY_COORDS(Local_68.f_9, 0) };
				func_355(&vLocal_343, vLocal_342);
				...
				func_352(&(Local_68.f_8), "", "", &iLocal_127, iLocal_128, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else if (func_113(iLocal_136, 8000))
						{
							bVar0 = true;
						}
						if (func_320(Local_68.f_9, vLocal_337, bVar0, 0, 1, iLocal_139))
						{
							if ((func_113(iLocal_137, 5000) || func_167(vLocal_343, 0f, 0f, 0f, 0)) || (!func_58(vVar1, vLocal_343, 8.5f) && !func_58(vVar1, vLocal_342, 8.5f)))
							{
								func_319();
						...
						else
						{
							if (!iLocal_81)
							{
								if (!func_113(iLocal_124, 2500))
								{
									if (!func_61())
									{
										if (func_105(Local_68.f_9, vLocal_337, 30f))
										{
											if (func_74(&uLocal_157, cLocal_150, "BB2_J7", 4, 0, 0, 0))
											{
												iLocal_124 = MISC::GET_GAME_TIMER();
												iLocal_81 = 1;
											}
							...
							{
								if (func_113(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_337, 30f))
									{
										if (PED::IS_PED_FLEEING(Local_68.f_9))
										{
											...
											{
												if (func_74(&uLocal_157, cLocal_151, "BBC_T13", 4, 0, 0, 0))
												{
													iLocal_124 = MISC::GET_GAME_TIMER();
												}
											}
											else if (func_74(&uLocal_157, cLocal_150, "BB2_FLEE", 4, 0, 0, 0))
											{
												iLocal_124 = MISC::GET_GAME_TIMER();
											}
										}
							...
							func_316(Local_68.f_9, vLocal_337, iLocal_137, 925353388);
						}
					}
					else
					{
				...
				{
					func_319();
					if (!func_105(Local_68.f_9, vLocal_337, 10f))
					{
						if (!iLocal_98)
						{
							if (!func_314(sLocal_148, 1))
							{
								func_312(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_98 = 1;
							}
						}
						else
						{
							func_352(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, iLocal_128, 1);
						}
					}
					else
					{
						if (!iLocal_82)
						{
							if (!PED::IS_PED_RAGDOLL(Local_68.f_9) && !PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
							{
								...
								if (func_74(&uLocal_157, cLocal_150, sLocal_148, 4, 0, 0, 0))
								{
									iLocal_82 = 1;
								}
							}
...
void func_356()
{
	...
	if (func_22(Local_68.f_9))
	{
		if (iLocal_70 == 0)
		{
			func_367(&(Local_68.f_9), &bLocal_116);
			if (func_366())
			{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_105(Local_68.f_9, vLocal_337, 20f))
					{
				...
				case 6:
					if (!func_105(Local_68.f_9, vLocal_337, 3.5f))
					{
				...
				case 29:
					if (func_113(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 14, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 28, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 37, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 43, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 45, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 50, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 51, 0);
				...
				case 13:
					if (func_113(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_68.f_9, vLocal_337);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
						...
						TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
				...
				case 14:
					if (!func_63(Local_68.f_9, 1805844857) && !PED::IS_PED_FLEEING(Local_68.f_9))
					{
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_68.f_10 = 13;
					}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_358())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, 0))
								{
									...
									if (fVar3 < 1.75f && func_105(Local_68.f_9, vLocal_337, 8f))
									{
				...
				case 23:
					if (func_361(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_357(Local_68.f_19, 10) && func_105(Local_68.f_9, vLocal_337, 50f)) || !func_113(iLocal_142, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 1))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
					...
					if (func_361(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						if (!func_63(Local_68.f_9, -1519143300))
						{
							if (!func_63(Local_68.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									if (!func_357(Local_68.f_19, 10) && func_105(Local_68.f_9, vLocal_337, 50f))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 23;
									}
							...
							else if (!func_357(Local_68.f_19, 10) && func_105(Local_68.f_9, vLocal_337, 50f))
							{
...
int func_361(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_22(iParam0))
	{
		...
		if (func_105(iParam0, vLocal_337, fParam2))
		{
...
void func_377()
{
	if (func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_336, 100f))
	{
		if (!func_378())
		{
	...
	{
		if (!func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_336, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					func_110(&(Local_68.f_8));
					if (!func_105(Local_68.f_9, vLocal_337, 25f))
					{
						...
						if (func_357(iLocal_135, 10))
						{
							if (!func_61())
							{
								if (func_74(&uLocal_157, cLocal_151, "BBC_T9", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
					...
					else if (!iLocal_83)
					{
						if (!func_314(sLocal_148, 1))
						{
							if (func_74(&uLocal_157, cLocal_151, "BBC_T5", 4, 0, 0, 0))
							{
								iLocal_83 = 1;
							}
						}
				...
				else if (func_105(Local_68.f_9, vLocal_337, 8f))
				{
					...
					if (!func_61())
					{
						if (Local_68.f_10 == 21 || Local_68.f_10 == 22)
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
							{
								if (func_74(&uLocal_157, cLocal_151, "BBC_T10", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
							else if (func_74(&uLocal_157, cLocal_150, "BB2_J5", 4, 0, 0, 0))
							{
								iLocal_124 = MISC::GET_GAME_TIMER();
							}
						}
...
void func_380()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		if (!iLocal_85)
		{
			if (func_74(&uLocal_157, cLocal_150, "BB2_J6", 4, 0, 0, 0))
			{
				iLocal_85 = 1;
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iVar0) < 0.5f)
						{
							if (!iLocal_94)
							{
								if (!func_61())
								{
									if (func_113(iLocal_140, 3500))
									{
										if (func_74(&uLocal_157, cLocal_150, "BB2_STOP", 4, 0, 0, 0))
										{
											iLocal_94 = 1;
										}
									}
				...
				{
					if (func_74(&uLocal_157, cLocal_150, "BB2_J9", 4, 0, 0, 0))
					{
						iLocal_84 = 1;
					}
				}
		...
		else
		{
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_89)
				{
					if (func_358())
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
						{
							...
							{
								if (func_74(&uLocal_157, cLocal_151, "BBC_T6", 4, iVar1, 0, 0))
								{
									iLocal_89 = 1;
								}
							}
					...
					else if (!func_314("BBC_T8", 1) && !func_314("BB2_WTF", 1))
					{
						if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
						{
							if (func_74(&uLocal_157, cLocal_151, "BBC_T8", 4, iVar1, 0, 0))
							{
								iLocal_89 = 1;
							}
						}
						else if (func_74(&uLocal_157, cLocal_150, "BB2_WTF", 4, iVar1, 0, 0))
						{
							iLocal_89 = 1;
						}
					}
				...
				else if (!iLocal_93)
				{
					if (func_381(&iVar0))
					{
						if ((!func_314("BB2_JACK", 1) && !func_314("BBC_T6", 1)) && !func_314("BBC_T8", 1))
						{
							if (func_74(&uLocal_157, cLocal_150, "BB2_JACK", 4, iVar1, 0, 0))
							{
								iLocal_93 = 1;
							}
						}
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
				{
					if (!iLocal_90)
					{
						if (!func_314("BBC_T7", 1) && !func_314("BB2_OUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
								if (func_74(&uLocal_157, cLocal_151, "BBC_T7", 4, iVar1, 0, 0))
								{
									iLocal_90 = 1;
								}
							}
							else if (func_74(&uLocal_157, cLocal_150, "BB2_OUT", 4, iVar1, 0, 0))
							{
								iLocal_90 = 1;
							}
						}
				...
				else if (Local_68.f_10 == 24 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_337, 25f))
					{
						if (!func_314("BB2_J10", 1))
						{
							if (func_113(iLocal_125, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
								}
								if (func_74(&uLocal_157, cLocal_150, "BB2_J10", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_337, 20f))
							{
								if (func_74(&uLocal_157, cLocal_150, "BB2_J4", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
...
void func_383(int iParam0)
{
	...
	{
		if (func_74(&uLocal_157, cLocal_150, sLocal_149[iParam0], 4, 0, 0, 0))
		{
			iLocal_86[iParam0] = 1;
			iLocal_108 = 0;
			iLocal_123 = 0;
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_117))
						{
							if (iLocal_97)
							{
								iLocal_117 = func_389(vLocal_336, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						{
							func_380();
							func_387(&Local_75, vLocal_337, &iLocal_126, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_336, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_336, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_336, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
				...
				else
				{
					...
					if (func_105(Local_68.f_9, vLocal_337, 8f))
					{
						if (Local_68.f_10 == 25 || Local_68.f_10 == 26)
						{
							Local_68.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_107)
				{
					bLocal_107 = func_385(vLocal_337, Local_63, 180f);
				}
				if (func_309(&(Local_68.f_9)))
				{
					iLocal_115 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_107)
					{
						bLocal_107 = func_385(vLocal_337, Local_63, 0f);
					}
					func_124(4);
				}
				break;
...
int func_385(vector3 vParam0, vector3 vParam1, float fParam2)
{
	int iVar0;
	
	if (!func_386(vParam0, vParam1, fParam2))
	{
		...
		if (iLocal_134 > 0)
		{
			...
			while (iVar0 <= (iLocal_134 - 1))
			{
				func_42(&(Local_69[iVar0 /*20*/]), 1, 0, 1);
				iVar0++;
			}
		}
		if (iLocal_131 > 0)
...
bool func_386(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
...
int func_387(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
		...
		if (!func_61())
		{
			...
			if (SYSTEM::VDIST2(vParam1, vVar0) < (fParam4 * fParam4))
			{
				if (MISC::GET_GAME_TIMER() - *iParam2) > (iParam3 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar2 = "BBCAUD";
					sVar3 = "BBC_loiter";
					func_388(&uVar1, cVar2, sVar3, 4, 0, 0);
				...
				if (!iLocal_109)
				{
					...
					if (!iLocal_81)
					{
						if (func_105(Local_68.f_9, vLocal_337, 30f))
						{
							if (!func_61())
							{
								if (func_74(&uLocal_157, cLocal_150, sLocal_147, 4, 0, 0, 0))
								{
									Local_68.f_17 = MISC::GET_GAME_TIMER();
									iLocal_124 = MISC::GET_GAME_TIMER();
									iLocal_81 = 1;
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else if (func_113(iLocal_136, 5000))
						{
							bVar0 = true;
						}
						if (func_320(Local_68.f_9, vLocal_337, bVar0, 0, 1, 170))
						{
							func_319();
							func_392(iLocal_134);
							Local_68.f_17 = MISC::GET_GAME_TIMER();
					...
					else if ((iLocal_129 > 0 && func_105(Local_68.f_9, vLocal_337, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_68.f_9) < 200)
					{
						Local_68.f_10 = 13;
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_136 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_113(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_105(Local_68.f_9, vLocal_337, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
								{
									if (func_74(&uLocal_157, cLocal_151, "BBC_T2", 4, 0, 0, 0))
									{
										iLocal_124 = MISC::GET_GAME_TIMER();
									}
								}
								else if (func_74(&uLocal_157, cLocal_150, "BB2_SHOOT", 4, 0, 0, 0))
								{
									iLocal_124 = MISC::GET_GAME_TIMER();
								}
							}
...
void func_393(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*20*/]))
		{
			func_368(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_17), 1126825984, 7);
			switch (Local_69[iVar0 /*20*/].f_14)
			{
				...
				case 1:
					...
					if (func_113(Local_69[iVar0 /*20*/].f_15, iVar2))
					{
						func_114(iVar0);
					}
					break;
				...
				case 2:
					func_394(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					break;
				
				case 3:
					if (!func_63(Local_69[iVar0 /*20*/], -2017877118))
					{
						func_114(iVar0);
					}
					break;
				...
				case 4:
					if (!func_63(Local_69[iVar0 /*20*/], 1805844857))
					{
						func_99(Local_69[iVar0 /*20*/], 1);
					}
					func_109(&(Local_69[iVar0 /*20*/].f_6));
...
void func_396()
{
	if (func_22(Local_68.f_9))
	{
		func_376(Local_68.f_9, &iLocal_135, 1126825984, 1);
		func_368(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_356();
		switch (iLocal_60)
		{
			case 0:
				...
				func_312(&(Local_68.f_8), "", "", &iLocal_127, &iLocal_128, 1, 0);
				iLocal_60 = 1;
				break;
				...
				switch (iLocal_61)
				{
					case 2:
						if (!iLocal_88)
						{
							...
							if (func_74(&uLocal_157, cLocal_151, "BBC_T14", 4, 0, 0, 0))
							{
								Local_68.f_17 = MISC::GET_GAME_TIMER();
								iLocal_88 = 1;
							}
						...
						else if (!iLocal_99)
						{
							...
							{
								func_312(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_99 = 1;
							}
						}
						else
						{
							func_352(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, iLocal_128, 1);
							if (func_105(Local_68.f_9, vLocal_337, 22f) && func_406(Local_68.f_9, vLocal_337, 10f))
							{
								...
								else if (func_404(Local_68.f_9, iLocal_135, 0, 1102053376, 1086324736))
								{
									iLocal_61 = 0;
								}
								else if (func_105(Local_68.f_9, vLocal_337, 5f))
								{
									iLocal_61 = 0;
								}
								else if (func_405(&(Local_68.f_19)))
								{
									if (func_105(Local_68.f_9, vLocal_337, (22f - 1.5f)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
										if (Local_68.f_10 != 3 && Local_68.f_10 != 4)
						...
						if (func_361(Local_68.f_9, Local_68.f_19, 22f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_60 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_91)
						{
							...
							if (func_74(&uLocal_157, cLocal_150, "BB2_J2", 4, 0, 0, 0))
							{
								Local_68.f_17 = MISC::GET_GAME_TIMER();
								iLocal_124 = MISC::GET_GAME_TIMER();
								iLocal_91 = 1;
						...
						{
							if (!func_314("BBC_T14", 1) && !func_314("BB2_J2", 1))
							{
								if (func_311("BBS_APHEND", 0, 0) || func_311("BBS_APHEND2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
								...
								if (func_74(&uLocal_157, cLocal_151, "BBC_T1", 4, 0, 0, 0))
								{
									Local_68.f_17 = MISC::GET_GAME_TIMER();
									iLocal_87 = 1;
								}
...
void func_400()
{
	if (!iLocal_92)
	{
		if (!func_61())
		{
			if (func_105(Local_68.f_9, vLocal_337, (22f + 5f)))
			{
				iLocal_118 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				{
					if (func_74(&uLocal_157, cLocal_150, "BB2_AMB", 1, iLocal_118, 0, 0))
					{
						iLocal_92 = 1;
					}
				}
				else if (func_402(&uLocal_157, cLocal_150, "BB2_AMB", &Local_335, 1, iLocal_118, 0))
				{
					iLocal_92 = 1;
					StringCopy(&Local_335, "", 24);
				}
	...
	else if (func_314("BB2_AMB", 0))
	{
		if (!func_105(Local_68.f_9, vLocal_337, (22f + 10f)))
		{
			Local_335 = { func_401() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_335))
			{
...
int func_402(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
	...
	if (func_403(uParam0, sParam1, sParam2, sParam3, iParam4, iParam5, iParam6))
	{
		return 1;
	}
	return 0;
...
int func_404(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_427(iParam0))
	{
		if (!func_357(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_105(Local_68.f_9, vLocal_337, fParam3))
				{
					return 0;
				}
				if (!func_406(iParam0, vLocal_337, fParam4))
				{
					return 0;
				}
			}
		...
		if (func_411(26, func_413(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_61() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					if (func_75(uParam1, func_410(uParam0->f_4), func_409(uParam0->f_4), 4, 0, 0, 0))
					{
						uParam0->f_7 = 1;
					}
				}
...
void func_416()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_9, 0) && !PED::IS_PED_INJURED(Local_68.f_9))
		{
			...
			{
				if (!func_105(Local_68.f_9, vLocal_337, 150f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
			...
			{
				if (!func_105(Local_68.f_9, vLocal_337, 80f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
...
void func_431(bool bParam0, bool bParam1)
{
	...
	if (iLocal_58 > 2)
	{
		func_391(0, &uLocal_144);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_143, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_107(&uLocal_157, 2);
	func_107(&uLocal_157, 3);
	func_107(&uLocal_157, 4);
	func_317(&uLocal_44, 0, 0);
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_477(iParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_477(iParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_447(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_446(*iParam1);
				...
				func_444(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106565.f_20112[iParam0 /*43*/].f_1));
				...
				func_444(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106565.f_20112[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_448(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_452(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_453(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_469(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_470(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1 && Global_2424047[iParam0 /*416*/].f_309.f_8 != func_335())
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_471(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_449(Global_2424047[iParam0 /*416*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_484(int iParam0)
{
	...
	if (func_157(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_163(iParam0, 0)) && Global_71318.f_66 == 0) && Global_106565.f_32743.f_1958[Global_70409.f_555[0 /*21*/].f_14] != 0) && Global_106565.f_32743.f_1958[Global_70409.f_555[0 /*21*/].f_14] > 3) && (!func_485(0, Global_70409.f_555[0 /*21*/].f_12) || !func_485(1, Global_70409.f_555[0 /*21*/].f_12)))
			{
...
int func_485(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_486(&(Global_106565.f_32743.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
{
	return func_488(&(Global_100114.f_2890), vParam0, fParam1, 0);
}
...
int func_490(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_492(iParam0, uVar1[iVar3], 1) && func_491(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_509(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_511(Global_100114.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_515()
{
	...
	if (func_22(PLAYER::PLAYER_PED_ID()))
	{
		func_90(&uLocal_157, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(PLAYER::PLAYER_PED_ID(), 1);
	}
	if (func_22(Local_68.f_9))
	{
		func_90(&uLocal_157, 3, Local_68.f_9, sLocal_146, 0, 1);
...
void func_516()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK::SET_SEQUENCE_TO_REPEAT(uLocal_145, 1);
		TASK::CLOSE_SEQUENCE_TASK(uLocal_145);
		TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
		TASK::CLEAR_SEQUENCE_TASK(&uLocal_145);
	}
	...
	while (iVar0 <= 5)
	{
		if (func_22(Local_69[iVar0 /*20*/]))
		{
			...
			func_517(Local_69[iVar0 /*20*/], "BACKUP_", iVar0);
			if (func_95(Local_71[0 /*6*/]))
			{
				if (iVar0 == 1)
				{
					PED::SET_PED_INTO_VEHICLE(Local_69[iVar0 /*20*/], Local_71[0 /*6*/], -1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iVar0 /*20*/], 1, 0);
				}
				else if (iVar0 == 2)
				{
			...
			if (iVar0 == 0)
			{
				...
				TASK::SET_SEQUENCE_TO_REPEAT(uLocal_145, 1);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_145);
				TASK::TASK_PERFORM_SEQUENCE(Local_69[iVar0 /*20*/], uLocal_145);
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_145);
				if (func_22(Local_69[iVar0 /*20*/]))
				{
					func_90(&uLocal_157, 4, Local_69[iVar0 /*20*/], "HILLBILLY", 0, 1);
...
int func_518()
{
	...
	if (iLocal_134 > 0)
	{
		...
		{
			if (func_53(&(Local_69[iVar2 /*20*/]), Local_69[iVar2 /*20*/].f_19, Local_69[iVar2 /*20*/].f_1, Local_69[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				if (func_22(Local_69[iVar2 /*20*/]))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105612) || Global_25767) || func_544()) || func_88(8, -1)) || func_543()) || func_542()) || func_536()) || func_537()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_538()) || Global_25767) || func_544()) || func_88(8, -1)) || func_536()) || func_543()) || func_542()) || func_537()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105612) || Global_25767) || func_544()) || func_88(8, -1)) || func_536()) || func_543()) || func_542()) || func_537()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105612) || Global_25767) || func_544()) || func_88(8, -1)) || func_543()) || func_542()) || func_537()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_538() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_537()) || func_541()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_88(8, -1) || func_543()) || func_542()) || func_541()) || func_540())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_538()) || Global_25767) || func_544()) || func_88(8, -1)) || func_542()) || func_536()) || func_537()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_538()) || Global_105612) || Global_25767) || func_544()) || func_88(8, -1)) || func_536()) || func_541()) || func_543()) || func_542()) || func_537())
						{
							return 0;
						}
						break;
...
int func_556()
{
	...
	iVar0 = func_557(&(Global_93682.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_560()
{
	...
	{
		if (func_550(&(Global_93682.f_3)) > -1)
		{
			return 1;
		}
	}
