					...
					else
					{
						if (iLocal_42)
						{
							...
							while (iLocal_44 < 8)
							{
								...
								{
									if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_44 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_29(iLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									{
										if (!Global_25979[iLocal_37])
										{
											func_26(iLocal_37, Global_25979[iLocal_37]);
										}
									}
								}
								else if (!Global_25979[iLocal_37])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_40)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_37, 0, 0))
											{
...
int func_32(vector3 vParam0, int iParam1, int iParam2, bool bParam3)
{
	vector3 vVar0[15];
	vector3 vVar1[15];
	float fVar2[15];
