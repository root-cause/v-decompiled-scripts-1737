...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105652[Var0 /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_105652[Var0 /*10*/].f_9));
			}
		}
		func_268(&Var0, 1);
	}
	if (!func_265(&iVar2, &Var0, vVar1, 5f))
	{
		func_264();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_195(&Var0, vVar1, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_195(&Var0, vVar1, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_194(Var0);
		func_186(&iLocal_55, &(Var0.f_9), vVar1);
		if (func_171(&Var0, 0))
		{
			if (func_170(Var0))
			{
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_199(var uParam0, bool bParam1)
{
	...
	if ((func_236(*uParam0) || func_234(*uParam0)) || Global_71835 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_235() && Global_93682.f_11 == 6) && iParam0 == func_165(&(Global_93682.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_239(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_245(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_243(&(uParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_243(&(uParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_241(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_176(uParam0->f_35[0]))
				{
			...
			{
				func_241(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
			...
			{
				func_240(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_126(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			{
				func_240(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_126(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_205(iParam0);
...
void func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_242(iParam0);
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_244(iParam0);
...
int func_250(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_241(&(uParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_245(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_125(uParam0->f_28[0]))
			{
				...
				{
					func_240(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_126(uParam0->f_41[3]))
					{
...
int func_252(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_245(&(uParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_125(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_240(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_126(uParam0->f_41[0]))
					{
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(PLAYER::PLAYER_PED_ID()))
			{
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_245(&(uParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_241(&(uParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_176(uParam0->f_35[0]))
				{
...
void func_268(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_281("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
