...
void __EntryFunction__()
{
	...
	if (func_106(func_108(SCRIPT::GET_THIS_SCRIPT_NAME())))
	{
		func_109(0);
	}
	if (!func_104())
	...
	iLocal_209 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_208) && func_96(iLocal_208))
	{
	...
	while (iVar0 == 1)
	{
		if (!func_96(iLocal_208))
		{
			func_91(func_108(SCRIPT::GET_THIS_SCRIPT_NAME()));
			func_109(0);
		}
		...
		fVar12 = func_90(PLAYER::PLAYER_PED_ID(), iLocal_208);
		if (fVar12 < 10f && func_89())
		{
		...
		{
			if (!func_83() && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_103())
				{
				}
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_208) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_208)) && fVar12 < 25f) && func_82(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED")) && func_79(iLocal_208, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_83())
				{
					func_85();
		...
		if (func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
			if (!HUD::DOES_BLIP_EXIST(iLocal_214))
			{
				func_74(&iLocal_214, &iLocal_208, 0);
			}
		}
		...
		switch (iLocal_216)
		{
			...
			case 3:
				...
				if (func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < fVar9)
				{
					if (func_52() == 1)
					{
						iLocal_216 = 8;
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_46(Global_106510[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_55();
				bVar37 = func_56();
				func_45(Global_106510[iLocal_217]);
			...
			case 13:
				...
				func_43(&uLocal_37, 3, iLocal_208, &Local_205, 0, 1);
				func_42(&cVar2);
				if (func_32(&uLocal_37, &cLocal_227, &cVar2, 3, 0, 0, 0))
				{
					iLocal_216 = 14;
				}
				func_31();
			...
			case 10:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&Local_255))
				{
					...
					else if (func_32(&uLocal_37, &cLocal_227, &cVar3, 3, 0, 0, 0))
					{
						iVar35 = 1;
					}
					if (iVar35 == 1)
		...
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			if (iLocal_224 == -1)
			{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_72(MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_71(iVar19))
				{
					if (!func_70(iVar19))
					{
						func_61(MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), 0);
					}
				}
				func_2(&iLocal_224);
			}
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_109(1);
		}
		SYSTEM::WAIT(0);
...
{
	func_9();
	if (func_96(iLocal_208) && func_96(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_208, false);
...
void func_48()
{
	...
	func_51(Global_106510[iLocal_217] + 1, &sVar0, &Var1);
...
int func_52()
{
	...
	{
		iVar1 = func_32(&uLocal_37, &cLocal_227, &Var0, 3, 0, 0, 0);
	}
	Local_327 = { Var0 };
	return iVar1;
}
	...
	if (iLocal_276 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(*iParam1))
			{
				...
				{
					*iParam0 = func_75(*iParam1, bParam2, 145);
					if (bParam2 == 0)
					{
...
{
	return func_78(iParam0, iParam1, 1);
}
...
int func_100()
{
	if (MISC::IS_BIT_SET(Global_106565.f_18568[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_106565.f_18568[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_105()
{
	if (MISC::IS_BIT_SET(Global_106565.f_18568[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_106565.f_18568[60 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_106565.f_18568[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_106565.f_18568[61 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_106565.f_18568[62 /*6*/], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_106565.f_18568[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_106565.f_18568[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_106565.f_18568[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_107(Global_106565.f_20111, uParam0);
}
