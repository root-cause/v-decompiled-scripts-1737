...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_308(Local_43.f_9, 0, 0, 0, 0, 0);
		if (iLocal_41 == 2)
		{
			func_304();
		}
...
{
	func_239();
	if (!func_220(Local_43.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				if (func_218(Local_43.f_28[0]))
				{
			...
			case 1:
				if (!bLocal_225)
				{
					bLocal_225 = func_208(&uLocal_59, "PAP3AU", "PAP3_RCM_LO", 8, 0, 0, 0);
				}
				else if (!func_207())
				{
...
int func_220(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_219(PLAYER::PLAYER_PED_ID()) && func_219(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_233(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_224(&(Local_35[iVar2 /*4*/]), vVar1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_224(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_225(iParam2, iParam5) };
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_229(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_229(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_228(vVar1, vVar0);
...
float func_228(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_229(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_237(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_229(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_239()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_219(Local_43.f_28[0]))
	{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_219(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_275(sLocal_56, PLAYER::PLAYER_PED_ID(), 0, 2);
				}
			}
			if (func_268(1, 1093140480, 0))
			{
				if (func_219(Local_43.f_28[0]))
				{
...
void func_253(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_257(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_258(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_258(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_262(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_260(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_261(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_262(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_229(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_263(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_263(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_263(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_263(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_263(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_263(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_263(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_263(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_263(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_263(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_263(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_263(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_263(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_263(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_263(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_263(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_263(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_268(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_273(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_272(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_282()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_218(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
			...
			if (func_218(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_226))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
							bLocal_224 = func_208(&uLocal_59, "PAP3AU", "PAP3_RCM_LI", 8, 0, 0, 0);
						}
					}
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.3f)
					{
...
void func_283()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_43.f_41[3]) && !iLocal_235)
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_231, "CAMERA", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, vLocal_232), sLocal_234, 0, 0, 0);
			iLocal_235 = 1;
		}
	}
}
...
void func_286()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_273(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_292()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_45))
	{
		...
		ENTITY::_0xA80AE305E0A3044F(iLocal_45, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		func_301(&iLocal_46, &(Local_43.f_41[0]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
	{
		func_301(&(iLocal_47[0]), &(Local_43.f_41[1]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
	{
		func_301(&(iLocal_47[1]), &(Local_43.f_41[2]));
	}
	func_300(&uLocal_59, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_300(&uLocal_59, 3, Local_43.f_28[0], "BEVERLY", 0, 1);
...
void func_293()
{
	...
	func_296();
	func_241(1);
	func_295(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_294(1, 1, 1);
}
...
int func_295(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_296()
{
	if (func_219(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		iLocal_228 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_229, vLocal_230, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_310(Global_71845, Global_71847, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_321(0) || Global_71859) || Global_71848 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_290(0)) || func_320(1))
			{
			}
			else
			{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_260(iParam0, 0, 0)) || func_260(iParam0, 1, 0)) || func_260(iParam0, 2, 0)) || func_380(iParam0) != 145) || func_379(iParam0)) || func_378(iParam0)) || func_333(iParam0)) || func_377(iParam0)) || !func_367(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_378(iParam0))
		{
		}
...
int func_425(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (!func_430(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			if (func_218(uParam0->f_28[0]))
			{
				...
				{
					func_426(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
void func_426(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_252(iParam0);
...
int func_427(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_428(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_428(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_432()
{
	...
	func_445(&(iLocal_47[0]), 0);
	func_445(&(iLocal_47[1]), 0);
	func_445(&iLocal_45, 0);
	func_445(&iLocal_46, 0);
	STREAMING::REMOVE_ANIM_DICT(sLocal_57);
	STREAMING::REMOVE_PTFX_ASSET();
	func_444(&uLocal_59, 1);
	func_444(&uLocal_59, 3);
	HUD::CLEAR_ADDITIONAL_TEXT(0, true);
	HUD::CLEAR_PRINTS();
	func_443(&(Local_43.f_28[0]), 1, 0, 1);
	func_433(&Local_43, 1, 0, 0);
