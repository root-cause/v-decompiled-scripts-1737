...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_381))
	{
		...
		iLocal_312 = Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_25;
		func_71(&Global_1295642, iLocal_312);
		vLocal_374 = { Global_1295642.f_146.f_82[5 /*102*/] };
		fLocal_375 = Global_1295642.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_375 < 0f)
		{
			fLocal_375 = (fLocal_375 + 360f);
		}
		vLocal_378 = { Global_1295642.f_146.f_82[5 /*102*/].f_16 };
		fLocal_379 = Global_1295642.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_376 = { Global_1295642.f_146.f_82[5 /*102*/].f_7 };
		vLocal_377 = { Global_1295642.f_146.f_82[5 /*102*/].f_10 };
	}
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_374, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 3f)
			{
				switch (iLocal_307)
				{
					...
					case 1:
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_58())
						{
							func_1();
						}
						else
...
void func_1()
{
	...
	{
		case 0:
			if (((func_53(vLocal_374, vVar0) && !func_52()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_375 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_375 + 45f))
			{
...
void func_2()
{
	...
	if (iVar0 > -1 && iVar0 != func_8())
	{
		...
		while (iVar1 < 22)
		{
			if (Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_273.f_25 == Global_1589819[iVar0 /*818*/].f_273[iVar1])
			{
...
{
	return MISC::IS_BIT_SET(Global_1371947.f_241.f_136[func_13(9) /*33*/][iParam0], func_12(9));
}
...
void func_40()
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_318))
	{
		if (func_42(2, 0, 1))
		{
			...
			{
				if (func_41(&iLocal_318, 5, iLocal_316, vLocal_378, fLocal_379, 1, 1, 1) && func_41(&iLocal_319, 5, iLocal_317, vLocal_378, fLocal_379, 1, 1, 1))
				{
...
int func_41(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam4, bool bParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_53(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_57(0)) && !func_56())
				{
					...
					if (func_54(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_54(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_73(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	*uParam2 = { func_75(iParam1, 86) };
	...
	vVar1 = { func_74(vVar1, -Var0[0 /*6*/].f_3.f_2) };
	vVar1 = { func_74(vVar1, Var0[1 /*6*/].f_3.f_2) };
...
void func_78(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 42:
		case 43:
			func_83(iParam1, 4, &vVar0, -1, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, -1, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 19f;
			func_83(iParam1, 276, &vVar0, -1, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, -1, 0);
		...
		case 64:
		case 65:
			func_83(iParam1, 4, &vVar0, 61, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 61, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 21f;
			func_83(iParam1, 276, &vVar0, 61, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 61, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 14.5f;
			break;
		...
		case 75:
		case 76:
			func_83(iParam1, 4, &vVar0, 73, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 73, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_83(iParam1, 276, &vVar0, 73, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 73, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 10.25f;
			func_83(iParam1, 483, &vVar0, 73, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_83(iParam1, 484, &vVar0, 73, 0);
		...
		case 81:
		case 82:
			func_83(iParam1, 4, &vVar0, 77, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 77, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_83(iParam1, 276, &vVar0, 77, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 77, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 5f;
			func_83(iParam1, 483, &vVar0, 77, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_83(iParam1, 484, &vVar0, 77, 0);
			(uParam0[2 /*8*/])->f_3 = { vVar0 };
		...
		case 84:
		case 85:
			func_83(iParam1, 4, &vVar0, 83, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 83, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 26.75f;
			func_83(iParam1, 276, &vVar0, 83, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 83, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 18.25f;
			break;
		
		case 86:
			func_83(iParam1, 4, &vVar0, 86, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 86, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 14.75f;
			func_83(iParam1, 276, &vVar0, 86, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 86, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 89:
		case 90:
			func_83(iParam1, 4, &vVar0, 88, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 88, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 27.25f;
			func_83(iParam1, 276, &vVar0, 88, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_83(iParam1, 277, &vVar0, 88, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 95:
		case 96:
			func_83(iParam1, 4, &vVar0, 91, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 91, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
		...
		case 101:
		case 102:
			func_83(iParam1, 4, &vVar0, 97, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_83(iParam1, 5, &vVar0, 97, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 22f;
			break;
	}
