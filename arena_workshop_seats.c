...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 2:
			if (func_62(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_43.f_2 /*14*/]) && func_61(PLAYER::PLAYER_PED_ID(), (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_43.f_2 /*14*/]))
			{
		...
		case 5:
			...
			{
				uParam0->f_43.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_47(uParam0), func_46(uParam0), 2, true, false, 1065353216, 0, 1.12f);
...
int func_55(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_62(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || func_57(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_56(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_62(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar1], false), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
void func_68(var uParam0)
{
	...
	func_69(&(uParam0->f_43), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_69(&(uParam0->f_43), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_69(&(uParam0->f_43), 0, func_44(0));
	func_69(&(uParam0->f_43), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_71()
{
	if ((CAM::IS_SCREEN_FADED_OUT() && !func_84()) && !Global_2507139)
	{
		return 1;
	}
	if (!func_83())
...
bool func_84()
{
	return MISC::IS_BIT_SET(Global_1671295.f_4, 10);
}
...
int func_85()
{
	if (Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
