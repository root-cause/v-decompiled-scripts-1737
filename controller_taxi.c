					...
					if (iVar1 != 2)
					{
						if ((!MISC::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_68(5))
						{
							...
							if (func_64())
							{
								...
								if (((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_25916) && (MISC::GET_GAME_TIMER() - iLocal_105) > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
			...
			case 8:
				if (func_64())
				{
					if (!func_21())
					{
						...
						iLocal_96 = SYSTEM::START_NEW_SCRIPT(&vLocal_97, 28000);
...
void func_12()
{
	...
	{
		func_14(13, SYSTEM::FLOOR(Global_106565.f_10188.f_3853));
	}
