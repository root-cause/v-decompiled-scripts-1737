...
void __EntryFunction__()
{
	...
	iLocal_52 = func_291(56);
	iLocal_53 = func_291(57);
	iLocal_54 = func_291(59);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105652[Var0 /*10*/].f_9 != -1)
			{
				...
				func_287(&(Global_105652[Var0 /*10*/].f_9));
			}
		}
		func_271(&Var0, 1);
	}
	if (!func_268(&iVar2, &Var0, vVar1, 1f))
	{
		func_267();
	...
	while (true)
	{
		...
		{
			func_207();
			if (func_206(Var0.f_35[1]))
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
					func_288("Player has moved SURFER2 vehicle [TERMINATING]");
					func_202(&Var0);
					func_271(&Var0, 1);
				}
			}
		...
		func_201(Var0);
		func_194(&iLocal_56, &(Var0.f_9), vVar1);
		if (Var0 == 32)
		{
			func_190(&Var0, vVar1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_59);
		}
		else if (Var0 == 34)
		{
			func_185(&Var0, vVar1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_171(&Var0, 0))
		{
			if (func_170(Var0))
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_188(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_176(2))
		{
			if (!func_145())
			{
				if (((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && func_126(iParam0->f_28[1])) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					func_288("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_188(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_188(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_186(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_288("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (((func_192(sParam3) && !*uParam8 == 1) && func_126(PLAYER::PLAYER_PED_ID())) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam8 = 1;
			}
			if (func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
				func_288("unpause conversation");
				func_191(0);
				*uParam8 = 2;
			}
		}
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_189(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
int func_205(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_208(var uParam0, bool bParam1)
{
	...
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_71835 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_221(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_221(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_222(iParam2, iParam5) };
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_226(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_225(vVar1, vVar0);
...
int func_233(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_226(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_241() && Global_93682.f_11 == 6) && iParam0 == func_165(&(Global_93682.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_254(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_251(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_248(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_246(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_246(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.5016f);
			...
			{
				func_251(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_247(iParam0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_246(&(uParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
...
int func_256(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			if (!func_253(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_248(&(uParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_248(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_246(&(uParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_257(uParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_246(&(uParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_257(uParam0->f_35[1], iVar0[1]);
...
int func_268(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_269((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_269((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_269(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_270(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_270(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
