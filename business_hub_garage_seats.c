...
int func_84()
{
	if (Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
...
void func_86(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	(uParam1[iParam2 /*14*/])->f_1 = { func_88(func_89(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_88(func_87(), fVar1) + vVar0 };
