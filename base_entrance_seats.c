...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 2:
			if (func_49(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				...
				else if (uParam0->f_57.f_5 == -1)
				{
					...
					{
						func_44(&(uParam0->f_57.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
					}
				}
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
	...
	if (uParam0->f_57.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_57), 0)) && !func_8(&(uParam0->f_57), 4)) && !func_21()) && !func_19(1)) && uParam0->f_57.f_8.f_2 != 3)
			{
				...
				{
					func_44(&(uParam0->f_57.f_5), 4, "MPJAC_EXIT", 0, 0, 0, 0);
				}
				if (uParam0->f_57.f_4 == 6)
				{
...
{
	uParam0->f_57.f_8 = func_43((*uParam0)[uParam0->f_57.f_2 /*14*/]);
	uParam0->f_57.f_8.f_1 = func_42(uParam0);
...
int func_46(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_47(iVar1, 1, 1)) && func_49(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
{
	func_56(&(uParam0->f_57), 4, func_57());
	func_56(&(uParam0->f_57), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_56(&(uParam0->f_57), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_56(&(uParam0->f_57), 0, func_35(0));
	func_56(&(uParam0->f_57), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 451.6327f, 4829.453f, -54.97165f, 499.981f, 4842.034f, -50.67961f, 30.75f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
...
void func_73()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_74(0, &uLocal_162, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_74(1, &uLocal_162, &iVar0);
}
...
void func_74(int iParam0, var uParam1, int iParam2)
{
	...
	func_81(iParam0, &vVar0, &fVar1);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		(*uParam1)[(*iParam2)[iVar2] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_77(func_78(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_77(func_76(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_77(func_75(iVar2), fVar1) + vVar0 };
